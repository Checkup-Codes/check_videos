...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><header class="sticky top-0 z-40 flex h-12 items-center justify-between border-b border-base-200 bg-base-100 px-4 sm:px-5 lg:hidden" data-v-23408e6c>`);
      if (basePath.value) {
        ...
        _push(`<div class="w-8" data-v-23408e6c></div>`);
      }
      _push(`<div class="px-3 py-1 font-bold uppercase text-primary" data-v-23408e6c>`);
      ...
      _push(`</div><button class="btn btn-ghost btn-sm px-2" data-v-23408e6c><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-23408e6c><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" data-v-23408e6c></path></svg></button></header>`);
      if (isMenuOpen.value) {
        _push(`<div class="${ssrRenderClass([isMenuOpen.value ? "opacity-100" : "opacity-0", "fixed inset-0 z-50 bg-black/50 transition-opacity duration-300"])}" data-v-23408e6c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([isMenuOpen.value ? "translate-y-0" : "translate-y-full", "drawer-content drawer-end fixed inset-x-0 bottom-0 z-50 transform transition-all duration-300 ease-in-out"])}" data-v-23408e6c><div class="max-h-[90vh] overflow-y-auto rounded-t-xl border border-base-200 bg-base-100 pb-6 pt-4 shadow-lg" data-v-23408e6c><div class="mb-4 flex justify-center" data-v-23408e6c><div class="h-1 w-10 rounded-full bg-base-300" data-v-23408e6c></div></div><div class="px-4" data-v-23408e6c>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/",
        class: "block"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mb-4 rounded-lg border border-base-300 bg-base-100 px-4 py-3 shadow-sm" data-v-23408e6c${_scopeId}><div class="flex items-center space-x-3" data-v-23408e6c${_scopeId}><div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-primary" data-v-23408e6c${_scopeId}>`);
            if (logoPath.value && !isLoading.value) {
              _push2(`<img${ssrRenderAttr("src", logoPath.value)}${ssrRenderAttr("alt", logoAlt.value)} class="h-full w-full object-cover" data-v-23408e6c${_scopeId}>`);
            } else {
              _push2(`<span class="text-sm font-bold text-primary-content" data-v-23408e6c${_scopeId}>${ssrInterpolate(appName.value.charAt(0))}</span>`);
            }
            _push2(`</div><div data-v-23408e6c${_scopeId}><h3 class="font-semibold text-base-content" data-v-23408e6c${_scopeId}>${ssrInterpolate(appName.value)}</h3></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "mb-4 rounded-lg border border-base-300 bg-base-100 px-4 py-3 shadow-sm" }, [
                createVNode("div", { class: "flex items-center space-x-3" }, [
                  createVNode("div", { class: "flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-primary" }, [
                    logoPath.value && !isLoading.value ? (openBlock(), createBlock("img", {
                      ...
                      key: 1,
                      class: "text-sm font-bold text-primary-content"
      ...
      if (!isLoggedIn.value) {
        _push(`<div class="mb-4" data-v-23408e6c><a href="https://youtu.be/FPsx8xHLR1k?si=3dNFdwhk5s8LyqOe" target="_blank" data-v-23408e6c><button class="w-full rounded-lg border border-base-300 bg-base-100 p-3 shadow-sm transition-colors hover:bg-base-200" data-v-23408e6c><div class="flex items-center justify-center space-x-3" data-v-23408e6c><span class="text-sm font-medium text-base-content" data-v-23408e6c>Powered by : Notiriel</span></div></button></a></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="mb-4 space-y-1" data-v-23408e6c>`);
      ...
      _push(`</div><div class="mb-4 space-y-1" data-v-23408e6c>`);
      _push(ssrRenderComponent(_sfc_main$5, {
        href: "/writes",
      ...
      if (!isLoggedIn.value) {
        _push(`<div class="mb-4 space-y-1 border-t border-base-300 pt-4" data-v-23408e6c>`);
        _push(ssrRenderComponent(_sfc_main$3, { "is-compact": false }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="mt-6 flex flex-col items-center" data-v-23408e6c><div class="mb-3" data-v-23408e6c><button class="btn btn-ghost btn-sm" data-v-23408e6c>`);
      if (isDarkMode.value) {
        _push(`<svg class="h-4 w-4 fill-current text-amber-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-v-23408e6c><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" data-v-23408e6c></path></svg>`);
      } else {
        _push(`<svg class="h-4 w-4 fill-current text-blue-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-v-23408e6c><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" data-v-23408e6c></path></svg>`);
      }
      _push(`</button><p class="text-base-content/40 mt-1 text-xs" data-v-23408e6c>${ssrInterpolate(currentThemeName.value)}</p></div><p class="text-base-content/60 mt-2 text-xs" data-v-23408e6c>Notiriel - Tüm Hakları Saklıdır</p></div></div></div></div><!--]-->`);
    };
  }
};
...
const HeaderLayout = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-23408e6c"]]);
const _sfc_main$1 = {
...
function render(page) {
  ...
  return createInertiaApp({
    page,
    resolve: async (name) => {
      const page2 = (await resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-Diprr4J0.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-SBqO7rhx.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-CWm06mam.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-B4pUEFUM.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-CcBdQgyd.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-C7XCA-UH.js"), "./Pages/Bookmarks/CreateBookmarks.vue": () => import("./assets/CreateBookmarks-DVJTJcy3.js"), "./Pages/Bookmarks/EditBookmarks.vue": () => import("./assets/EditBookmarks-DZrKHk0d.js"), "./Pages/Bookmarks/IndexBookmarks.vue": () => import("./assets/IndexBookmarks-BH0g04d3.js"), "./Pages/Bookmarks/ShowBookmarks.vue": () => import("./assets/ShowBookmarks-B_Ty2lxF.js"), "./Pages/Bookmarks/SidebarLayoutBookmarks.vue": () => import("./assets/SidebarLayoutBookmarks-B16ebHBN.js"), "./Pages/Category/TypescriptTutorial.vue": () => import("./assets/TypescriptTutorial-BIFkOjAm.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-DcObxRRZ.js"), "./Pages/Equipments/Create/Screen.vue": () => import("./assets/Screen-D1PJcqvP.js"), "./Pages/Equipments/CreateEquipment.vue": () => import("./assets/CreateEquipment-CxmoL0yv.js"), "./Pages/Equipments/Edit/Screen.vue": () => import("./assets/Screen-Ca5kb9UJ.js"), "./Pages/Equipments/EditEquipment.vue": () => import("./assets/EditEquipment-D2FCZljd.js"), "./Pages/Equipments/Index/Screen.vue": () => import("./assets/Screen-Cuce7w9O.js"), "./Pages/Equipments/IndexEquipment.vue": () => import("./assets/IndexEquipment-BqyUdMbS.js"), "./Pages/Equipments/ShowEquipment.vue": () => import("./assets/ShowEquipment-Di6pVRrk.js"), "./Pages/Excalidraw.vue": () => import("./assets/Excalidraw-COkoWgJA.js"), "./Pages/FBVersions/Versions/Create/Screen.vue": () => import("./assets/Screen-CWsBLhWk.js"), "./Pages/FBVersions/Versions/CreateVersion.vue": () => import("./assets/CreateVersion-DVqjAqyQ.js"), "./Pages/FBVersions/Versions/Edit/Screen.vue": () => import("./assets/Screen-Cap0pveE.js"), "./Pages/FBVersions/Versions/EditVersion.vue": () => import("./assets/EditVersion-BQXjf23J.js"), "./Pages/FBVersions/Versions/Index/Screen.vue": () => import("./assets/Screen-D2P7t1uT.js"), "./Pages/FBVersions/Versions/IndexVersion.vue": () => import("./assets/IndexVersion-BiOPLHGW.js"), "./Pages/FBVersions/Versions/Show/Screen.vue": () => import("./assets/Screen-DrZg848U.js"), "./Pages/FBVersions/Versions/ShowVersion.vue": () => import("./assets/ShowVersion-CAAooSBM.js"), "./Pages/FBVersions/_components/VersionList.vue": () => import("./assets/VersionList-nzCJkvRK.js"), "./Pages/FBVersions/_layouts/LayoutFBVersions.vue": () => import("./assets/LayoutFBVersions-S_qn16cK.js"), "./Pages/FBVersions/_layouts/SidebarLayoutVersion.vue": () => import("./assets/SidebarLayoutVersion-6lZL97Eb.js"), "./Pages/Index/Factory.vue": () => import("./assets/Factory-2ZHSsfDx.js"), "./Pages/Index/Index.vue": () => import("./assets/Index-BPBSSKKK.js"), "./Pages/Lessons/Create/Screen.vue": () => import("./assets/Screen-CPrdPMtJ.js"), "./Pages/Lessons/CreateLesson.vue": () => import("./assets/CreateLesson-CnkBbaZd.js"), "./Pages/Lessons/Edit/Screen.vue": () => import("./assets/Screen-Bki1VgSS.js"), "./Pages/Lessons/EditLesson.vue": () => import("./assets/EditLesson-CogMlNuJ.js"), "./Pages/Lessons/Index/Screen.vue": () => import("./assets/Screen-BCXsAg6V.js"), "./Pages/Lessons/IndexLesson.vue": () => import("./assets/IndexLesson-CidZvUd8.js"), "./Pages/Lessons/Show/Screen.vue": () => import("./assets/Screen-CjkZqS8v.js"), "./Pages/Lessons/ShowLesson.vue": () => import("./assets/ShowLesson-Dh62RzrO.js"), "./Pages/Lessons/_layouts/CheckLayout.vue": () => import("./assets/CheckLayout-DfZzYfmn.js"), "./Pages/Lessons/_layouts/SidebarLayoutLesson.vue": () => import("./assets/SidebarLayoutLesson-jj_1q1DG.js"), "./Pages/Media/Index.vue": () => import("./assets/Index-D7zwUoij.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-0kVD1Nk8.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DVCHwD4r.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-DUxQgeJZ.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm--eQ_BEVm.js"), "./Pages/Projects/Customers/Create/Screen.vue": () => import("./assets/Screen-C-SZSGJW.js"), "./Pages/Projects/Customers/CreateCustomer.vue": () => import("./assets/CreateCustomer-BJXaEv6u.js"), "./Pages/Projects/Customers/Edit/Screen.vue": () => import("./assets/Screen-1rnCPCA3.js"), "./Pages/Projects/Customers/EditCustomer.vue": () => import("./assets/EditCustomer-pBJmG4qU.js"), "./Pages/Projects/Customers/Index/Screen.vue": () => import("./assets/Screen-DuBvRY7b.js"), "./Pages/Projects/Customers/IndexCustomer.vue": () => import("./assets/IndexCustomer-SWVgBks7.js"), "./Pages/Projects/Customers/Show/Screen.vue": () => import("./assets/Screen-CKUyiJ5u.js"), "./Pages/Projects/Customers/ShowCustomer.vue": () => import("./assets/ShowCustomer-ciwDw4eM.js"), "./Pages/Projects/Index/Screen.vue": () => import("./assets/Screen-DhR7Vu2C.js"), "./Pages/Projects/Project/Create/Screen.vue": () => import("./assets/Screen-Dxwec_zU.js"), "./Pages/Projects/Project/CreateProject.vue": () => import("./assets/CreateProject-HHx_MN9r.js"), "./Pages/Projects/Project/Edit/Screen.vue": () => import("./assets/Screen-D3jKNjK5.js"), "./Pages/Projects/Project/EditProject.vue": () => import("./assets/EditProject-BpVSHNcQ.js"), "./Pages/Projects/Project/Index/Screen.vue": () => import("./assets/Screen-CV_W5O0q.js"), "./Pages/Projects/Project/IndexProject.vue": () => import("./assets/IndexProject-CjMoPi25.js"), "./Pages/Projects/Project/Show/Screen.vue": () => import("./assets/Screen-5iZr_3lb.js"), "./Pages/Projects/Project/ShowProject.vue": () => import("./assets/ShowProject--_XbThvF.js"), "./Pages/Projects/Services/Create/Screen.vue": () => import("./assets/Screen-D4phAlyJ.js"), "./Pages/Projects/Services/CreateService.vue": () => import("./assets/CreateService-Bs5cJ9Gj.js"), "./Pages/Projects/Services/Edit/Screen.vue": () => import("./assets/Screen-BBzOILrC.js"), "./Pages/Projects/Services/EditService.vue": () => import("./assets/EditService-Cec-P9zc.js"), "./Pages/Projects/Services/Index/Screen.vue": () => import("./assets/Screen-CzZadZNx.js"), "./Pages/Projects/Services/Index/ServiceItem.vue": () => import("./assets/ServiceItem-Ihxuygsp.js"), "./Pages/Projects/Services/IndexService.vue": () => import("./assets/IndexService-BcqbAc_-.js"), "./Pages/Projects/Services/Show/Screen.vue": () => import("./assets/Screen-CkiAq9Qd.js"), "./Pages/Projects/Services/ShowService.vue": () => import("./assets/ShowService-UOZ51mz2.js"), "./Pages/Projects/_layouts/CheckLayout.vue": () => import("./assets/CheckLayout-LlIdInKJ.js"), "./Pages/Projects/_layouts/LayoutProjects.vue": () => import("./assets/LayoutProjects-DXAlsolR.js"), "./Pages/Projects/_layouts/SidebarLayoutProject.vue": () => import("./assets/SidebarLayoutProject-BcM3cXoB.js"), "./Pages/Rendition/LanguagePacks/Create/Screen.vue": () => import("./assets/Screen-C5zzPGh2.js"), "./Pages/Rendition/LanguagePacks/CreateLanguagePacks.vue": () => import("./assets/CreateLanguagePacks-DtMWEkGQ.js"), "./Pages/Rendition/LanguagePacks/Edit/Screen.vue": () => import("./assets/Screen-BhAAAqxh.js"), "./Pages/Rendition/LanguagePacks/EditLanguagePacks.vue": () => import("./assets/EditLanguagePacks-CJK8zaji.js"), "./Pages/Rendition/LanguagePacks/Index/PacksTable.vue": () => import("./assets/PacksTable-CNd9Ythh.js"), "./Pages/Rendition/LanguagePacks/Index/Screen.vue": () => import("./assets/Screen-_7PmOT92.js"), "./Pages/Rendition/LanguagePacks/IndexLanguagePacks.vue": () => import("./assets/IndexLanguagePacks-KCq_Kaq3.js"), "./Pages/Rendition/LanguagePacks/ShowLanguagePacks.vue": () => import("./assets/ShowLanguagePacks-D9rX4gvi.js"), "./Pages/Rendition/LanguagePacks/Words.vue": () => import("./assets/Words-DSwl6LoX.js"), "./Pages/Rendition/LanguagePacks/Words/Screen.vue": () => import("./assets/Screen-BEZFz91b.js"), "./Pages/Rendition/Words/Create/Screen.vue": () => import("./assets/Screen-41jMfKZx.js"), "./Pages/Rendition/Words/CreateWord.vue": () => import("./assets/CreateWord-BZf9N7Nx.js"), "./Pages/Rendition/Words/Edit/Screen.vue": () => import("./assets/Screen-CzJJkhuM.js"), "./Pages/Rendition/Words/EditWord.vue": () => import("./assets/EditWord-BL11IOns.js"), "./Pages/Rendition/Words/Index/Screen.vue": () => import("./assets/Screen-CsnwCH_W.js"), "./Pages/Rendition/Words/IndexWord.vue": () => import("./assets/IndexWord-apr3X1-i.js"), "./Pages/Rendition/Words/Show/Screen.vue": () => import("./assets/Screen-XgYA-bgW.js"), "./Pages/Rendition/Words/ShowWord.vue": () => import("./assets/ShowWord-CmFh2Bw-.js"), "./Pages/Rendition/_components/MultipleChoice.vue": () => import("./assets/MultipleChoice-B9iPBUYP.js"), "./Pages/Rendition/_components/TranslateWord.vue": () => import("./assets/TranslateWord-BZUIwaCp.js"), "./Pages/Rendition/_components/WordCompletion.vue": () => import("./assets/WordCompletion-DMRxGzDE.js"), "./Pages/Rendition/_components/WordsTable.vue": () => import("./assets/WordsTable-BqU-bMcA.js"), "./Pages/Rendition/_layouts/LayoutRendition.vue": () => import("./assets/LayoutRendition-BwDO1Dmz.js"), "./Pages/Rendition/_layouts/SidebarPackGame.vue": () => import("./assets/SidebarPackGame-XDVNUvfC.js"), "./Pages/Rendition/_layouts/SidebarRendition.vue": () => import("./assets/SidebarRendition-Va84hYzR.js"), "./Pages/Seo/Create.vue": () => import("./assets/Create-BRdXUaxN.js"), "./Pages/Seo/Edit.vue": () => import("./assets/Edit-DTfkQryQ.js"), "./Pages/Seo/Index.vue": () => import("./assets/Index-DYcxatp1.js"), "./Pages/SocialMedia/Index.vue": () => import("./assets/Index-CbGmwi4q.js"), "./Pages/SoftwareProducts/Create.vue": () => import("./assets/Create-B4Oi8qLw.js"), "./Pages/SoftwareProducts/Edit.vue": () => import("./assets/Edit-DJ-sG-Av.js"), "./Pages/SoftwareProducts/Index.vue": () => import("./assets/Index-CifLqXBt.js"), "./Pages/SoftwareProducts/Show.vue": () => import("./assets/Show-C4u6lUfx.js"), "./Pages/SoftwareProducts/component/Box.vue": () => import("./assets/Box-CvUfE-UW.js"), "./Pages/SoftwareProducts/component/ConfirmModal.vue": () => import("./assets/ConfirmModal-8bTg5PxV.js"), "./Pages/SoftwareProducts/component/SPAddress.vue": () => import("./assets/SPAddress-C4B-URBw.js"), "./Pages/SoftwareProducts/component/SPPrice.vue": () => import("./assets/SPPrice-DDe_ZJN3.js"), "./Pages/SoftwareProducts/component/SPSpaces.vue": () => import("./assets/SPSpaces-C-9fwGUn.js"), "./Pages/ThemeManagement.vue": () => import("./assets/ThemeManagement-CovEqm69.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-D6Jmvwhf.js"), "./Pages/WritesCategories/Categories/Create/CategoriesCreateFrom.vue": () => import("./assets/CategoriesCreateFrom-kQrBvJAp.js"), "./Pages/WritesCategories/Categories/Create/Screen.vue": () => import("./assets/Screen-BFycxZNf.js"), "./Pages/WritesCategories/Categories/CreateCategory.vue": () => import("./assets/CreateCategory-r5Ui2THK.js"), "./Pages/WritesCategories/Categories/Edit/CategoriesEditFrom.vue": () => import("./assets/CategoriesEditFrom-DKzwSiRi.js"), "./Pages/WritesCategories/Categories/Edit/Screen.vue": () => import("./assets/Screen-DI_H6u5c.js"), "./Pages/WritesCategories/Categories/EditCategory.vue": () => import("./assets/EditCategory-CEuMP2w8.js"), "./Pages/WritesCategories/Categories/Index/Screen.vue": () => import("./assets/Screen-Dgm0Ep8Y.js"), "./Pages/WritesCategories/Categories/IndexCategory.vue": () => import("./assets/IndexCategory-B9fau05o.js"), "./Pages/WritesCategories/Categories/Show/Screen.vue": () => import("./assets/Screen-BbCjqpQn.js"), "./Pages/WritesCategories/Categories/ShowCategory.vue": () => import("./assets/ShowCategory-DzKRAL1Z.js"), "./Pages/WritesCategories/Categories/WriteByCategory.vue": () => import("./assets/WriteByCategory-BfmvXCgz.js"), "./Pages/WritesCategories/Categories/WriteByCategory/Screen.vue": () => import("./assets/Screen-K2CpA1iy.js"), "./Pages/WritesCategories/Writes/Create/FormField.vue": () => import("./assets/FormField-B5B8BMWT.js"), "./Pages/WritesCategories/Writes/Create/Screen.vue": () => import("./assets/Screen-gMIqpOT8.js"), "./Pages/WritesCategories/Writes/Create/WriteCreateForm.vue": () => import("./assets/WriteCreateForm-BZ2VoCCz.js"), "./Pages/WritesCategories/Writes/CreateWrite.vue": () => import("./assets/CreateWrite-BJ1Upk1s.js"), "./Pages/WritesCategories/Writes/Edit/Screen.vue": () => import("./assets/Screen-CgCjYHST.js"), "./Pages/WritesCategories/Writes/Edit/WriteUpdateForm.vue": () => import("./assets/WriteUpdateForm-Cpua6oKE.js"), "./Pages/WritesCategories/Writes/EditWrite.vue": () => import("./assets/EditWrite-D0EsE2Ml.js"), "./Pages/WritesCategories/Writes/Index/Screen.vue": () => import("./assets/Screen-CbIYSR5N.js"), "./Pages/WritesCategories/Writes/IndexWrite.vue": () => import("./assets/IndexWrite-BXkLl6Y2.js"), "./Pages/WritesCategories/Writes/Show/Screen.vue": () => import("./assets/Screen-C4t1ZqNk.js"), "./Pages/WritesCategories/Writes/ShowWrite.vue": () => import("./assets/ShowWrite-C7rJSMy1.js"), "./Pages/WritesCategories/_components/RichTextEditor.vue": () => import("./assets/RichTextEditor-OP0dOd6Z.js"), "./Pages/WritesCategories/_composables/CategoryTree.vue": () => import("./assets/CategoryTree-Bo3u88OW.js"), "./Pages/WritesCategories/_composables/WriteList.vue": () => import("./assets/WriteList-08ZCbF3x.js"), "./Pages/WritesCategories/_layouts/LayoutWritesCategories.vue": () => import("./assets/LayoutWritesCategories-DpxNIN3Q.js"), "./Pages/WritesCategories/_layouts/SidebarLayoutCategory.vue": () => import("./assets/SidebarLayoutCategory-UYHjV0nJ.js"), "./Pages/WritesCategories/_layouts/SidebarLayoutWrite.vue": () => import("./assets/SidebarLayoutWrite-DWbgubFD.js") }))).default;
