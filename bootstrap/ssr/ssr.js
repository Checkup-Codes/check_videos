...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.isCompact) {
        _push(`<p class="text-base-content/60 mt-2 text-xs">${ssrInterpolate(seoTitle.value)} - Tüm Hakları Saklıdır</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></aside>`);
