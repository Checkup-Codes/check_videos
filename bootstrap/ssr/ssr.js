...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      } else if (currentTheme.value === "lotr") {
        _push(`<svg class="h-6 w-6 fill-current text-yellow-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,2L13.09,8.26L20,9L13.09,9.74L12,16L10.91,9.74L4,9L10.91,8.26L12,2Z"></path><path d="M12,18L13.09,24.26L20,25L13.09,25.74L12,32L10.91,25.74L4,25L10.91,24.26L12,18Z"></path></svg>`);
      } else if (currentTheme.value === "neon") {
        _push(`<svg class="h-6 w-6 fill-current text-cyan-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z"></path><path d="M12,6a6,6,0,1,0,6,6A6,6,0,0,0,12,6Zm0,10a4,4,0,1,1,4-4A4,4,0,0,1,12,16Z"></path></svg>`);
      } else if (currentTheme.value === "cyberpunk") {
        _push(`<svg class="h-6 w-6 fill-current text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,2L13.09,8.26L20,9L13.09,9.74L12,16L10.91,9.74L4,9L10.91,8.26L12,2Z"></path><path d="M12,18L13.09,24.26L20,25L13.09,25.74L12,32L10.91,25.74L4,25L10.91,24.26L12,18Z"></path><path d="M12,10L13.09,16.26L20,17L13.09,17.74L12,24L10.91,17.74L4,17L10.91,16.26L12,10Z"></path></svg>`);
      } else if (currentTheme.value === "nature") {
      ...
      } else if (currentTheme.value === "ocean") {
      ...
      } else if (currentTheme.value === "sunset") {
