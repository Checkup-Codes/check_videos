...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex w-fit cursor-pointer items-center gap-4 rounded-lg p-4" }, _attrs))} data-v-5b849c03><div class="avatar" data-v-5b849c03><div class="h-10 w-10 rounded-full bg-white ring ring-primary ring-offset-2 ring-offset-base-100" data-v-5b849c03>`);
      if (!isLoading.value) {
        _push(`<img${ssrRenderAttr("src", logoPath.value)}${ssrRenderAttr("alt", logoAlt.value)} class="h-full w-full rounded-full object-cover" data-v-5b849c03>`);
      } else {
        _push(`<div class="h-full w-full rounded-full bg-base-200" data-v-5b849c03><div class="animate-shimmer h-full w-full rounded-full bg-gradient-to-r from-base-200 via-base-100 to-base-200" data-v-5b849c03></div></div>`);
      }
      _push(`</div></div><div class="flex flex-col" data-v-5b849c03>`);
      if (!isLoading.value) {
        _push(`<!--[--><div class="font-semibold text-base-content" data-v-5b849c03>${ssrInterpolate(seoTitle.value)}</div><div class="text-sm font-thin text-base-content" data-v-5b849c03>${ssrInterpolate(seoDescription.value)}</div><!--]-->`);
      } else {
        _push(`<div class="space-y-2" data-v-5b849c03><div class="h-5 w-32 animate-pulse rounded bg-base-200" data-v-5b849c03></div><div class="h-4 w-40 animate-pulse rounded bg-base-200" data-v-5b849c03></div></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const ProfileCard = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-5b849c03"]]);
const _sfc_main$7 = {
  __name: "NavItem",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="text-base-content/60 mt-2 text-xs">${ssrInterpolate(seoTitle.value)} - Tüm Hakları Saklıdır</p></div></aside>`);
    };
  }
};
