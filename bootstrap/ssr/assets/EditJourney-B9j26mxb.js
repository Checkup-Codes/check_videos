              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!imagePreview.value && !__props.entry.image) {
                    ...
                    _push3(`<img${ssrRenderAttr("src", imagePreview.value || `/storage/${__props.entry.image}`)} alt="Preview" class="h-full max-h-[200px] w-full rounded-md object-cover"${_scopeId2}>`);
                  }
                  _push3(`</div>`);
                  if (imagePreview.value || __props.entry.image) {
