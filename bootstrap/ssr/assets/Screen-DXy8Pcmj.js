      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div>`);
            if (unref(isGuest)) {
              _push2(`<div class="border-t border-border pt-4"${_scopeId}><h3 class="mb-4 text-lg font-semibold text-foreground"${_scopeId}>Sonucunu Paylaş</h3><div class="space-y-4"${_scopeId}><div class="rounded-md border border-input bg-background p-4"${_scopeId}><p class="mb-2 text-sm text-muted-foreground"${_scopeId}>Paylaşılabilir mesaj:</p><p class="whitespace-pre-wrap text-foreground font-medium" id="shareMessage"${_scopeId}>${ssrInterpolate(shareMessage.value)}</p></div><div class="flex gap-2"${_scopeId}><button class="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"${_scopeId}></path></svg> ${ssrInterpolate(copyButtonText.value)}</button>`);
              if (canShare.value) {
                  ...
                  unref(isGuest) ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "space-y-4" }, [
                      createVNode("div", { class: "rounded-md border border-input bg-background p-4" }, [
                        ...
                        createVNode("p", {
                          class: "whitespace-pre-wrap text-foreground font-medium",
                          id: "shareMessage"
