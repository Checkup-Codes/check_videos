import { defineComponent, onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, createTextVNode, createVNode, createBlock, toDisplayString, openBlock } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="min-h-screen bg-base-100"><nav class="border-b border-base-300 bg-base-200"><div class="mx-auto max-w-7xl px-4 sm:px-6"><div class="flex h-16 justify-between"><div class="flex"><div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">`);
