import { ref, withCtx, unref, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, withModifiers, withDirectives, vModelText, vModelSelect, vModelCheckbox, Fragment, renderList, withKeys, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, { title: "Kelime Oluştur" }, null, _parent2, _scopeId));
            if (props.error) {
            ...
            _push2(`</div><div class="mb-4"${_scopeId}><label for="learning_status" class="mb-1 block text-sm font-medium text-gray-700"${_scopeId}>Öğrenme Durumu</label><select id="learning_status" class="w-full rounded-md border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-500"${_scopeId}><option${ssrRenderAttr("value", 0)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 0) : ssrLooseEqual(unref(form).learning_status, 0)) ? " selected" : ""}${_scopeId}>Öğrenilmedi</option><option${ssrRenderAttr("value", 1)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 1) : ssrLooseEqual(unref(form).learning_status, 1)) ? " selected" : ""}${_scopeId}>Öğreniliyor</option><option${ssrRenderAttr("value", 2)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 2) : ssrLooseEqual(unref(form).learning_status, 2)) ? " selected" : ""}${_scopeId}>Öğrenildi</option></select>`);
            ...
            _push2(`</div><div class="col-span-1 mb-4 md:col-span-2"${_scopeId}><label class="mb-1 block text-sm font-medium text-gray-700"${_scopeId}>Dil Paketleri</label><div class="max-h-60 overflow-y-auto rounded-md border border-gray-300 p-3"${_scopeId}>`);
            if (props.languagePacks.length === 0) {
              ...
              ssrRenderList(props.languagePacks, (pack) => {
                _push2(`<div class="flex items-center"${_scopeId}><input${ssrRenderAttr("id", `pack-${pack.id}`)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).language_pack_ids) ? ssrLooseContain(unref(form).language_pack_ids, pack.id) : unref(form).language_pack_ids) ? " checked" : ""}${ssrRenderAttr("value", pack.id)} type="checkbox" class="h-4 w-4 rounded border-gray-300 text-black"${_scopeId}><label${ssrRenderAttr("for", `pack-${pack.id}`)} class="ml-2 block text-sm text-gray-700"${_scopeId}>${ssrInterpolate(pack.name)} (${ssrInterpolate(getLanguageName(pack.language))}) </label></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div>`);
            ...
            return [
              createVNode(_sfc_main$2, { title: "Kelime Oluştur" }),
