      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="mt-2 flex flex-shrink-0 gap-2 sm:mt-0"${_scopeId}><button class="${ssrRenderClass([showDraw.value ? "btn-primary" : "btn-ghost", "btn"])}" size="sm"${_scopeId}>${ssrInterpolate(showDraw.value ? "Metni Göster" : "Çizim Göster")}</button>`);
            if (unref(auth).user) {
                  ...
                  createVNode("div", { class: "mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between" }, [
                    ...
                    createVNode("div", { class: "mt-2 flex flex-shrink-0 gap-2 sm:mt-0" }, [
                      createVNode("button", {
                        ...
                        class: ["btn", showDraw.value ? "btn-primary" : "btn-ghost"],
                        size: "sm"
