...
import WriteList from "./WriteList-DVFMWbxG.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ isNarrow: isNarrow.value }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border bg-background p-2" data-v-e702b4d1${_scopeId}><div class="flex items-center justify-between gap-2" data-v-e702b4d1${_scopeId}><div class="flex items-center gap-1" data-v-e702b4d1${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-e702b4d1${_scopeId2}>Liste</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-e702b4d1${_scopeId2}>Kategori</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(`</div>`);
            if (isLoggedIn.value) {
              _push2(`<div class="flex items-center gap-1" data-v-e702b4d1${_scopeId}>`);
              if (writeFilter.value !== "all") {
                _push2(`<button class="inline-flex h-6 w-6 items-center justify-center rounded text-xs text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground" title="Filtreyi temizle" data-v-e702b4d1${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$4, { class: "h-3 w-3" }, null, _parent2, _scopeId));
                _push2(`</button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="write-filter-dropdown-container relative" data-v-e702b4d1${_scopeId}><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": showWriteFilterDropdown.value }, "inline-flex h-6 items-center gap-1 rounded px-2 text-xs text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}" title="Filtrele" data-v-e702b4d1${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$5, { class: "h-3 w-3" }, null, _parent2, _scopeId));
              _push2(`<span class="text-xs" data-v-e702b4d1${_scopeId}>${ssrInterpolate(getFilterLabel(writeFilter.value))}</span></button>`);
              if (showWriteFilterDropdown.value) {
                _push2(`<div class="absolute left-0 top-full z-50 mt-1 w-32 rounded-md border border-border bg-popover shadow-md" data-v-e702b4d1${_scopeId}><div class="flex flex-col p-1" data-v-e702b4d1${_scopeId}><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": writeFilter.value === "all" }, "inline-flex h-7 items-center gap-2 rounded-sm px-2 text-xs font-medium text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}" data-v-e702b4d1${_scopeId}> Tümü </button><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": writeFilter.value === "published" }, "inline-flex h-7 items-center gap-2 rounded-sm px-2 text-xs font-medium text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}" data-v-e702b4d1${_scopeId}> Herkese Açık </button><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": writeFilter.value === "link_only" }, "inline-flex h-7 items-center gap-2 rounded-sm px-2 text-xs font-medium text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}" data-v-e702b4d1${_scopeId}> Sadece Link </button><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": writeFilter.value === "private" }, "inline-flex h-7 items-center gap-2 rounded-sm px-2 text-xs font-medium text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}" data-v-e702b4d1${_scopeId}> Gizli </button></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
...
const SidebarLayoutWrite = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e702b4d1"]]);
export {
