...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const writeDraws = ref(((_a = props.write) == null ? void 0 : _a.writeDraws) || ((_b = props.write) == null ? void 0 : _b.write_draws) || []);
      ...
      import("@excalidraw/excalidraw").then(({ Excalidraw }) => {
        import("react").then((React) => {
          import("react-dom/client").then((ReactDOMClient) => {
            ...
            const initialElements = draws.length > 0 && ((_a2 = draws[0]) == null ? void 0 : _a2.elements) ? JSON.parse(draws[0].elements) : [];
            let initialFiles = {};
            if (draws.length > 0 && ((_b2 = draws[0]) == null ? void 0 : _b2.files)) {
              try {
            ...
            const excalidrawElement = React.createElement(Excalidraw, {
              ...
              viewModeEnabled: !((_c = props.auth) == null ? void 0 : _c.user),
              theme: isDarkTheme.value ? "dark" : "light",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a2 = unref(props).auth) == null ? void 0 : _a2.user) {
