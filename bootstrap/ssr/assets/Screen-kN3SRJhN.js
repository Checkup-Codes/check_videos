        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, {
              url: `/customers/${unref(customer).id}`
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, { title: "Müşteri Bilgisini Güncelle" }, null, _parent2, _scopeId));
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Güncelleniyor..." : "Müşteriyi Güncelle")}</button></div></form></div></div>`);
          } else {
            return [
              createVNode(_sfc_main$2, {
                url: `/customers/${unref(customer).id}`
              }, null, 8, ["url"]),
              createVNode(_sfc_main$3, { title: "Müşteri Bilgisini Güncelle" }),
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 gap-4 md:grid-cols-2" }, [
                      ...
                      createVNode("div", {
                        ...
                        createVNode("label", { class: "mb-1 block text-sm font-medium text-foreground" }, "Soy İsmi"),
                        withDirectives(createVNode("input", {
