import { ref, withCtx, unref, createBlock, createTextVNode, openBlock, createVNode, withModifiers, withDirectives, createCommentVNode, vModelText, toDisplayString, vModelRadio, useSSRContext } from "vue";
            ...
            _push2(ssrRenderComponent(_sfc_main$2, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<h1 class="text-3xl font-bold tracking-tight text-foreground"${_scopeId2}>Yeni Kayıt</h1><p class="mt-2 text-muted-foreground"${_scopeId2}>Yolculuğunuza yeni bir an ekleyin.</p></div><form class="space-y-6"${_scopeId2}><div${_scopeId2}><label for="entry_date" class="mb-2 block text-sm font-medium text-foreground"${_scopeId2}> Tarih <span class="text-destructive"${_scopeId2}>*</span></label><input id="entry_date"${ssrRenderAttr("value", unref(form).entry_date)} type="date" class="w-full rounded-lg border border-input bg-background px-4 py-2.5 text-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20" required${_scopeId2}>`);
                  ...
                  _push3(` ${ssrInterpolate(unref(form).processing ? "Kaydediliyor..." : "Kaydet")}</button>`);
                  _push3(ssrRenderComponent(unref(Link), {
                    href: "/journey",
                  ...
                  return [
                    createVNode("div", { class: "mx-auto max-w-2xl py-8" }, [
                      createVNode("div", { class: "mb-8" }, [
                        ...
                        createVNode("h1", { class: "text-3xl font-bold tracking-tight text-foreground" }, "Yeni Kayıt"),
                        createVNode("p", { class: "mt-2 text-muted-foreground" }, "Yolculuğunuza yeni bir an ekleyin.")
                      ]),
                      createVNode("form", {
