...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto w-full max-w-full bg-screen-bg px-5 lg:mt-0" }, _attrs))}><div class="container mx-auto p-4"><h1 class="mb-4 text-2xl font-bold">Yeni yazı oluştur</h1>`);
