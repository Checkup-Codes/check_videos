    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mx-auto max-w-5xl py-8" data-v-3f88ab27${_scopeId}><div class="mb-12" data-v-3f88ab27${_scopeId}><h1 class="xl:-translate-x-[80px] mb-5 text-2xl font-bold text-foreground sm:text-3xl" data-v-3f88ab27${_scopeId}>Çalışma Alanım</h1></div>`);
            if (__props.workspaces.length === 1) {
              _push2(`<div class="space-y-8" data-v-3f88ab27${_scopeId}><div class="overflow-hidden rounded-xl bg-card shadow-sm" data-v-3f88ab27${_scopeId}>`);
              if (__props.workspaces[0].images && __props.workspaces[0].images.length > 0) {
                _push2(`<div class="space-y-2 p-4" data-v-3f88ab27${_scopeId}><!--[-->`);
                ssrRenderList(__props.workspaces[0].images, (image, index) => {
                  _push2(`<div class="group relative w-full overflow-hidden rounded-lg" data-v-3f88ab27${_scopeId}><img${ssrRenderAttr("src", `/storage/${image}`)}${ssrRenderAttr("alt", `Çalışma Alanı Resim ${index + 1}`)} class="h-auto w-full object-cover transition-transform duration-300 group-hover:scale-105" data-v-3f88ab27${_scopeId}></div>`);
                });
                _push2(`<!--]--></div>`);
              } else {
                _push2(`<div class="flex aspect-video items-center justify-center bg-muted" data-v-3f88ab27${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-muted-foreground/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-3f88ab27${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-3f88ab27${_scopeId}></path></svg></div>`);
              }
              if (__props.workspaces[0].products && __props.workspaces[0].products.length > 0) {
                _push2(`<div class="p-6" data-v-3f88ab27${_scopeId}><div class="mb-3 hidden grid-cols-12 gap-4 border-b border-border pb-2 md:grid" data-v-3f88ab27${_scopeId}><div class="col-span-4" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>Ürün Adı</span></div><div class="col-span-5" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>Özellikler</span></div><div class="col-span-3 flex justify-end" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>İşlem</span></div></div><div class="space-y-3" data-v-3f88ab27${_scopeId}><!--[-->`);
                ssrRenderList(__props.workspaces[0].products, (product) => {
                  _push2(`<div class="grid grid-cols-12 items-center gap-4 py-2" data-v-3f88ab27${_scopeId}><div class="col-span-12 md:col-span-4" data-v-3f88ab27${_scopeId}><span class="text-sm font-medium text-foreground" data-v-3f88ab27${_scopeId}>${ssrInterpolate(product.name)}</span></div><div class="col-span-12 md:col-span-5" data-v-3f88ab27${_scopeId}>`);
                  if (product.features) {
                    _push2(`<p class="text-sm text-muted-foreground" data-v-3f88ab27${_scopeId}>${ssrInterpolate(product.features)}</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div><div class="col-span-12 flex justify-end md:col-span-3" data-v-3f88ab27${_scopeId}>`);
                  if (product.link) {
                    _push2(`<a${ssrRenderAttr("href", product.link)} target="_blank" rel="noopener noreferrer" class="text-sm text-primary transition-colors hover:text-primary/80" data-v-3f88ab27${_scopeId}> Satın Al </a>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div></div>`);
              ...
              _push2(`<div class="relative" data-v-3f88ab27${_scopeId}><div class="relative overflow-hidden rounded-xl bg-card shadow-sm" data-v-3f88ab27${_scopeId}><div class="flex transition-transform duration-500 ease-in-out" style="${ssrRenderStyle({ transform: `translateX(-${currentIndex.value * 100}%)` })}" data-v-3f88ab27${_scopeId}><!--[-->`);
              ssrRenderList(__props.workspaces, (workspace) => {
                _push2(`<div class="min-w-full flex-shrink-0" data-v-3f88ab27${_scopeId}>`);
                ...
                if (workspace.products && workspace.products.length > 0) {
                  _push2(`<div class="p-6" data-v-3f88ab27${_scopeId}><h2 class="mb-4 text-xl font-semibold text-foreground" data-v-3f88ab27${_scopeId}>Ürünler</h2><div class="mb-3 hidden grid-cols-12 gap-4 border-b border-border pb-2 md:grid" data-v-3f88ab27${_scopeId}><div class="col-span-4" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>Ürün Adı</span></div><div class="col-span-5" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>Özellikler</span></div><div class="col-span-3 flex justify-end" data-v-3f88ab27${_scopeId}><span class="text-xs font-medium uppercase tracking-wider text-muted-foreground" data-v-3f88ab27${_scopeId}>İşlem</span></div></div><div class="space-y-3" data-v-3f88ab27${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></div>`);
              if (__props.workspaces.length > 1) {
                _push2(`<button${ssrIncludeBooleanAttr(currentIndex.value === 0) ? " disabled" : ""} class="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-background/90 p-2 shadow-lg transition-all hover:bg-background disabled:cursor-not-allowed disabled:opacity-30" aria-label="Önceki" data-v-3f88ab27${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-3f88ab27${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-3f88ab27${_scopeId}></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              if (__props.workspaces.length > 1) {
                _push2(`<button${ssrIncludeBooleanAttr(currentIndex.value === __props.workspaces.length - 1) ? " disabled" : ""} class="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-background/90 p-2 shadow-lg transition-all hover:bg-background disabled:cursor-not-allowed disabled:opacity-30" aria-label="Sonraki" data-v-3f88ab27${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-3f88ab27${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" data-v-3f88ab27${_scopeId}></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              if (__props.workspaces.length > 1) {
                _push2(`<div class="absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2" data-v-3f88ab27${_scopeId}><!--[-->`);
                ssrRenderList(__props.workspaces, (workspace, index) => {
                  _push2(`<button class="${ssrRenderClass([currentIndex.value === index ? "w-8 bg-primary" : "w-2 bg-muted-foreground/30", "h-2 rounded-full transition-all"])}"${ssrRenderAttr("aria-label", `Çalışma alanı ${index + 1}`)} data-v-3f88ab27${_scopeId}></button>`);
                });
                _push2(`<!--]--></div>`);
              } else {
                _push2(`<!---->`);
              ...
              _push2(`<div class="rounded-xl border border-dashed border-border bg-card/50 py-16 text-center" data-v-3f88ab27${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 h-16 w-16 text-muted-foreground/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-3f88ab27${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-3f88ab27${_scopeId}></path></svg><h3 class="mb-2 text-lg font-medium text-foreground" data-v-3f88ab27${_scopeId}>Henüz çalışma alanı yok</h3><p class="text-sm text-muted-foreground" data-v-3f88ab27${_scopeId}>Çalışma alanları eklendiğinde burada görünecek.</p></div>`);
            }
            _push2(`</div>`);
          } else {
            return [
...
const IndexWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3f88ab27"]]);
export {
