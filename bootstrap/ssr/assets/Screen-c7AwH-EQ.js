import { computed, ref, watch, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, Fragment, renderList, withModifiers, withDirectives, vModelText, vModelSelect, withKeys, nextTick, useSSRContext } from "vue";
...
import _sfc_main$2 from "./BulkImportTab-D33JOH8s.js";
const _sfc_main = {
  __name: "Screen",
  ...
  setup(__props) {
    ...
    const activeTab = ref(hasBulkErrors.value || ((_a = page.props.flash) == null ? void 0 : _a.error) ? "bulk" : "single");
    watch(
      () => {
        var _a2;
        return [page.props.errors, (_a2 = page.props.flash) == null ? void 0 : _a2.error];
      },
      () => {
        var _a2;
        if (hasBulkErrors.value || ((_a2 = page.props.flash) == null ? void 0 : _a2.error)) {
