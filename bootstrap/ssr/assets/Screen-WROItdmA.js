import { ref, withCtx, unref, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, withDirectives, createTextVNode, vModelCheckbox, vModelText, withKeys, withModifiers, vModelSelect, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (unref(errors).word) {
                      _push3(`<label class="label"${_scopeId2}><span class="label-text-alt text-error"${_scopeId2}>${ssrInterpolate(unref(errors).word)}</span></label>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    ...
                    if (unref(errors).meaning) {
                      _push3(`<label class="label"${_scopeId2}><span class="label-text-alt text-error"${_scopeId2}>${ssrInterpolate(unref(errors).meaning)}</span></label>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    ...
                    if (unref(errors).type) {
                      _push3(`<label class="label"${_scopeId2}><span class="label-text-alt text-error"${_scopeId2}>${ssrInterpolate(unref(errors).type)}</span></label>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    ...
                    _push3(`<div class="divider"${_scopeId2}>Dil Paketleri</div>`);
                    _push3(ssrRenderComponent(_sfc_main$3, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (props.languagePacks.length === 0) {
                            ...
                            ssrRenderList(props.languagePacks, (pack) => {
                              _push4(`<div class="form-control"${_scopeId3}><label class="label cursor-pointer"${_scopeId3}><span class="label-text"${_scopeId3}>${ssrInterpolate(pack.name)} <span class="badge badge-sm badge-outline ml-1"${_scopeId3}>${ssrInterpolate(getLanguageName(pack.language))}</span></span><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).language_pack_ids) ? ssrLooseContain(unref(form).language_pack_ids, pack.id) : unref(form).language_pack_ids) ? " checked" : ""}${ssrRenderAttr("value", pack.id)} class="checkbox checkbox-sm"${_scopeId3}></label></div>`);
                            });
                            _push4(`<!--]--></div>`);
                          }
                          if (unref(errors).language_pack_ids) {
                            _push4(`<label class="label"${_scopeId3}><span class="label-text-alt text-error"${_scopeId3}>${ssrInterpolate(unref(errors).language_pack_ids)}</span></label>`);
                          } else {
                            _push4(`<!---->`);
                          }
                        } else {
                    ...
                    _push3(`<div class="divider"${_scopeId2}></div><div class="flex justify-end gap-2"${_scopeId2}><button type="button" class="btn btn-ghost"${_scopeId2}>İptal</button><button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId2}>`);
                    if (processing.value) {
            ...
            return [
              ...
              props.word ? (openBlock(), createBlock(_sfc_main$3, {
                key: 2,
                elevated: ""
              }, {
                default: withCtx(() => [
