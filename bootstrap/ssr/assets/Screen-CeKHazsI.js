    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="container mx-auto max-w-7xl px-4 py-6" data-v-df723a0d${_scopeId}><div class="mb-8" data-v-df723a0d${_scopeId}><div class="flex items-center justify-between" data-v-df723a0d${_scopeId}><div data-v-df723a0d${_scopeId}><h1 class="text-3xl font-bold tracking-tight" data-v-df723a0d${_scopeId}>${ssrInterpolate(((_a = props.pack) == null ? void 0 : _a.name) || "Kelimeler")}</h1><p class="text-muted-foreground mt-1" data-v-df723a0d${_scopeId}>${ssrInterpolate(((_b = props.words) == null ? void 0 : _b.length) || 0)} kelime bulundu</p></div></div></div>`);
            if (!showGameInterface.value) {
              _push2(`<div class="mb-6 space-y-4" data-v-df723a0d${_scopeId}><div class="flex max-w-sm gap-3" data-v-df723a0d${_scopeId}><div class="flex-1" data-v-df723a0d${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Kelime veya anlam ara..." class="input-bordered input w-full" data-v-df723a0d${_scopeId}></div><button class="btn btn-sm bg-base-content text-base-100 hover:bg-base-300 hover:text-base-content" data-v-df723a0d${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" data-v-df723a0d${_scopeId}></path></svg></button></div><div class="space-y-3" data-v-df723a0d${_scopeId}><div class="flex flex-wrap gap-2" data-v-df723a0d${_scopeId}><button class="btn btn-outline"${ssrIncludeBooleanAttr(!hasEnoughWords.value) ? " disabled" : ""} data-v-df723a0d${_scopeId}> Çoktan Seçmeli </button><button class="btn btn-outline"${ssrIncludeBooleanAttr(!hasEnoughWords.value) ? " disabled" : ""} data-v-df723a0d${_scopeId}> Boşluk Doldurma </button><button class="btn btn-outline"${ssrIncludeBooleanAttr(!hasEnoughWords.value) ? " disabled" : ""} data-v-df723a0d${_scopeId}> Kelime Tamamlama </button></div><div class="flex flex-wrap gap-2" data-v-df723a0d${_scopeId}><select class="select-bordered select" data-v-df723a0d${_scopeId}><option value="all" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "all") : ssrLooseEqual(gameConfig.value.smartFilter, "all")) ? " selected" : ""}${_scopeId}>Tüm Kelimeler</option><option value="never-answered" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "never-answered") : ssrLooseEqual(gameConfig.value.smartFilter, "never-answered")) ? " selected" : ""}${_scopeId}>Hiç Cevaplanmamış</option><option value="most-mistakes" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "most-mistakes") : ssrLooseEqual(gameConfig.value.smartFilter, "most-mistakes")) ? " selected" : ""}${_scopeId}>Çok Hata Yapılan</option><option value="flagged" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "flagged") : ssrLooseEqual(gameConfig.value.smartFilter, "flagged")) ? " selected" : ""}${_scopeId}>İşaretlenen</option><option value="unlearned" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "unlearned") : ssrLooseEqual(gameConfig.value.smartFilter, "unlearned")) ? " selected" : ""}${_scopeId}>Öğrenilmemiş</option><option value="nouns" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "nouns") : ssrLooseEqual(gameConfig.value.smartFilter, "nouns")) ? " selected" : ""}${_scopeId}>İsimler</option><option value="verbs" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "verbs") : ssrLooseEqual(gameConfig.value.smartFilter, "verbs")) ? " selected" : ""}${_scopeId}>Fiiller</option><option value="adjectives" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.smartFilter) ? ssrLooseContain(gameConfig.value.smartFilter, "adjectives") : ssrLooseEqual(gameConfig.value.smartFilter, "adjectives")) ? " selected" : ""}${_scopeId}>Sıfatlar</option></select><select class="select-bordered select" data-v-df723a0d${_scopeId}><option value="5" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "5") : ssrLooseEqual(gameConfig.value.questionCount, "5")) ? " selected" : ""}${_scopeId}>5 Soru</option><option value="10" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "10") : ssrLooseEqual(gameConfig.value.questionCount, "10")) ? " selected" : ""}${_scopeId}>10 Soru</option><option value="15" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "15") : ssrLooseEqual(gameConfig.value.questionCount, "15")) ? " selected" : ""}${_scopeId}>15 Soru</option><option value="20" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "20") : ssrLooseEqual(gameConfig.value.questionCount, "20")) ? " selected" : ""}${_scopeId}>20 Soru</option><option value="25" data-v-df723a0d${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "25") : ssrLooseEqual(gameConfig.value.questionCount, "25")) ? " selected" : ""}${_scopeId}>25 Soru</option></select><button class="btn btn-outline" data-v-df723a0d${_scopeId}>Sıfırla</button></div>`);
              if (gameConfig.value.smartFilter !== "all") {
                _push2(`<div class="rounded-lg bg-base-200 p-3" data-v-df723a0d${_scopeId}><div class="flex items-center justify-between" data-v-df723a0d${_scopeId}><div class="flex items-center gap-2 text-sm" data-v-df723a0d${_scopeId}><svg class="text-base-content/70 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-df723a0d${_scopeId}></path></svg><span class="text-base-content/70" data-v-df723a0d${_scopeId}>${ssrInterpolate(getFilterDescription(gameConfig.value.smartFilter).description)} <span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(filteredWordsForGame.value.length)} kelime</span> bulundu. </span></div><button class="btn btn-outline btn-xs"${ssrIncludeBooleanAttr(filteredWordsForGame.value.length === 0) ? " disabled" : ""} data-v-df723a0d${_scopeId}><svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-df723a0d${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-df723a0d${_scopeId}></path></svg> Detayları Gör </button></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            if (showGameInterface.value) {
              _push2(`<div class="my-8" data-v-df723a0d${_scopeId}><div class="mb-4 flex justify-end" data-v-df723a0d${_scopeId}><button class="btn btn-outline btn-sm" data-v-df723a0d${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-df723a0d${_scopeId}></path></svg> Oyunu Durdur </button></div>`);
              if (loadingGame.value) {
                _push2(`<div class="flex h-60 items-center justify-center" data-v-df723a0d${_scopeId}><div class="loading loading-spinner loading-lg" data-v-df723a0d${_scopeId}></div></div>`);
              ...
              _push2(`<div data-v-df723a0d${_scopeId}><div class="rounded-lg border border-base-300" data-v-df723a0d${_scopeId}><div class="relative w-full overflow-auto" data-v-df723a0d${_scopeId}><table class="w-full caption-bottom text-sm" data-v-df723a0d${_scopeId}><thead class="[&amp;_tr]:border-b" data-v-df723a0d${_scopeId}><tr class="border-b border-base-300 transition-colors hover:bg-base-200" data-v-df723a0d${_scopeId}><th class="text-base-content/70 h-10 px-2 text-left align-middle font-medium [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}> Kelime </th><th class="text-base-content/70 h-10 px-2 text-left align-middle font-medium [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}> Anlam </th><th class="text-base-content/70 h-10 px-2 text-left align-middle font-medium [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}> İşlem </th></tr></thead><tbody class="[&amp;_tr:last-child]:border-0" data-v-df723a0d${_scopeId}>`);
              if (isLoading.value) {
                _push2(`<tr class="border-b border-base-300 transition-colors hover:bg-base-200" data-v-df723a0d${_scopeId}><td colspan="3" class="p-4 text-center" data-v-df723a0d${_scopeId}><div class="loading loading-spinner loading-md" data-v-df723a0d${_scopeId}></div></td></tr>`);
              } else if (displayedWords.value.length === 0) {
                _push2(`<tr class="border-b border-base-300 transition-colors hover:bg-base-200" data-v-df723a0d${_scopeId}><td colspan="3" class="text-base-content/70 p-4 text-center" data-v-df723a0d${_scopeId}>Sonuç bulunamadı</td></tr>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(displayedWords.value, (word) => {
                _push2(`<tr class="cursor-pointer border-b border-base-300 transition-colors hover:bg-base-200" data-v-df723a0d${_scopeId}><td class="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}><div class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(word.word)}</div></td><td class="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}><div class="text-base-content/70" data-v-df723a0d${_scopeId}>${ssrInterpolate(getPrimaryMeaning(word))}</div></td><td class="p-2 align-middle [&amp;:has([role=checkbox])]:pr-0 [&amp;&gt;[role=checkbox]]:translate-y-[2px]" data-v-df723a0d${_scopeId}><div class="flex items-center gap-2" data-v-df723a0d${_scopeId}><button class="btn btn-ghost btn-xs btn-square" data-v-df723a0d${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-df723a0d${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-df723a0d${_scopeId}></path></svg></button>`);
                if (isLoggedIn.value) {
              ...
              if (filteredWordsForGame.value.length > perPage.value) {
                _push2(`<div class="mt-4 flex items-center justify-between" data-v-df723a0d${_scopeId}><div class="text-base-content/70 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(paginationInfo.value)}</div><div class="flex items-center space-x-2" data-v-df723a0d${_scopeId}><button${ssrIncludeBooleanAttr(currentPage.value <= 1) ? " disabled" : ""} class="btn btn-outline" data-v-df723a0d${_scopeId}> Önceki </button><span class="text-sm font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(currentPage.value)}</span><button${ssrIncludeBooleanAttr(currentPage.value >= totalPages.value) ? " disabled" : ""} class="btn btn-outline" data-v-df723a0d${_scopeId}> Sonraki </button></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_f = props.words) == null ? void 0 : _f.length) === 0) {
                _push2(`<div class="mt-8 text-center" data-v-df723a0d${_scopeId}><div class="text-base-content/40 mx-auto h-12 w-12" data-v-df723a0d${_scopeId}><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-df723a0d${_scopeId}></path></svg></div><h3 class="mt-4 text-lg font-semibold text-base-content" data-v-df723a0d${_scopeId}>Kelime bulunamadı</h3><p class="text-base-content/70 mt-2" data-v-df723a0d${_scopeId}>Bu pakette henüz kelime bulunmamaktadır.</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (selectedWord.value) {
              _push2(`<div class="bg-base-content/20 fixed inset-0 z-50" data-v-df723a0d${_scopeId}><div class="fixed left-[50%] top-[50%] z-50 flex grid max-h-[80vh] w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] flex-col gap-4 border border-base-300 bg-base-100 shadow-xl duration-200 sm:rounded-xl" data-v-df723a0d${_scopeId}><div class="flex flex-shrink-0 flex-col space-y-1.5 border-b border-base-300 bg-base-100 p-6 pb-4 text-center sm:text-left" data-v-df723a0d${_scopeId}><div class="flex items-center justify-between" data-v-df723a0d${_scopeId}><h3 class="text-lg font-semibold leading-none tracking-tight text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(selectedWord.value.word)}</h3><button class="btn btn-ghost btn-xs btn-square" data-v-df723a0d${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-df723a0d${_scopeId}></path></svg></button></div><p class="text-base-content/70 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(getWordTypeLabel(selectedWord.value.type))} • ${ssrInterpolate(getDifficultyLabel(selectedWord.value.difficulty_level))}</p></div><div class="flex-1 overflow-y-auto p-6 pt-4" data-v-df723a0d${_scopeId}><div class="space-y-4" data-v-df723a0d${_scopeId}><div data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Anlamlar</h4><div class="mt-2 space-y-2" data-v-df723a0d${_scopeId}><!--[-->`);
              ssrRenderList(selectedWord.value.meanings, (meaning, index) => {
                _push2(`<div class="${ssrRenderClass([meaning.is_primary ? "bg-base-content text-base-100" : "bg-base-200", "flex items-start gap-3 rounded-lg border border-base-300 p-3"])}" data-v-df723a0d${_scopeId}><span class="${ssrRenderClass([meaning.is_primary ? "bg-base-100 text-base-content" : "bg-base-300 text-base-content", "flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full text-xs font-medium"])}" data-v-df723a0d${_scopeId}>${ssrInterpolate(index + 1)}</span><div class="min-w-0 flex-1" data-v-df723a0d${_scopeId}><span class="${ssrRenderClass([meaning.is_primary ? "text-base-100" : "text-base-content", "text-sm"])}" data-v-df723a0d${_scopeId}>${ssrInterpolate(meaning.meaning)}</span>`);
                if (meaning.is_primary) {
                  _push2(`<span class="${ssrRenderClass([meaning.is_primary ? "bg-base-100 text-base-content" : "bg-base-300 text-base-content", "ml-2 inline-flex items-center rounded-full px-2 py-1 text-xs font-medium"])}" data-v-df723a0d${_scopeId}> Birincil </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
              });
              _push2(`<!--]--></div></div><div class="grid grid-cols-2 gap-4" data-v-df723a0d${_scopeId}><div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Öğrenme Durumu</h4><div class="text-base-content/70 mt-2 space-y-1 text-sm" data-v-df723a0d${_scopeId}><div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>Durum:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(getLearningStatusLabel(selectedWord.value.learning_status))}</span></div><div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>Toplam:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(selectedWord.value.review_count || 0)}</span></div><div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>Yanlış:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(selectedWord.value.incorrect_count || 0)}</span></div><div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>Başarı:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(calculateSuccessRate(selectedWord.value).label)}</span></div></div></div><div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Diğer Bilgiler</h4><div class="text-base-content/70 mt-2 space-y-1 text-sm" data-v-df723a0d${_scopeId}>`);
              if (selectedWord.value.synonyms && selectedWord.value.synonyms.length > 0) {
                _push2(`<div data-v-df723a0d${_scopeId}><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>Eş Anlamlılar:</span><div class="mt-1 flex flex-wrap gap-1" data-v-df723a0d${_scopeId}><!--[-->`);
                ssrRenderList(selectedWord.value.synonyms, (synonym) => {
                  _push2(`<span class="inline-flex items-center rounded-md bg-base-300 px-2 py-1 text-xs text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(typeof synonym === "object" ? synonym.synonym : synonym)}</span>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              if (selectedWord.value.flag) {
                _push2(`<div class="flex items-center gap-1" data-v-df723a0d${_scopeId}><svg class="h-4 w-4 text-base-content" fill="currentColor" viewBox="0 0 20 20" data-v-df723a0d${_scopeId}><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" data-v-df723a0d${_scopeId}></path></svg><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>Öne çıkarılmış</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div>`);
              if (selectedWord.value.example_sentences && selectedWord.value.example_sentences.length > 0) {
                _push2(`<div data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Örnek Cümleler</h4><div class="mt-2 space-y-2" data-v-df723a0d${_scopeId}><!--[-->`);
                ssrRenderList(selectedWord.value.example_sentences, (sentence, index) => {
                  _push2(`<div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><div class="flex items-start gap-3" data-v-df723a0d${_scopeId}><span class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-base-content text-xs font-medium text-base-100" data-v-df723a0d${_scopeId}>${ssrInterpolate(index + 1)}</span><div class="min-w-0 flex-1" data-v-df723a0d${_scopeId}><p class="text-sm font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(getSentenceText(sentence))}</p>`);
                  if (getSentenceTranslation(sentence)) {
                    _push2(`<p class="text-base-content/70 mt-1 text-xs" data-v-df723a0d${_scopeId}>${ssrInterpolate(getSentenceTranslation(sentence))}</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div></div></div>`);
              ...
              _push2(`</div></div><div class="flex flex-shrink-0 flex-col-reverse border-t border-base-300 bg-base-100 p-6 pt-4 sm:flex-row sm:justify-end sm:space-x-2" data-v-df723a0d${_scopeId}><button class="btn btn-outline" data-v-df723a0d${_scopeId}>Kapat</button>`);
              if (isLoggedIn.value) {
                _push2(ssrRenderComponent(unref(Link), {
            ...
            if (showFilteredWordsModal.value) {
              _push2(`<div class="bg-base-content/20 fixed inset-0 z-50" data-v-df723a0d${_scopeId}><div class="fixed left-[50%] top-[50%] z-50 flex grid max-h-[80vh] w-full max-w-4xl translate-x-[-50%] translate-y-[-50%] flex-col gap-4 border border-base-300 bg-base-100 shadow-xl duration-200 sm:rounded-xl" data-v-df723a0d${_scopeId}><div class="flex flex-shrink-0 flex-col space-y-1.5 border-b border-base-300 bg-base-100 p-6 pb-4 text-center sm:text-left" data-v-df723a0d${_scopeId}><div class="flex items-center justify-between" data-v-df723a0d${_scopeId}><div data-v-df723a0d${_scopeId}><h3 class="text-lg font-semibold leading-none tracking-tight text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(getFilterDescription(gameConfig.value.smartFilter).title)}</h3><p class="text-base-content/70 mt-1 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(filteredWordsForGame.value.length)} kelime bulundu</p></div><button class="btn btn-ghost btn-xs btn-square" data-v-df723a0d${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-df723a0d${_scopeId}></path></svg></button></div><p class="text-base-content/70 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(getFilterDescription(gameConfig.value.smartFilter).description)}</p></div><div class="flex-1 overflow-y-auto p-6 pt-4" data-v-df723a0d${_scopeId}><div class="space-y-4" data-v-df723a0d${_scopeId}><div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><h4 class="mb-2 text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Filtre Kriterleri</h4><p class="text-base-content/70 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(getFilterDescription(gameConfig.value.smartFilter).criteria)}</p></div><div class="space-y-2" data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Filtrelenmiş Kelimeler</h4><div class="max-h-96 overflow-y-auto" data-v-df723a0d${_scopeId}><div class="space-y-2" data-v-df723a0d${_scopeId}><!--[-->`);
              ssrRenderList(filteredWordsForGame.value, (word, index) => {
                _push2(`<div class="flex cursor-pointer items-center justify-between rounded-lg border border-base-300 bg-base-200 p-3 transition-colors hover:bg-base-300" data-v-df723a0d${_scopeId}><div class="flex items-center gap-3" data-v-df723a0d${_scopeId}><span class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-base-content text-xs font-medium text-base-100" data-v-df723a0d${_scopeId}>${ssrInterpolate(index + 1)}</span><div data-v-df723a0d${_scopeId}><div class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(word.word)}</div><div class="text-base-content/70 text-sm" data-v-df723a0d${_scopeId}>${ssrInterpolate(getPrimaryMeaning(word))}</div></div></div><div class="flex items-center gap-2" data-v-df723a0d${_scopeId}><span class="badge bg-base-300 text-xs text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(getWordTypeLabel(word.type))}</span><span class="badge bg-base-content text-xs text-base-100" data-v-df723a0d${_scopeId}>${ssrInterpolate(getDifficultyLabel(word.difficulty_level))}</span><span class="badge bg-base-200 text-xs text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(getLearningStatusLabel(word.learning_status))}</span><button class="btn btn-ghost btn-xs btn-square" data-v-df723a0d${_scopeId}><svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-df723a0d${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-df723a0d${_scopeId}></path></svg></button></div></div>`);
              });
              _push2(`<!--]--></div></div></div><div class="grid grid-cols-2 gap-4" data-v-df723a0d${_scopeId}><div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Tür Dağılımı</h4><div class="text-base-content/70 mt-2 space-y-1 text-sm" data-v-df723a0d${_scopeId}><!--[-->`);
              ssrRenderList(getWordTypeStats(filteredWordsForGame.value), (count, type) => {
                _push2(`<div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>${ssrInterpolate(getWordTypeLabel(type))}:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(count)}</span></div>`);
              });
              _push2(`<!--]--></div></div><div class="rounded-lg border border-base-300 bg-base-200 p-3" data-v-df723a0d${_scopeId}><h4 class="text-sm font-medium leading-none text-base-content" data-v-df723a0d${_scopeId}>Zorluk Dağılımı</h4><div class="text-base-content/70 mt-2 space-y-1 text-sm" data-v-df723a0d${_scopeId}><!--[-->`);
              ssrRenderList(getDifficultyStats(filteredWordsForGame.value), (count, level) => {
                _push2(`<div class="flex justify-between" data-v-df723a0d${_scopeId}><span data-v-df723a0d${_scopeId}>${ssrInterpolate(getDifficultyLabel(level))}:</span><span class="font-medium text-base-content" data-v-df723a0d${_scopeId}>${ssrInterpolate(count)}</span></div>`);
              });
              _push2(`<!--]--></div></div></div></div></div><div class="flex flex-shrink-0 flex-col-reverse border-t border-base-300 bg-base-100 p-6 pt-4 sm:flex-row sm:justify-end sm:space-x-2" data-v-df723a0d${_scopeId}><button class="btn btn-outline" data-v-df723a0d${_scopeId}>Kapat</button><button class="btn bg-base-content text-base-100 hover:bg-base-300 hover:text-base-content" data-v-df723a0d${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-df723a0d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-df723a0d${_scopeId}></path></svg> Dışa Aktar </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df723a0d"]]);
export {
  Screen as default
};
