import { ref, withCtx, unref, createTextVNode, createVNode, toDisplayString, withModifiers, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex justify-end gap-2 border-t border-border mt-4 pt-4"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: `/customers/${unref(customer).id}`,
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Güncelleniyor..." : "Müşteriyi Güncelle")}</button></div></div></div></form></div>`);
          } else {
            return [
              createVNode("div", { class: "mx-auto max-w-4xl" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("h1", { class: "text-xl font-semibold text-foreground" }, "Müşteriyi Düzenle"),
                  createVNode("p", { class: "mt-1 text-xs text-muted-foreground" }, toDisplayString(unref(customer).first_name) + " " + toDisplayString(unref(customer).last_name), 1)
                ]),
                createVNode("form", {
                    ...
                    createVNode("div", { class: "space-y-4" }, [
                      createVNode("div", { class: "grid grid-cols-1 gap-4 md:grid-cols-2" }, [
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "İlk İsmi"),
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Soy İsmi"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "E-posta"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Telefon"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Adres"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Şehir"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Bölge"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Posta Kodu"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Ülke"),
                          withDirectives(createVNode("input", {
                      ...
                      createVNode("div", { class: "flex justify-end gap-2 border-t border-border mt-4 pt-4" }, [
                        ...
                        createVNode("button", {
                          ...
                          createTextVNode(" " + toDisplayString(unref(form).processing ? "Güncelleniyor..." : "Müşteriyi Güncelle"), 1)
                        ], 8, ["disabled"])
                      ])
                    ])
                  ])
