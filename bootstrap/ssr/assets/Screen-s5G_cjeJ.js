          ...
          if (_push2) {
            ...
            if (isLoggedIn.value) {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 h-4 w-4"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6"${_scopeId2}></path></svg> Yeni Kelime Ekle `);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
            ...
            return [
              createVNode("div", { class: "p-6 pt-12 sm:p-8 sm:pt-16" }, [
                createVNode("div", { class: "mb-8" }, [
                  ...
                  createVNode("p", { class: "text-muted-foreground mt-2 text-sm" }, "Kelime arayın, anlamlarını öğrenin")
                ]),
                createVNode("div", { class: "mb-8" }, [
