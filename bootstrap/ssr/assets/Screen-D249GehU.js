import { computed, ref, onMounted, watch, withCtx, unref, createTextVNode, createVNode, toDisplayString, withModifiers, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, Fragment, renderList, vModelSelect, vModelCheckbox, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="mt-1 text-xs text-muted-foreground"${_scopeId}> Bu projeye ait yazıların bulunduğu kategoriyi seçin. </p></div></div><div class="space-y-4 border-t border-border mt-4 pt-4"${_scopeId}><h3 class="text-xs font-semibold text-foreground"${_scopeId}>Hizmetler</h3>`);
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Güncelleniyor..." : "Projeyi Güncelle")}</button></div></div></form></div>`);
          } else {
            return [
              createVNode("div", { class: "mx-auto max-w-4xl" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("h1", { class: "text-xl font-semibold text-foreground" }, "Projeyi Düzenle"),
                  createVNode("p", { class: "mt-1 text-xs text-muted-foreground" }, toDisplayString(project.value.project_name), 1)
                ]),
                createVNode("form", {
