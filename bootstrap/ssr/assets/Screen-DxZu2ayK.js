...
import _sfc_main$2 from "./MultipleChoice-BrLhjuPu.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="card border border-gray-200 bg-white shadow-lg transition-all duration-200 dark:border-gray-700 dark:bg-base-100" data-v-48c2dbfa${_scopeId}><div class="card-body p-6" data-v-48c2dbfa${_scopeId}><div class="mb-4 flex items-center justify-between" data-v-48c2dbfa${_scopeId}><div class="flex-1" data-v-48c2dbfa${_scopeId}><h1 class="text-2xl font-bold" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(((_a = props.pack) == null ? void 0 : _a.name) || "Kelimeler")} <span class="badge badge-outline ml-2" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(((_b = props.words) == null ? void 0 : _b.length) || 0)} kelime</span></h1></div><div class="flex gap-2" data-v-48c2dbfa${_scopeId}>`);
            ...
            _push2(`</div></div><div class="divider my-2" data-v-48c2dbfa${_scopeId}></div>`);
            if (!showGameInterface.value) {
              _push2(`<div class="mb-4 flex flex-wrap gap-3" data-v-48c2dbfa${_scopeId}><div class="form-control min-w-[200px] flex-1" data-v-48c2dbfa${_scopeId}><div class="input-group" data-v-48c2dbfa${_scopeId}><input type="text"${ssrRenderAttr("value", searchQuery.value)} placeholder="Kelime ara..." class="input-bordered input input-sm w-full" data-v-48c2dbfa${_scopeId}><button class="btn btn-sm btn-square" data-v-48c2dbfa${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-48c2dbfa${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-48c2dbfa${_scopeId}></path></svg></button></div></div><select class="select-bordered select select-sm min-w-[150px] flex-1" data-v-48c2dbfa${_scopeId}><option value="" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterType.value) ? ssrLooseContain(filterType.value, "") : ssrLooseEqual(filterType.value, "")) ? " selected" : ""}${_scopeId}>Tüm Türler</option><option value="noun" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterType.value) ? ssrLooseContain(filterType.value, "noun") : ssrLooseEqual(filterType.value, "noun")) ? " selected" : ""}${_scopeId}>İsim</option><option value="verb" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterType.value) ? ssrLooseContain(filterType.value, "verb") : ssrLooseEqual(filterType.value, "verb")) ? " selected" : ""}${_scopeId}>Fiil</option><option value="adjective" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterType.value) ? ssrLooseContain(filterType.value, "adjective") : ssrLooseEqual(filterType.value, "adjective")) ? " selected" : ""}${_scopeId}>Sıfat</option><option value="adverb" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterType.value) ? ssrLooseContain(filterType.value, "adverb") : ssrLooseEqual(filterType.value, "adverb")) ? " selected" : ""}${_scopeId}>Zarf</option></select><select class="select-bordered select select-sm min-w-[150px] flex-1" data-v-48c2dbfa${_scopeId}><option value="" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "") : ssrLooseEqual(filterStatus.value, "")) ? " selected" : ""}${_scopeId}>Tüm Durumlar</option><option value="0" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "0") : ssrLooseEqual(filterStatus.value, "0")) ? " selected" : ""}${_scopeId}>Öğrenilmedi</option><option value="1" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "1") : ssrLooseEqual(filterStatus.value, "1")) ? " selected" : ""}${_scopeId}>Öğreniliyor</option><option value="2" data-v-48c2dbfa${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "2") : ssrLooseEqual(filterStatus.value, "2")) ? " selected" : ""}${_scopeId}>Öğrenildi</option></select></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showGameInterface.value) {
              _push2(`<div data-v-48c2dbfa${_scopeId}>`);
              if (loadingGame.value) {
                _push2(`<div class="flex h-60 items-center justify-center" data-v-48c2dbfa${_scopeId}><span class="loading loading-spinner loading-lg" data-v-48c2dbfa${_scopeId}></span></div>`);
              ...
              if (hasEnoughWords.value) {
                _push2(`<div class="mb-6 rounded-lg border border-base-300 bg-base-100 p-4" data-v-48c2dbfa${_scopeId}><div class="flex flex-wrap items-center gap-4" data-v-48c2dbfa${_scopeId}><div class="form-control" data-v-48c2dbfa${_scopeId}><label class="label cursor-pointer gap-2" data-v-48c2dbfa${_scopeId}><span class="label-text" data-v-48c2dbfa${_scopeId}>Soru Sayısı: ${ssrInterpolate(gameConfig.value.questionCount)}</span><input type="range" min="5" max="20"${ssrRenderAttr("value", gameConfig.value.questionCount)} class="range range-primary range-xs" data-v-48c2dbfa${_scopeId}></label></div><div class="form-control" data-v-48c2dbfa${_scopeId}><label class="label cursor-pointer" data-v-48c2dbfa${_scopeId}><span class="label-text mr-2" data-v-48c2dbfa${_scopeId}>Öğrenilmemiş Kelimelere Öncelik Ver</span><input type="checkbox" class="toggle toggle-sm"${ssrIncludeBooleanAttr(Array.isArray(prioritizeUnlearned.value) ? ssrLooseContain(prioritizeUnlearned.value, null) : prioritizeUnlearned.value) ? " checked" : ""} data-v-48c2dbfa${_scopeId}></label></div><div class="divider divider-horizontal" data-v-48c2dbfa${_scopeId}></div><div class="grid grid-cols-3 gap-2" data-v-48c2dbfa${_scopeId}><!--[-->`);
                ssrRenderList(games, (game) => {
                  _push2(`<button class="${ssrRenderClass([{ "btn-primary": currentGame.value === game.route, "btn-outline": currentGame.value !== game.route }, "btn btn-sm"])}" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(game.name)}</button>`);
                });
                _push2(`<!--]--></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="overflow-x-auto" data-v-48c2dbfa${_scopeId}><table class="table table-zebra" data-v-48c2dbfa${_scopeId}><thead data-v-48c2dbfa${_scopeId}><tr data-v-48c2dbfa${_scopeId}><th data-v-48c2dbfa${_scopeId}>Kelime</th><th data-v-48c2dbfa${_scopeId}>Anlam</th><th data-v-48c2dbfa${_scopeId}>Tür</th><th data-v-48c2dbfa${_scopeId}>Durum</th><th data-v-48c2dbfa${_scopeId}>Zorluk</th>`);
              if (isLoggedIn.value) {
                _push2(`<th data-v-48c2dbfa${_scopeId}></th>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</tr></thead><tbody data-v-48c2dbfa${_scopeId}>`);
              if (isLoading.value) {
                _push2(`<tr data-v-48c2dbfa${_scopeId}><td colspan="6" class="text-center" data-v-48c2dbfa${_scopeId}><span class="loading loading-spinner loading-md" data-v-48c2dbfa${_scopeId}></span></td></tr>`);
              } else if (displayedWords.value.length === 0) {
                _push2(`<tr data-v-48c2dbfa${_scopeId}><td colspan="6" class="text-center" data-v-48c2dbfa${_scopeId}>Sonuç bulunamadı</td></tr>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(displayedWords.value, (word) => {
                _push2(`<tr data-v-48c2dbfa${_scopeId}><td class="font-medium" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(word.word)}</td><td data-v-48c2dbfa${_scopeId}>${ssrInterpolate(getPrimaryMeaning(word))}</td><td data-v-48c2dbfa${_scopeId}><div class="badge" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(word.type)}</div></td><td data-v-48c2dbfa${_scopeId}><div class="${ssrRenderClass([getLearningStatusBadgeClass(word.learning_status), "badge badge-sm"])}" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(getLearningStatusLabel(word.learning_status))}</div></td><td data-v-48c2dbfa${_scopeId}><div class="${ssrRenderClass([getDifficultyBadgeClass(word.difficulty_level), "badge badge-sm"])}" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(getDifficultyLabel(word.difficulty_level))}</div></td>`);
                if (isLoggedIn.value) {
                  _push2(`<td data-v-48c2dbfa${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
              ...
              if (filteredWordList.value.length > perPage.value) {
                _push2(`<div class="mt-4 flex justify-between" data-v-48c2dbfa${_scopeId}><div data-v-48c2dbfa${_scopeId}><span class="text-sm opacity-70" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(paginationInfo.value)}</span></div><div class="join" data-v-48c2dbfa${_scopeId}><button class="btn btn-sm join-item"${ssrIncludeBooleanAttr(currentPage.value <= 1) ? " disabled" : ""} data-v-48c2dbfa${_scopeId}> « </button><button class="btn btn-sm join-item" data-v-48c2dbfa${_scopeId}>${ssrInterpolate(currentPage.value)}</button><button class="btn btn-sm join-item"${ssrIncludeBooleanAttr(currentPage.value >= totalPages.value) ? " disabled" : ""} data-v-48c2dbfa${_scopeId}> » </button></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_f = props.words) == null ? void 0 : _f.length) === 0) {
                _push2(`<div class="alert alert-info mt-6" data-v-48c2dbfa${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-6 w-6 shrink-0 stroke-current" data-v-48c2dbfa${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-48c2dbfa${_scopeId}></path></svg><span data-v-48c2dbfa${_scopeId}>Bu pakette kelime bulunmamaktadır.</span></div>`);
              } else if (!hasEnoughWords.value) {
                _push2(`<div class="alert alert-warning mt-6" data-v-48c2dbfa${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-6 w-6 shrink-0 stroke-current" data-v-48c2dbfa${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" data-v-48c2dbfa${_scopeId}></path></svg><span data-v-48c2dbfa${_scopeId}>Oyunları başlatabilmek için en az 5 kelime gerekiyor.</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-48c2dbfa"]]);
export {
  Screen as default
};
