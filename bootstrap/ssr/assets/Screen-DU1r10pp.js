import { computed, ref, withCtx, unref, createTextVNode, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, withModifiers, withDirectives, vModelText, vModelSelect, Fragment, renderList, withKeys, vModelCheckbox, nextTick, useSSRContext } from "vue";
                        ...
                        createVNode("div", { class: "rounded-lg bg-muted/50 p-3 text-center" }, [
                          createVNode("label", { class: "flex cursor-pointer flex-col items-center gap-1" }, [
                            withDirectives(createVNode("input", {
                              ...
                              class: "h-5 w-5 rounded border-2 border-input bg-background text-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:border-muted-foreground"
                            }, null, 8, ["onUpdate:modelValue"]), [
