import { ref, computed, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, withModifiers, createCommentVNode, withDirectives, vModelText, vModelCheckbox, vModelSelect, useSSRContext } from "vue";
                  ...
                  selectedTheme.value === "custom" ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "modal-box max-w-6xl" }, [
                      ...
                      createVNode("div", { class: "mt-6" }, [
                        ...
                        createVNode("div", { class: "mt-4" }, [
                          createVNode("div", { class: "card bg-card p-4" }, [
                            createVNode("h5", { class: "font-semibold" }, "Örnek Card"),
                            createVNode("p", { class: "text-muted-foreground text-sm" }, "Bu bir örnek card'tır.")
                          ])
                        ])
                      ]),
                      createVNode("div", { class: "modal-action" }, [
