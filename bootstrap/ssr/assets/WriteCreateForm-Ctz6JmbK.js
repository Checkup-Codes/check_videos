...
import { ssrRenderComponent, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { usePage, useForm } from "@inertiajs/vue3";
import { _ as _sfc_main$1, a as _sfc_main$2 } from "./Form-DJzmk4H_.js";
import { _ as _sfc_main$3 } from "./RichTextEditor-DMNxOCyR.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ onSubmit: createWrite }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-4"${_scopeId}><label for="status" class="mb-1 block text-sm font-bold text-theme-text"${_scopeId}>Durumu:</label><select id="status" class="mt-1 block w-full rounded border-gray-300"${_scopeId}><option value="draft"${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "draft") : ssrLooseEqual(unref(form).status, "draft")) ? " selected" : ""}${_scopeId}>Şablon</option><option value="published"${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "published") : ssrLooseEqual(unref(form).status, "published")) ? " selected" : ""}${_scopeId}>Yayında</option><option value="private"${ssrIncludeBooleanAttr(Array.isArray(unref(form).status) ? ssrLooseContain(unref(form).status, "private") : ssrLooseEqual(unref(form).status, "private")) ? " selected" : ""}${_scopeId}>Gizli</option></select>`);
            if (errors.value.status) {
              _push2(`<p class="text-sm text-red-500"${_scopeId}>${ssrInterpolate(errors.value.status)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="mb-4"${_scopeId}><label for="category_id" class="mb-1 block text-sm font-bold text-theme-text"${_scopeId}>Kategori:</label><select id="category_id" class="mt-1 block w-full rounded border-gray-300"${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).category_id) ? ssrLooseContain(unref(form).category_id, "") : ssrLooseEqual(unref(form).category_id, "")) ? " selected" : ""}${_scopeId}>Kategori seç</option><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-4" }, [
                createVNode("label", {
                  for: "status",
                  class: "mb-1 block text-sm font-bold text-theme-text"
                }, "Durumu:"),
              ...
              createVNode("div", { class: "mb-4 flex items-center" }, [
                createVNode("label", {
                  for: "hasDraw",
                  class: "mb-1 mr-2 text-sm font-bold text-theme-text"
                }, "Çizim Var Mı?"),
                withDirectives(createVNode("input", {
