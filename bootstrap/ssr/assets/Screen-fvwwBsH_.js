        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (unref(test).description) {
              _push2(`<div class="text-sm leading-6 text-muted-foreground"${_scopeId}>${ssrInterpolate(unref(stripHtml)(unref(test).description))}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if (unref(isAdmin)) {
              ...
              if (hasAnalysis.value) {
                _push2(`<div class="space-y-4"${_scopeId}><div class="grid grid-cols-2 gap-2 lg:grid-cols-6"${_scopeId}><!--[-->`);
                ...
                _push2(`<!--]--></div></div></div>`);
                if ((_c = unref(testAnalysis).blank_questions) == null ? void 0 : _c.length) {
                  _push2(`<div class="rounded-md border border-amber-200 bg-amber-50/70 p-3 dark:border-amber-900/70 dark:bg-amber-950/30"${_scopeId}><div class="flex items-center justify-between gap-3"${_scopeId}><h3 class="text-sm font-semibold text-foreground"${_scopeId}>Boş bıraktığın sorular</h3><span class="text-xs text-muted-foreground"${_scopeId}>${ssrInterpolate(unref(testAnalysis).blank_answers_count)} boş kayıt</span></div><div class="mt-3 grid gap-2 lg:grid-cols-2"${_scopeId}><!--[-->`);
                  ssrRenderList(unref(testAnalysis).blank_questions, (question, index) => {
                    _push2(`<div class="rounded-md border border-amber-200/80 bg-background p-3 dark:border-amber-900/60"${_scopeId}><p class="text-sm font-medium leading-5 text-foreground"${_scopeId}>${ssrInterpolate(index + 1)}. ${ssrInterpolate(question.question_text)}</p><p class="mt-2 text-xs text-muted-foreground"${_scopeId}>${ssrInterpolate(question.blank_count)} kez boş bırakıldı</p></div>`);
                  });
                  _push2(`<!--]--></div></div>`);
                } else {
                  _push2(`<!---->`);
              ...
              createVNode("div", {
                ...
                unref(isAdmin) ? (openBlock(), createBlock("section", {
                  ...
                  hasAnalysis.value ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-2 lg:grid-cols-6" }, [
                    ...
                    createVNode("div", { class: "grid gap-3 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]" }, [
                      createVNode("div", { class: "rounded-md border border-border/70 bg-background p-3" }, [
                        createVNode("div", { class: "flex items-center justify-between gap-3" }, [
                          ...
                          createVNode("span", { class: "text-xs text-muted-foreground" }, toDisplayString(((_d = unref(testAnalysis).weak_questions) == null ? void 0 : _d.length) || 0) + " kayıt", 1)
                        ]),
                        ((_e = unref(testAnalysis).weak_questions) == null ? void 0 : _e.length) ? (openBlock(), createBlock("div", {
                          key: 0,
                    ...
                    ((_f = unref(testAnalysis).blank_questions) == null ? void 0 : _f.length) ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "rounded-md border border-amber-200 bg-amber-50/70 p-3 dark:border-amber-900/70 dark:bg-amber-950/30"
                    }, [
                      createVNode("div", { class: "flex items-center justify-between gap-3" }, [
                        createVNode("h3", { class: "text-sm font-semibold text-foreground" }, "Boş bıraktığın sorular"),
                        createVNode("span", { class: "text-xs text-muted-foreground" }, toDisplayString(unref(testAnalysis).blank_answers_count) + " boş kayıt", 1)
                      ]),
                      createVNode("div", { class: "mt-3 grid gap-2 lg:grid-cols-2" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(testAnalysis).blank_questions, (question, index) => {
                          return openBlock(), createBlock("div", {
                            key: question.question_id,
                            class: "rounded-md border border-amber-200/80 bg-background p-3 dark:border-amber-900/60"
                          }, [
                            createVNode("p", { class: "text-sm font-medium leading-5 text-foreground" }, toDisplayString(index + 1) + ". " + toDisplayString(question.question_text), 1),
                            createVNode("p", { class: "mt-2 text-xs text-muted-foreground" }, toDisplayString(question.blank_count) + " kez boş bırakıldı", 1)
                          ]);
                        }), 128))
                      ])
                    ])) : createCommentVNode("", true)
