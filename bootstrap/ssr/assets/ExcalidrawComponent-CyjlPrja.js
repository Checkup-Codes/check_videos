...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bg-white px-2 lg:p-3"><div class="flex justify-between rounded-md px-1 py-2 text-gray-800 sm:mx-3 md:mx-5"><div class="flex"><label for="versionDropdown" class="my-auto px-3 font-semibold">Versiyon Seç:</label><select id="versionDropdown" class="mx-5 border py-0 pl-2 text-gray-800 shadow-sm focus:outline-none focus:ring focus:ring-gray-200"><!--[-->`);
