...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: computedClass.value }, _attrs))}><div class="h-screen-minus-12 overflow-y-auto overscroll-none lg:h-screen-minus"><div class="${ssrRenderClass([{ "xl:mx-auto": isWideScreen.value }, "container mx-auto max-w-[920px]"])}">`);
