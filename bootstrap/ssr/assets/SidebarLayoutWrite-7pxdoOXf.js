...
import _sfc_main$3 from "./CategoryMenu-Bv95_yN1.js";
import WriteList from "./WriteList-CJ_NaMV2.js";
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "border-color-one relative border-r" }, _attrs))}>`);
      ...
      _push(ssrRenderComponent(WriteList, {
        writes: writes.value,
        route: _ctx.route
      }, null, _parent));
      _push(`</div>`);
