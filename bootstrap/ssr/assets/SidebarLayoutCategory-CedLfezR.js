...
import CategoryTree from "./CategoryTree-Ch9CShgM.js";
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (!isNarrow.value) {
                          _push4(`<span data-v-75c14916${_scopeId3}>Liste</span>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (!isNarrow.value) {
                          _push4(`<span data-v-75c14916${_scopeId3}>Kategori</span>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
...
const SidebarLayoutCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-75c14916"]]);
export {
