import { computed, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, Fragment, renderList, createCommentVNode, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const browserTitle = computed(() => {
      ...
      return ((_c = (_b = (_a = page.props) == null ? void 0 : _a.screen) == null ? void 0 : _b.seo) == null ? void 0 : _c.title) || ((_f = (_e = (_d = page.props) == null ? void 0 : _d.app) == null ? void 0 : _e.seo) == null ? void 0 : _f.title) || "Çalışma Alanı";
    });
            ...
            _push2(ssrRenderComponent(_sfc_main$2, { width: "detail" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<article class="overflow-hidden rounded-xl border border-border bg-card shadow-sm"${_scopeId2}>`);
                  if (__props.workspace.images && __props.workspace.images.length > 0) {
                    _push3(`<div class="grid grid-cols-1 gap-2 p-4 md:grid-cols-2 lg:grid-cols-3"${_scopeId2}><!--[-->`);
                    ssrRenderList(__props.workspace.images, (image, index) => {
                      _push3(`<div class="group relative overflow-hidden rounded-lg"${_scopeId2}><img${ssrRenderAttr("src", `/storage/${image}`)}${ssrRenderAttr("alt", `Çalışma Alanı Resim ${index + 1}`)} class="h-64 w-full object-cover transition-transform duration-300 group-hover:scale-105"${_scopeId2}></div>`);
                    });
                    _push3(`<!--]--></div>`);
                  } else {
                    _push3(`<div class="flex aspect-video items-center justify-center bg-muted"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-muted-foreground/30" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg></div>`);
                  }
                  _push3(`<div class="p-6 sm:p-8"${_scopeId2}><div class="mb-4 flex flex-wrap items-center gap-3"${_scopeId2}>`);
                  ...
                  if (__props.workspace.products && __props.workspace.products.length > 0) {
                    _push3(`<div class="mt-8"${_scopeId2}><h2 class="mb-6 text-2xl font-bold tracking-tight text-foreground"${_scopeId2}>Ürünler</h2><ul class="space-y-3"${_scopeId2}><!--[-->`);
                    ssrRenderList(__props.workspace.products, (product) => {
                      _push3(`<li class="flex items-start justify-between gap-4 rounded-lg border border-border bg-background p-4 transition-all hover:border-primary/50 hover:shadow-sm"${_scopeId2}><div class="flex-1"${_scopeId2}><h3 class="mb-1 text-lg font-semibold text-foreground"${_scopeId2}>${ssrInterpolate(product.name)}</h3>`);
                      if (product.features) {
                        _push3(`<p class="text-sm leading-relaxed text-muted-foreground whitespace-pre-line"${_scopeId2}>${ssrInterpolate(product.features)}</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div>`);
                      if (product.link) {
                        _push3(`<div class="flex-shrink-0"${_scopeId2}><a${ssrRenderAttr("href", product.link)} target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"${_scopeId2}><span${_scopeId2}>Satın Al</span><svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"${_scopeId2}></path></svg></a></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</li>`);
                    ...
                    _push3(`<div class="mt-8 rounded-lg border border-dashed border-border bg-muted/30 py-8 text-center"${_scopeId2}><p class="text-sm text-muted-foreground"${_scopeId2}>Henüz ürün eklenmemiş.</p></div>`);
                  }
                  _push3(`</div></article>`);
                } else {
                  return [
