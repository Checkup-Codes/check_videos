import { ref, watch, computed, withCtx, unref, openBlock, createBlock, createVNode, createTextVNode, createCommentVNode, toDisplayString, Fragment, renderList, withDirectives, withKeys, vModelText, useSSRContext } from "vue";
...
import _sfc_main$3 from "./DuplicateModal-ma_atwAs.js";
const _sfc_main = {
  __name: "Screen",
  ...
  setup(__props) {
    ...
    const bulkImportSummary = computed(() => {
      ...
      const flashSuccess = (_b = page.props.flash) == null ? void 0 : _b.success;
      const flashError = (_c = page.props.flash) == null ? void 0 : _c.error;
      ...
      if (flashError) {
        return {
          ...
          message: flashError,
          details: ((bulkResults == null ? void 0 : bulkResults.errors) || []).slice(0, 10).map(
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (bulkImportSummary.value) {
              _push2(`<div class="${ssrRenderClass([bulkImportSummary.value.isError ? "border-destructive/30 bg-destructive/5" : "border-primary/30 bg-primary/5", "mb-6 rounded-xl border p-4"])}"${_scopeId}><h3 class="${ssrRenderClass([bulkImportSummary.value.isError ? "text-destructive" : "text-foreground", "font-medium"])}"${_scopeId}>${ssrInterpolate(bulkImportSummary.value.title)}</h3><p class="mt-1 text-sm text-muted-foreground"${_scopeId}>${ssrInterpolate(bulkImportSummary.value.message)}</p>`);
              if (bulkImportSummary.value.details.length) {
                _push2(`<ul class="mt-3 space-y-1 text-sm text-muted-foreground"${_scopeId}><!--[-->`);
                ssrRenderList(bulkImportSummary.value.details, (detail, index) => {
                  _push2(`<li${_scopeId}>• ${ssrInterpolate(detail)}</li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
            ...
            if (searchResult.value) {
              ...
              if (!searchResult.value.is_complete) {
                _push2(`<span class="inline-flex items-center rounded-full border border-yellow-500/40 bg-yellow-500/10 px-2.5 py-0.5 text-xs font-semibold text-yellow-700 dark:text-yellow-300"${_scopeId}> Anlam eksik </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><p class="text-muted-foreground text-lg"${_scopeId}>${ssrInterpolate(searchResult.value.meaning)}</p></div>`);
              if (isLoggedIn.value) {
            ...
            return [
              createVNode("div", { class: "p-6 pt-12 sm:p-8 sm:pt-16" }, [
                ...
                bulkImportSummary.value ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: ["mb-6 rounded-xl border p-4", bulkImportSummary.value.isError ? "border-destructive/30 bg-destructive/5" : "border-primary/30 bg-primary/5"]
                }, [
                  createVNode("h3", {
                    class: ["font-medium", bulkImportSummary.value.isError ? "text-destructive" : "text-foreground"]
                  }, toDisplayString(bulkImportSummary.value.title), 3),
                  createVNode("p", { class: "mt-1 text-sm text-muted-foreground" }, toDisplayString(bulkImportSummary.value.message), 1),
                  bulkImportSummary.value.details.length ? (openBlock(), createBlock("ul", {
                    key: 0,
                    class: "mt-3 space-y-1 text-sm text-muted-foreground"
                  }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(bulkImportSummary.value.details, (detail, index) => {
                      return openBlock(), createBlock("li", { key: index }, "• " + toDisplayString(detail), 1);
                    }), 128))
                  ])) : createCommentVNode("", true)
                ...
                searchResult.value ? (openBlock(), createBlock("div", { key: 2 }, [
                      ...
                      createVNode("div", { class: "flex-1" }, [
                        createVNode("div", { class: "mb-3 flex items-center gap-3" }, [
                          ...
                          createVNode("div", { class: "flex gap-2" }, [
                            ...
                            !searchResult.value.is_complete ? (openBlock(), createBlock("span", {
                              key: 0,
                            ...
                            }, " Anlam eksik ")) : createCommentVNode("", true)
                          ])
                        ]),
