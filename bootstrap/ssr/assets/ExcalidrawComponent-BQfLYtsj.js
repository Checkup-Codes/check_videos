...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div id="excalidraw-container" class="3xl:h-[820px] relative h-[620px] w-full 2xl:h-[720px]"><div id="excali" class="h-full w-full"></div></div></div><!--]-->`);
    };
  }
};
