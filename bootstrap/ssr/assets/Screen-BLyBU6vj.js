      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="w-full sm:w-auto"${_scopeId}><h2 class="text-primary truncate text-xl font-bold sm:text-2xl"${_scopeId}>${ssrInterpolate(unref(form).title)} <span class="text-base opacity-70"${_scopeId}>Düzenle</span></h2></div></div>`);
            _push2(ssrRenderComponent(_sfc_main$3, { class: "card-compact mt-5 w-full shadow-md" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="mt-1 text-sm opacity-70"${_scopeId2}><p class="break-words"${_scopeId2}> Örnek: https://www.youtube.com/playlist?list=<span class="font-bold"${_scopeId2}>PLXcQxEjxyk31WyqhATafLwZoTm7whKh_l</span></p><p${_scopeId2}>Koyu renkli bölümü girin.</p></div></div><div class="mt-8 grid grid-cols-1 gap-3 sm:flex sm:justify-between"${_scopeId2}><button type="button" class="btn btn-error order-last w-full sm:order-first sm:w-auto"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"${_scopeId2}></path></svg> Sil </button><div class="flex flex-col-reverse space-y-3 space-y-reverse sm:flex-row sm:space-x-2 sm:space-y-0"${_scopeId2}>`);
                  ...
                  _push3(` Kaydet </button></div></div></form>`);
                } else {
                  return [
                    createVNode("form", {
              ...
              createVNode("div", { class: "mb-5" }, [
                createVNode("div", { class: "flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0" }, [
                  ...
                  createVNode("div", { class: "w-full sm:w-auto" }, [
                    createVNode("h2", { class: "text-primary truncate text-xl font-bold sm:text-2xl" }, [
                      createTextVNode(toDisplayString(unref(form).title) + " ", 1),
                      createVNode("span", { class: "text-base opacity-70" }, "Düzenle")
                    ])
                  ])
                ]),
