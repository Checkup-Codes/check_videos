...
import { _ as _sfc_main$3 } from "./CheckScreen-juRHZR4N.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$3, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 pt-6 sm:p-6 sm:pt-8" data-v-41ae3e25${_scopeId}>`);
            if (!isLoading.value) {
              _push2(`<div class="mb-8 border-b border-border/60 pb-6" data-v-41ae3e25${_scopeId}><div class="flex items-start justify-between gap-4" data-v-41ae3e25${_scopeId}><div class="min-w-0 flex-1" data-v-41ae3e25${_scopeId}>`);
              if (categoryBreadcrumb.value.length > 1) {
                _push2(`<nav class="mb-3 flex items-center gap-1.5 text-xs" data-v-41ae3e25${_scopeId}><!--[-->`);
                ssrRenderList(categoryBreadcrumb.value, (breadcrumbItem, index) => {
                  ...
                  if (index < categoryBreadcrumb.value.length - 1) {
                    ...
                    _push2(`<span class="font-semibold text-foreground" data-v-41ae3e25${_scopeId}>${ssrInterpolate(breadcrumbItem.name)}</span>`);
                  }
                  if (index < categoryBreadcrumb.value.length - 1) {
                    _push2(`<span class="text-muted-foreground/50" data-v-41ae3e25${_scopeId}>/</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<!--]-->`);
              ...
              _push2(`<h1 class="mb-3 truncate text-2xl font-bold text-foreground sm:text-3xl" data-v-41ae3e25${_scopeId}>${ssrInterpolate(category.value.name)}</h1><div class="flex flex-wrap items-center gap-3 text-sm" data-v-41ae3e25${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a2, _b;
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-41ae3e25${_scopeId2}></path></svg> ${ssrInterpolate(((_a2 = filteredWrites.value) == null ? void 0 : _a2.length) || 0)} yazı `);
                  } else {
                    return [
              ...
              if (category.value.description) {
                _push2(`<span class="text-muted-foreground line-clamp-1" data-v-41ae3e25${_scopeId}>${ssrInterpolate(category.value.description)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="flex shrink-0 flex-wrap items-center gap-1.5" data-v-41ae3e25${_scopeId}>`);
              ...
              if (statusFilter.value !== "all") {
                _push2(ssrRenderComponent(_sfc_main$4, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-3.5 w-3.5" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-41ae3e25${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          xmlns: "http://www.w3.org/2000/svg",
            ...
            if (isLoading.value) {
              _push2(`<div class="space-y-2" data-v-41ae3e25${_scopeId}><!--[-->`);
              ssrRenderList(5, (i) => {
                _push2(`<div class="rounded border border-border bg-card p-4" data-v-41ae3e25${_scopeId}><div class="mb-2 h-5 w-3/4 rounded bg-muted" data-v-41ae3e25${_scopeId}></div><div class="h-3 w-1/2 rounded bg-muted" data-v-41ae3e25${_scopeId}></div></div>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<div data-v-41ae3e25${_scopeId}><div class="space-y-3" data-v-41ae3e25${_scopeId}><!--[-->`);
              ssrRenderList(paginatedWrites.value, (write) => {
                _push2(ssrRenderComponent(_sfc_main$2, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="flex items-start justify-between gap-4" data-v-41ae3e25${_scopeId2}><div class="min-w-0 flex-1" data-v-41ae3e25${_scopeId2}><div class="mb-2 flex items-center gap-2.5" data-v-41ae3e25${_scopeId2}><span class="inline-flex shrink-0 items-center"${ssrRenderAttr("title", getStatusText(write.status))} data-v-41ae3e25${_scopeId2}>`);
                      if (write.status === "private") {
                        _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" data-v-41ae3e25${_scopeId2}></path></svg>`);
                      } else if (write.status === "link_only") {
                        _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5M10.172 13.828a4 4 0 010-5.656l3-3a4 4 0 015.656 5.656l-1.5 1.5" data-v-41ae3e25${_scopeId2}></path></svg>`);
                      } else {
                        _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-41ae3e25${_scopeId2}></path></svg>`);
                      }
                      _push3(`</span><h3 class="line-clamp-1 text-lg font-semibold text-foreground transition-colors group-hover:text-primary" data-v-41ae3e25${_scopeId2}>${ssrInterpolate(write.title)}</h3></div>`);
                      if (write.summary) {
                        _push3(`<p class="mb-3 line-clamp-2 text-sm leading-relaxed text-muted-foreground" data-v-41ae3e25${_scopeId2}>${ssrInterpolate(write.summary)}</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<div class="flex flex-wrap items-center gap-4 text-xs" data-v-41ae3e25${_scopeId2}><span class="inline-flex items-center gap-1.5 text-muted-foreground" data-v-41ae3e25${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" class="h-3.5 w-3.5" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-41ae3e25${_scopeId2}></path><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-41ae3e25${_scopeId2}></path></svg><span class="font-medium" data-v-41ae3e25${_scopeId2}>${ssrInterpolate(formatNumber(write.views_count))}</span></span><span class="inline-flex items-center gap-1.5 text-muted-foreground" data-v-41ae3e25${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" class="h-3.5 w-3.5" stroke-width="2" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-41ae3e25${_scopeId2}></path></svg><span class="font-medium" data-v-41ae3e25${_scopeId2}>${ssrInterpolate(formatDateMobile(write.created_at))}</span></span></div></div><div class="shrink-0 text-muted-foreground/60 transition-colors group-hover:text-primary" data-v-41ae3e25${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="h-5 w-5" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" data-v-41ae3e25${_scopeId2}></path></svg></div></div>`);
                    } else {
                      return [
              ...
              if ((hasMore.value || isLoadingMore.value) && filteredWrites.value.length > perPage) {
                _push2(`<div class="flex justify-center py-6" data-v-41ae3e25${_scopeId}>`);
                if (isLoadingMore.value) {
                  _push2(`<div class="flex items-center gap-2 text-sm text-muted-foreground" data-v-41ae3e25${_scopeId}><div class="h-4 w-4 animate-spin rounded-full border-2 border-primary border-t-transparent" data-v-41ae3e25${_scopeId}></div> Yükleniyor... </div>`);
                } else {
                  _push2(ssrRenderComponent(_sfc_main$4, {
                    onClick: loadMore,
                    variant: "outline",
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-41ae3e25${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5L12 21m0 0l-7.5-7.5M12 21V3" data-v-41ae3e25${_scopeId2}></path></svg> Daha Fazla `);
                      } else {
                        return [
                          (openBlock(), createBlock("svg", {
                            xmlns: "http://www.w3.org/2000/svg",
              ...
              if (filteredWrites.value.length === 0) {
                _push2(`<div class="py-16 text-center" data-v-41ae3e25${_scopeId}><div class="mb-3 text-muted-foreground/50" data-v-41ae3e25${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mx-auto h-12 w-12" data-v-41ae3e25${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-41ae3e25${_scopeId}></path></svg></div><p class="text-sm text-muted-foreground" data-v-41ae3e25${_scopeId}>`);
                if (statusFilter.value !== "all") {
                  _push2(`<span data-v-41ae3e25${_scopeId}>Seçilen filtreye uygun yazı bulunamadı.</span>`);
                } else {
                  _push2(`<span data-v-41ae3e25${_scopeId}>Bu kategoride henüz yazı bulunmuyor.</span>`);
                }
                _push2(`</p></div>`);
              } else if (!hasMore.value && paginatedWrites.value.length > 0) {
                _push2(`<div class="py-8 text-center" data-v-41ae3e25${_scopeId}><p class="text-xs text-muted-foreground/60" data-v-41ae3e25${_scopeId}>Tüm yazılar gösteriliyor</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-41ae3e25"]]);
export {
  Screen as default
};
