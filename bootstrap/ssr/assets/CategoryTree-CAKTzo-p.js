...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-1 p-3" }, _attrs))} data-v-b510b2cc><!--[-->`);
      ssrRenderList(filteredParentCategories.value, (category) => {
        _push(`<div data-v-b510b2cc><div class="${ssrRenderClass([
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-center justify-between" data-v-b510b2cc${_scopeId}><div class="flex min-w-0 flex-1 items-center gap-2" data-v-b510b2cc${_scopeId}>`);
              if (category.status === "hidden") {
                _push2(`<span class="shrink-0 text-yellow-500" title="Gizli kategori" data-v-b510b2cc${_scopeId}>`);
              ...
              if (hasLinkOnlyWrites(category)) {
                _push2(`<span class="shrink-0 text-primary" title="Sadece link yazıları" data-v-b510b2cc${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$2, { class: "h-3 w-3" }, null, _parent2, _scopeId));
                _push2(`</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<h3 class="${ssrRenderClass([url.value === `/categories/${category.slug}` ? "text-accent-foreground" : "text-foreground", "truncate text-sm font-medium"])}"${ssrRenderAttr("title", category.name)} data-v-b510b2cc${_scopeId}>${ssrInterpolate(category.name)}</h3></div><div class="flex shrink-0 items-center gap-2" data-v-b510b2cc${_scopeId}>`);
              ...
              _push2(`<div class="inline-flex items-center rounded-full border border-border bg-secondary px-2 py-0.5 text-xs font-semibold text-secondary-foreground" data-v-b510b2cc${_scopeId}>${ssrInterpolate(getTotalWriteCount(category))}</div></div></div>`);
            } else {
              return [
        ...
        if (category.children.length) {
          _push(`<div class="pb-1" style="${ssrRenderStyle(!isCollapsed(category.id) ? null : { display: "none" })}" data-v-b510b2cc><div class="space-y-0.5 pl-4" data-v-b510b2cc><!--[-->`);
          ssrRenderList(category.children, (child) => {
            ...
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  _push2(`<span class="${ssrRenderClass([url.value === `/categories/${child.slug}` ? "text-accent-foreground" : "text-foreground", "truncate text-sm font-medium"])}"${ssrRenderAttr("title", child.name)} data-v-b510b2cc${_scopeId}>${ssrInterpolate(child.name)}</span></div><div class="flex shrink-0 items-center gap-2" data-v-b510b2cc${_scopeId}>`);
                  ...
                  _push2(`<div class="inline-flex items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-xs font-semibold text-secondary-foreground" data-v-b510b2cc${_scopeId}>${ssrInterpolate(getTotalWriteCount(child))}</div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", { class: "flex min-w-0 flex-1 items-center gap-2" }, [
                      ...
                      createVNode("div", { class: "flex shrink-0 items-center gap-2" }, [
                        ...
                        createVNode("div", { class: "inline-flex items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-xs font-semibold text-secondary-foreground" }, toDisplayString(getTotalWriteCount(child)), 1)
                      ])
                    ])
                  ];
                }
            ...
            if (child.children.length) {
              _push(`<div class="pb-1" style="${ssrRenderStyle(!isCollapsed(child.id) ? null : { display: "none" })}" data-v-b510b2cc><div class="space-y-0.5 pl-4" data-v-b510b2cc><!--[-->`);
                ...
                _push(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      ...
                      ])}"${ssrRenderAttr("title", subChild.name)} data-v-b510b2cc${_scopeId}>${ssrInterpolate(subChild.name)}</span></div><div class="inline-flex shrink-0 items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-xs font-semibold text-secondary-foreground" data-v-b510b2cc${_scopeId}>${ssrInterpolate(getTotalWriteCount(subChild))}</div></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "flex min-w-0 flex-1 items-center gap-2" }, [
                          ...
                          createVNode("div", { class: "inline-flex shrink-0 items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-xs font-semibold text-secondary-foreground" }, toDisplayString(getTotalWriteCount(subChild)), 1)
                        ])
                      ];
                    }
                  }),
      ...
      if (filteredParentCategories.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center text-muted-foreground opacity-50" data-v-b510b2cc><div data-v-b510b2cc>Henüz kategori bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const CategoryTree = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b510b2cc"]]);
export {
