import { computed, ref, onMounted, watch, mergeProps, withCtx, unref, createTextVNode, createVNode, withModifiers, withDirectives, vModelText, openBlock, createBlock, toDisplayString, createCommentVNode, Fragment, renderList, vModelSelect, vModelCheckbox, useSSRContext } from "vue";
...
import _sfc_main$2 from "./RelatedImagesUpload-CPJPrzZI.js";
      ...
      if (project.value.services && project.value.services.length > 0) {
        project.value.services.forEach((service) => {
          ...
          servicesData.value[service.id] = {
            ...
            guest_description: ((_e = service.pivot) == null ? void 0 : _e.guest_description) || "",
            service_start_date: ((_f = service.pivot) == null ? void 0 : _f.service_start_date) || null,
            service_end_date: ((_g = service.pivot) == null ? void 0 : _g.service_end_date) || null
          };
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="mt-1 text-xs text-muted-foreground"${_scopeId}> Bu projeye ait yazıların bulunduğu kategoriyi seçin. </p></div>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              "entity-id": project.value.id,
              category: "projects",
              label: "Proje Görselleri",
              "initial-images": project.value.images || []
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="space-y-4 border-t border-border mt-4 pt-4"${_scopeId}><h3 class="text-xs font-semibold text-foreground"${_scopeId}>Hizmetler</h3>`);
            if (!services.value || services.value.length === 0) {
              _push2(`<div class="flex items-center gap-3 rounded-md border border-border bg-muted/50 p-4 text-sm text-muted-foreground"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-5 w-5 shrink-0" stroke="currentColor" stroke-width="2"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg><span${_scopeId}>Henüz hizmet bulunmamaktadır.</span></div>`);
            } else {
              ...
              ssrRenderList(services.value, (service) => {
                ...
                if (service.description) {
                  _push2(`<p class="mt-1 text-xs text-muted-foreground line-clamp-2"${_scopeId}>${ssrInterpolate(unref(stripHtml)(service.description))}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></label>`);
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Güncelleniyor..." : "Projeyi Güncelle")}</button></div></div></form>`);
          } else {
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "rounded-lg border border-border bg-card p-5 shadow-sm" }, [
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("h3", { class: "text-xs font-semibold text-foreground" }, "Proje Bilgileri"),
                    createVNode("div", {
                      ref_key: "projectNameRef",
                      ref: projectNameRef
                    }, [
                      createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Proje Adı"),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Müşteri Seçin"),
                    ...
                    createVNode("div", {
                      ...
                      createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Kategori/Yazı Bağlantısı (Opsiyonel)"),
                      withDirectives(createVNode("select", {
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-muted-foreground" }, " Bu projeye ait yazıların bulunduğu kategoriyi seçin. ")
                    ], 512),
                    createVNode(_sfc_main$2, {
                      ...
                      label: "Proje Görselleri",
                      "initial-images": project.value.images || []
                    }, null, 8, ["entity-id", "initial-images"])
                  ]),
                  createVNode("div", { class: "space-y-4 border-t border-border mt-4 pt-4" }, [
                    createVNode("h3", { class: "text-xs font-semibold text-foreground" }, "Hizmetler"),
                    !services.value || services.value.length === 0 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("span", null, "Henüz hizmet bulunmamaktadır.")
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("label", { class: "flex cursor-pointer items-center gap-3" }, [
                            ...
                            createVNode("div", { class: "flex-1" }, [
                              ...
                              }, toDisplayString(unref(stripHtml)(service.description)), 1)) : createCommentVNode("", true)
                            ])
                          ]),
                          selectedServices.value.includes(service.id) ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("div", null, [
                              ...
                              createVNode("p", { class: "mt-1 text-[10px] text-muted-foreground" }, " Boş bırakılırsa hizmet kataloğundaki açıklama kullanılır. ")
                            ]),
                            createVNode("div", null, [
                              createVNode("label", { class: "mb-1 block text-xs font-medium text-foreground" }, "İç notlar"),
