...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button type="button" class="text-blue-600 hover:underline">Yeni Özellik Ekle</button></div><div class="space-y-4"><h3 class="text-lg font-semibold">Çözülen Buglar</h3><!--[-->`);
      ...
      _push(`<button type="button" class="text-blue-600 hover:underline">Yeni Bug ekle</button></div><button type="submit" class="rounded-md bg-blue-600 px-4 py-2 text-white">Değişiklikleri Kaydet</button></form></div>`);
    };
  }
};
