            ...
            ssrRenderList(unref(test).questions, (question, index) => {
              ...
              if (question.question_type === "single_choice" || question.question_type === "multiple_choice" && hasOnlyOneCorrectAnswer(question)) {
                ...
                ssrRenderList(question.options, (option, optIndex) => {
                  ...
                  }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-option-${option.id}`)} type="radio"${ssrRenderAttr("name", `question-${question.id}`)}${ssrRenderAttr("value", option.id)}${ssrIncludeBooleanAttr(ssrLooseEqual(answers.value[question.id], option.id)) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:bg-primary dark:checked:border-primary"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([answers.value[question.id] === option.id ? "text-primary" : "text-muted-foreground", "font-semibold transition-colors"])}"${_scopeId}>${ssrInterpolate(String.fromCharCode(65 + optIndex))}. </span><span class="${ssrRenderClass([answers.value[question.id] === option.id ? "font-medium text-foreground" : "text-foreground", "whitespace-pre-wrap transition-colors"])}"${_scopeId}>${ssrInterpolate(option.option_text)}</span></div></div></label>`);
                });
                _push2(`<!--]-->`);
                ...
                ssrRenderList(question.options, (option, optIndex) => {
                  ...
                  }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-option-${option.id}`)} type="checkbox"${ssrRenderAttr("value", option.id)}${ssrIncludeBooleanAttr(Array.isArray(answers.value[question.id]) ? ssrLooseContain(answers.value[question.id], option.id) : answers.value[question.id]) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer rounded border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:bg-primary dark:checked:border-primary"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([isOptionSelected(question.id, option.id) ? "text-primary" : "text-muted-foreground", "font-semibold transition-colors"])}"${_scopeId}>${ssrInterpolate(String.fromCharCode(65 + optIndex))}. </span><span class="${ssrRenderClass([isOptionSelected(question.id, option.id) ? "font-medium text-foreground" : "text-foreground", "whitespace-pre-wrap transition-colors"])}"${_scopeId}>${ssrInterpolate(option.option_text)}</span></div></div></label>`);
                });
                _push2(`<!--]-->`);
              } else if (question.question_type === "true_false") {
                ...
                }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-false`)} type="radio"${ssrRenderAttr("name", `question-${question.id}`)}${ssrRenderAttr("value", false)}${ssrIncludeBooleanAttr(ssrLooseEqual(answers.value[question.id], false)) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:bg-primary dark:checked:border-primary"${_scopeId}><div class="flex-1"${_scopeId}><span class="${ssrRenderClass([answers.value[question.id] === false ? "text-primary" : "text-foreground", "whitespace-pre-wrap font-medium transition-colors"])}"${_scopeId}> Yanlış </span></div></label><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(test).questions, (question, index) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-start justify-between" }, [
                        ...
                        isQuestionAnswered(question.id) ? (openBlock(), createBlock("div", {
                          key: 0,
                          ...
                          return openBlock(), createBlock("label", {
                            ...
                            createVNode("div", { class: "flex-1" }, [
                              createVNode("div", { class: "flex items-center gap-2" }, [
                                ...
                                createVNode("span", {
                                  class: ["whitespace-pre-wrap transition-colors", isOptionSelected(question.id, option.id) ? "font-medium text-foreground" : "text-foreground"]
                                }, toDisplayString(option.option_text), 3)
                              ])
                            ])
                          ], 10, ["for"]);
