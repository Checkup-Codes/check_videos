  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: scrollContainer,
        class: "h-full w-full overflow-y-auto px-2 py-3"
      }, _attrs))} data-v-faff28d7><!--[-->`);
      ssrRenderList(filteredWrites.value, (write) => {
        _push(ssrRenderComponent(unref(Link), {
          key: write.id,
          href: __props.route("writes.show", { write: write.slug }),
          class: [
            activeWrite.value === `/writes/${write.slug}` ? "border-l-4 border-l-primary bg-base-200" : "border-l border-l-base-200",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-center gap-2 font-medium" data-v-faff28d7${_scopeId}>`);
              if (write.status === "private") {
                _push2(`<span class="text-base-content opacity-60" data-v-faff28d7${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor" data-v-faff28d7${_scopeId}><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" data-v-faff28d7${_scopeId}></path></svg></span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span class="truncate text-sm" data-v-faff28d7${_scopeId}>${ssrInterpolate(write.title)}</span></div><div class="mt-1.5 flex justify-between text-xs opacity-60" data-v-faff28d7${_scopeId}><span data-v-faff28d7${_scopeId}>${ssrInterpolate(formatDate(write.created_at))}</span><div class="inline-flex items-center gap-1" data-v-faff28d7${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-faff28d7${_scopeId}><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" data-v-faff28d7${_scopeId}></path><circle cx="12" cy="12" r="3" data-v-faff28d7${_scopeId}></circle></svg> ${ssrInterpolate(write.views_count)}</div></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-center gap-2 font-medium" }, [
                  ...
                  createVNode("span", { class: "truncate text-sm" }, toDisplayString(write.title), 1)
                ]),
                createVNode("div", { class: "mt-1.5 flex justify-between text-xs opacity-60" }, [
      ...
      if (filteredWrites.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center opacity-50" data-v-faff28d7><div data-v-faff28d7>Henüz yazı bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const WriteList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-faff28d7"]]);
export {
