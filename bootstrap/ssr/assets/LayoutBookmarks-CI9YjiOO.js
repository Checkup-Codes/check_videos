...
import SidebarLayoutBookmarks from "./SidebarLayoutBookmarks-BHXtYlpG.js";
...
import "./CategoryList-CU2CDvCf.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    const isNonIndexPage = computed(() => {
      ...
      const isBookmarkCreateEditPage = path === "/bookmarks/create" || /^\/bookmarks\/[^/]+\/edit$/.test(path);
