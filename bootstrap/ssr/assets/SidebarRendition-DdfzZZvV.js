    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border bg-background p-3" data-v-55090159${_scopeId}><div class="flex items-center justify-between gap-2" data-v-55090159${_scopeId}><span class="text-xs font-semibold uppercase tracking-wider text-muted-foreground" data-v-55090159${_scopeId}>Kelime Paketleri</span></div></div>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-1 p-2" data-v-55090159${_scopeId2}><!--[-->`);
                  ssrRenderList(languagePacks.value, (languagePack) => {
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex w-full items-center justify-between" data-v-55090159${_scopeId3}><div class="flex-1" data-v-55090159${_scopeId3}><div class="${ssrRenderClass([
                            getLinkClasses(`/rendition/words/${languagePack.slug}`) ? "text-primary-foreground" : "text-foreground",
                            "text-sm font-medium leading-tight"
                          ])}" data-v-55090159${_scopeId3}>${ssrInterpolate(languagePack.name)}</div><div class="${ssrRenderClass([
                            getLinkClasses(`/rendition/words/${languagePack.slug}`) ? "text-primary-foreground/70" : "text-muted-foreground",
                            "text-xs uppercase"
                          ])}" data-v-55090159${_scopeId3}>${ssrInterpolate(languagePack.language)}</div></div><div class="${ssrRenderClass([
                          ...
                          ])}" data-v-55090159${_scopeId3}>${ssrInterpolate(languagePack.word_count || 0)}</div></div>`);
                        } else {
                          return [
...
const SidebarRendition = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-55090159"]]);
export {
