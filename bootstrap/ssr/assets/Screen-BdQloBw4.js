...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      meanings: ((_k = (_j = props.word) == null ? void 0 : _j.meanings) == null ? void 0 : _k.length) > 0 ? props.word.meanings.map((m) => ({ meaning: m.meaning, is_primary: m.is_primary })) : [{ meaning: "", is_primary: true }],
