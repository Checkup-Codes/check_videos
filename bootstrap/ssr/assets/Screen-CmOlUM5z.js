import { ref, computed, withCtx, unref, createTextVNode, createVNode, createBlock, toDisplayString, openBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div></div><div class="space-y-4"${_scopeId}><h2 class="text-xl font-semibold text-foreground"${_scopeId}>Sorular ve Cevaplar</h2><div class="space-y-6"${_scopeId}><!--[-->`);
            ssrRenderList(resultAnswers.value, (answer, index) => {
              ...
              }, "space-y-4 rounded-lg border border-border bg-card p-6"])}"${_scopeId}><div class="flex items-start justify-between"${_scopeId}><div class="flex-1"${_scopeId}><div class="mb-2 flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([
                answer.is_correct ? "bg-green-500 text-white" : "bg-red-500 text-white",
                "rounded-md px-2 py-1 text-sm font-semibold"
              ])}"${_scopeId}> Soru ${ssrInterpolate(index + 1)}</span>`);
            ...
            _push2(`<!--]--></div></div>`);
            if (unref(isGuest)) {
              _push2(`<div class="rounded-lg border border-border bg-card p-6"${_scopeId}><h3 class="mb-4 text-lg font-semibold text-foreground"${_scopeId}>Sonucunu Paylaş</h3><div class="space-y-4"${_scopeId}><div class="rounded-md border border-input bg-background p-4"${_scopeId}><p class="text-sm text-muted-foreground mb-2"${_scopeId}>Paylaşılabilir mesaj:</p><p class="text-foreground font-medium" id="shareMessage"${_scopeId}>${ssrInterpolate(shareMessage.value)}</p></div><div class="flex gap-2"${_scopeId}><button class="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"${_scopeId}></path></svg> ${ssrInterpolate(copyButtonText.value)}</button>`);
              ...
              _push2(ssrRenderComponent(unref(Link), {
                href: `/tests/${(_c = unref(result).test) == null ? void 0 : _c.slug}`,
              ...
              createVNode("div", { class: "mx-auto max-w-4xl space-y-6 p-6" }, [
                createVNode("div", { class: "space-y-4 rounded-lg border border-border bg-card p-6" }, [
                  createVNode("div", { class: "text-center" }, [
                    ...
                    createVNode("p", { class: "text-muted-foreground" }, toDisplayString((_d = unref(result).test) == null ? void 0 : _d.title), 1)
                  ]),
                ...
                unref(isGuest) ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "space-y-4" }, [
                    createVNode("div", { class: "rounded-md border border-input bg-background p-4" }, [
                      createVNode("p", { class: "text-sm text-muted-foreground mb-2" }, "Paylaşılabilir mesaj:"),
                      createVNode("p", {
                    ...
                    createVNode("div", { class: "flex gap-2" }, [
                      ...
                      createVNode(unref(Link), {
                        href: `/tests/${(_e = unref(result).test) == null ? void 0 : _e.slug}`,
                        class: "inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-4 text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground"
                      }, {
                        default: withCtx(() => [
                          createTextVNode(" Teste Geri Dön ")
                  ...
                  createVNode(unref(Link), {
                    href: `/tests/${(_f = unref(result).test) == null ? void 0 : _f.slug}`,
                    class: "inline-flex h-11 items-center justify-center rounded-md border border-input bg-background px-6 text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground"
                  }, {
                    default: withCtx(() => [
                      createTextVNode(" Teste Geri Dön ")
