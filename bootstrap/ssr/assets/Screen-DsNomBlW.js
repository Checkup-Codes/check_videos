      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="space-y-1.5"${_scopeId}><label class="text-sm font-medium text-base-content"${_scopeId}>JSON Dosyası İçe Aktar</label><div class="relative"${_scopeId}><input type="file" accept=".json" class="border-base-300/50 bg-base-50 focus:border-base-content/50 focus:ring-base-content/20 w-full rounded-lg border px-3 py-2 text-sm text-base-content transition-colors file:mr-3 file:rounded-lg file:border-0 file:bg-base-content file:px-3 file:py-1 file:text-sm file:font-medium file:text-base-100 hover:file:bg-base-300 hover:file:text-base-content focus:bg-base-100 focus:outline-none focus:ring-1"${_scopeId}></div><p class="text-base-content/70 text-xs"${_scopeId}> Daha önce dışa aktarılmış bir JSON dosyasını yükleyerek kelimeleri otomatik olarak içe aktarabilirsiniz. </p>`);
            if (unref(errors).import_file) {
              _push2(`<p class="text-xs text-error"${_scopeId}>${ssrInterpolate(unref(errors).import_file)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex flex-col-reverse gap-2 pt-4 sm:flex-row sm:justify-end"${_scopeId}><button type="button" class="border-base-300/50 rounded-lg border bg-base-100 px-4 py-2 text-sm font-medium text-base-content transition-colors hover:bg-base-200"${_scopeId}> İptal </button><button type="submit" class="rounded-lg bg-base-content px-4 py-2 text-sm font-medium text-base-100 transition-colors hover:bg-base-300 hover:text-base-content disabled:opacity-50"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
            ...
            return [
              createVNode("div", { class: "card-body p-4 sm:p-6" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("h1", { class: "text-xl font-bold sm:text-2xl" }, "Yeni Dil Paketi Oluştur"),
                  createVNode("p", { class: "text-base-content/60 mt-1 text-sm" }, "Yeni bir dil paketi oluşturun ve kelimelerinizi organize edin")
                ]),
                createVNode("form", {
                  ...
                  createVNode("div", { class: "space-y-1.5" }, [
                    ...
                    createVNode("div", { class: "relative" }, [
                      createVNode("input", {
                        ...
                        class: "border-base-300/50 bg-base-50 focus:border-base-content/50 focus:ring-base-content/20 w-full rounded-lg border px-3 py-2 text-sm text-base-content transition-colors file:mr-3 file:rounded-lg file:border-0 file:bg-base-content file:px-3 file:py-1 file:text-sm file:font-medium file:text-base-100 hover:file:bg-base-300 hover:file:text-base-content focus:bg-base-100 focus:outline-none focus:ring-1"
                      }, null, 32)
                    ]),
