...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "z-10 h-screen shadow-right shadow-gray-100" }, _attrs))}><div class="bg-sidebar z-10 flex cursor-pointer justify-between text-sm text-black">`);
