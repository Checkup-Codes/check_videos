        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (props.word) {
              ...
              _push2(`</div><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Anlam</span></label><input type="text"${ssrRenderAttr("value", unref(form).meaning)} class="input-bordered input w-full" required${_scopeId}>`);
