  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(equipments.value, (equipment) => {
        _push(`<tr class="hover:bg-gray-100"><td class="border-b px-6 py-4">${ssrInterpolate(equipment.name)}</td><td class="border-b px-6 py-4">${ssrInterpolate(equipment.specs)}</td><td class="border-b px-6 py-4"><a${ssrRenderAttr("href", equipment.link)} class="text-blue-600 hover:underline" target="_blank">Ziyaret Et</a></td>`);
        if (auth.value.user) {
