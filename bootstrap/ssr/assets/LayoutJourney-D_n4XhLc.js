...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="h-full overflow-hidden px-2 sm:px-4 lg:px-8"><div class="h-[calc(100vh-3rem)] overflow-y-auto overscroll-none lg:h-full"><div class="${ssrRenderClass([{ "xl:mx-auto": isWideScreen.value }, "mx-auto max-w-full sm:max-w-[920px]"])}">`);
