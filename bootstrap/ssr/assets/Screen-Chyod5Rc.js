              ...
              createVNode("div", { class: "mb-5" }, [
                createVNode("div", { class: "flex flex-col space-y-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0" }, [
                  ...
                  createVNode("div", { class: "w-full sm:w-auto" }, [
                    createVNode("h2", { class: "truncate text-xl font-bold text-primary sm:text-2xl" }, "Yeni Ders Ekle")
                  ])
                ]),
                createVNode("div", { class: "card-compact card mt-5 w-full border border-gray-200 bg-white shadow-md shadow-sm transition-all duration-200 dark:border-gray-700 dark:bg-base-100" }, [
