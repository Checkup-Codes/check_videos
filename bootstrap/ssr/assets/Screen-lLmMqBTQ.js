import { computed, ref, withCtx, unref, createBlock, createTextVNode, openBlock, createVNode, withModifiers, withDirectives, createCommentVNode, vModelText, toDisplayString, Fragment, renderList, vModelCheckbox, vModelSelect, withKeys, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderClass, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(form).meanings, (meaning, index) => {
              _push2(`<div class="flex items-center gap-3"${_scopeId}><input type="text"${ssrRenderAttr("value", meaning.meaning)} class="input input-bordered w-full"${ssrRenderAttr("placeholder", `${index + 1}. anlam`)} required${_scopeId}><div class="form-control"${_scopeId}><label class="label cursor-pointer gap-2"${_scopeId}><span class="label-text text-xs"${_scopeId}>Birincil</span><input type="radio" name="primaryMeaning"${ssrIncludeBooleanAttr(meaning.is_primary) ? " checked" : ""} class="radio radio-sm radio-primary"${_scopeId}></label></div>`);
            ...
            _push2(`<div class="mt-3"${_scopeId}><button type="button" class="btn btn-outline btn-sm w-full"${_scopeId}><svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"${_scopeId}></path></svg> Yeni Anlam Ekle </button></div></div></div><div class="space-y-4"${_scopeId}><div class="divider"${_scopeId}><span class="text-base-content font-semibold"${_scopeId}>Dil Paketleri</span></div>`);
            if (props.languagePacks.length === 0) {
              _push2(`<div class="alert alert-info"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-current shrink-0 w-6 h-6"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg><span${_scopeId}>Henüz dil paketi bulunmamaktadır.</span></div>`);
            } else {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3"${_scopeId}><!--[-->`);
              ssrRenderList(props.languagePacks, (pack) => {
                _push2(`<div class="${ssrRenderClass([{ "ring-2 ring-primary": unref(form).language_pack_ids.includes(pack.id) }, "card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer"])}"${_scopeId}><div class="card-body p-4"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h3 class="font-semibold text-base-content"${_scopeId}>${ssrInterpolate(pack.name)}</h3><p class="text-sm text-base-content/70"${_scopeId}>${ssrInterpolate(pack.description)}</p></div><div class="badge badge-primary"${_scopeId}>${ssrInterpolate(pack.language.toUpperCase())}</div></div><div class="mt-2 text-xs text-base-content/60"${_scopeId}>${ssrInterpolate(pack.word_count || 0)} kelime </div></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            ...
            _push2(`</div><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Zorluk Seviyesi</span></label><select class="select select-bordered w-full"${_scopeId}><option${ssrRenderAttr("value", 1)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 1) : ssrLooseEqual(unref(form).difficulty_level, 1)) ? " selected" : ""}${_scopeId}>Kolay</option><option${ssrRenderAttr("value", 2)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 2) : ssrLooseEqual(unref(form).difficulty_level, 2)) ? " selected" : ""}${_scopeId}>Orta</option><option${ssrRenderAttr("value", 3)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 3) : ssrLooseEqual(unref(form).difficulty_level, 3)) ? " selected" : ""}${_scopeId}>Zor</option><option${ssrRenderAttr("value", 4)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 4) : ssrLooseEqual(unref(form).difficulty_level, 4)) ? " selected" : ""}${_scopeId}>Çok Zor</option></select>`);
            ...
            _push2(`<!--]--></div><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", newSynonym.value)} type="text" class="input input-bordered w-full" placeholder="Yeni eş anlamlı kelime"${_scopeId}><button type="button" class="btn btn-outline"${_scopeId}><svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"${_scopeId}></path></svg> Ekle </button></div></div></div></div><div class="divider"${_scopeId}></div><div class="flex justify-end gap-3"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"${_scopeId2}></path></svg> İptal `);
                } else {
                  return [
            ...
            if (processing.value) {
              ...
              _push2(`<svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"${_scopeId}></path></svg>`);
            }
            _push2(` Kelimeyi Kaydet </button></div></form></div></div>`);
          } else {
            return [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "space-y-4" }, [
                      createVNode("div", { class: "divider" }, [
                        createVNode("span", { class: "text-base-content font-semibold" }, "Dil Paketleri")
                      ]),
                      props.languagePacks.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(props.languagePacks, (pack) => {
                          return openBlock(), createBlock("div", {
                            key: pack.id,
                            class: ["card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer", { "ring-2 ring-primary": unref(form).language_pack_ids.includes(pack.id) }],
                            ...
                            createVNode("div", { class: "card-body p-4" }, [
                              createVNode("div", { class: "flex items-center justify-between" }, [
                                createVNode("div", null, [
                                  ...
                                  createVNode("p", { class: "text-sm text-base-content/70" }, toDisplayString(pack.description), 1)
                                ]),
                                createVNode("div", { class: "badge badge-primary" }, toDisplayString(pack.language.toUpperCase()), 1)
                              ]),
                              createVNode("div", { class: "mt-2 text-xs text-base-content/60" }, toDisplayString(pack.word_count || 0) + " kelime ", 1)
                            ])
                          ], 10, ["onClick"]);
                        }), 128))
                      ])),
                    ...
                    createVNode("div", { class: "collapse collapse-arrow bg-base-200" }, [
                      ...
                      createVNode("div", { class: "collapse-title text-base-content font-semibold" }, " Daha Fazla Seçenek "),
                      createVNode("div", { class: "collapse-content" }, [
                        createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4 pt-4" }, [
                          createVNode("div", { class: "form-control w-full" }, [
                            createVNode("label", { class: "label" }, [
                    ...
                    createVNode("div", { class: "flex justify-end gap-3" }, [
                      ...
                      createVNode("button", {
                        ...
                        createTextVNode(" Kelimeyi Kaydet ")
                      ], 8, ["disabled"])
                    ])
                  ], 32)
                ])
