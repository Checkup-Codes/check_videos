import { computed, inject, ref, watch, onMounted, nextTick, onActivated, onDeactivated, onBeforeUnmount, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent } from "vue/server-renderer";
import { usePage, Link } from "@inertiajs/vue3";
import TestList from "./TestList-DU86OUi2.js";
import { _ as _sfc_main$1, S as SubSidebarHeader, a as _sfc_main$4, b as _sfc_main$5 } from "./SubSidebarContent-QVixNVtK.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SubSidebarHeader, {
              title: "Testler",
              description: String(tests.value.length)
            }, {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (!isNarrow.value) {
                          _push4(`<span data-v-ff3f4284${_scopeId3}>Liste</span>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (!isNarrow.value) {
                          _push4(`<span data-v-ff3f4284${_scopeId3}>Kategori</span>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$5, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(TestList, {
                          ref_key: "testListRef",
                          ref: testListRef,
                          tests: tests.value,
...
const SidebarLayoutTest = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ff3f4284"]]);
export {
