...
import _sfc_main$1 from "./SidebarLayoutWrite-DOiZvjjH.js";
import _sfc_main$2 from "./SidebarLayoutCategory-CDiteJJC.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(screenName) === "writes") {
        ...
        _push(`<div>`);
        _push(ssrRenderComponent(_sfc_main$2, { class: unref(sidebarStyle) }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
