import { computed, ref, unref, withCtx, createTextVNode, createVNode, withModifiers, openBlock, createBlock, Fragment, renderList, createCommentVNode, withDirectives, vModelRadio, toDisplayString, Teleport, vModelText, useSSRContext } from "vue";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    ...
                    description: "Çalışma alanınızı ve ürünlerinizi ekleyin"
                  }, null, _parent3, _scopeId2));
                  _push3(`<form class="space-y-6"${_scopeId2}><div class="rounded-xl bg-card p-6 ring-1 ring-border/50"${_scopeId2}><h2 class="mb-4 text-lg font-semibold text-foreground"${_scopeId2}>Görseller</h2><div class="space-y-4"${_scopeId2}><label class="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border px-6 py-8 transition-colors hover:border-primary"${_scopeId2}><svg class="mb-2 h-10 w-10 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span class="text-sm font-medium text-foreground"${_scopeId2}>Resim Yükle</span><span class="mt-1 text-xs text-muted-foreground"${_scopeId2}>PNG, JPG, WEBP - max 5MB</span><input type="file" accept="image/*" multiple class="hidden"${_scopeId2}></label>`);
