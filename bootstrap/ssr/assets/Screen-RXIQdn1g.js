    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (write.value.hasDraw) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          href: `/writes/${write.value.slug}?showMerhaba=${_ctx.showMerhaba ? 0 : 1}`
        }, {
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$2, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(_ctx.showMerhaba ? "Yazıya Dön" : "Çizimine Git")}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(_ctx.showMerhaba ? "Yazıya Dön" : "Çizimine Git"), 1)
                    ];
                  }
                }),
                _: 1
