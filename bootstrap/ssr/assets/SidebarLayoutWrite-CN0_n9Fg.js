...
import _sfc_main$3 from "./CategoryMenu-DmYz_UpQ.js";
import _sfc_main$4 from "./WriteList-D32Nlkza.js";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        class: ["top-1/2 z-50 hidden h-8 w-8 -translate-y-1/2 transform items-center rounded-full bg-black pb-0.5 text-white shadow-lg transition-all duration-300 ease-in-out hover:bg-gray-600 hover:shadow-xl lg:absolute lg:block", [__props.isCollapsed ? "left-52" : "-right-4"]]
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative border-r-2 border-color-one" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        isCollapsed: false,
        toggle: collapseSidebar
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$2, { message: flashSuccess.value }, null, _parent));
...
const SidebarLayoutWrite = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _sfc_main
}, Symbol.toStringTag, { value: "Module" }));
export {
  SidebarLayoutWrite as S,
  _sfc_main$1 as _,
  _sfc_main as a
};
