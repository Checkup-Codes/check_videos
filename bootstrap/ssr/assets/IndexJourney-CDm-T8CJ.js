        ...
        screen: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, {
              width: "detail",
              class: showYearFilter.value && isYearFilterOpen.value ? "xl:pr-56" : ""
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    title: "Yolculuk",
                    description: `${__props.entries.length} kayıt`
                  }, null, _parent3, _scopeId2));
                  if (groupedByYear.value.length > 0) {
                    _push3(`<div class="relative transition-[padding] duration-300"${_scopeId2}><div class="space-y-8"${_scopeId2}><!--[-->`);
                    ssrRenderList(groupedByYear.value, (yearGroup, yearIndex) => {
                      _push3(`<div class="relative"${_scopeId2}><div class="relative mb-6 flex items-center"${_scopeId2}><div class="h-px flex-1 bg-gradient-to-r from-transparent to-border"${_scopeId2}></div><div class="mx-4 flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 backdrop-blur-sm"${_scopeId2}><svg class="h-3.5 w-3.5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span class="text-sm font-semibold text-primary"${_scopeId2}>${ssrInterpolate(yearGroup.year)}</span><span class="text-xs text-muted-foreground"${_scopeId2}>${ssrInterpolate(yearGroup.entries.length)} kayıt</span></div><div class="h-px flex-1 bg-gradient-to-l from-transparent to-border"${_scopeId2}></div></div><div class="relative"${_scopeId2}><div class="absolute bottom-0 left-2 top-0 w-px border-l-2 border-dashed border-border/60 sm:left-3"${_scopeId2}></div><div class="space-y-4"${_scopeId2}><!--[-->`);
                      ssrRenderList(yearGroup.entries, (entry, entryIndex) => {
                        _push3(`<div class="timeline-entry relative pl-8 sm:pl-10"${_scopeId2}><div class="absolute left-0 top-3 flex h-4 w-4 items-center justify-center sm:left-1"${_scopeId2}>`);
                        if (yearIndex === 0 && entryIndex === 0) {
                          _push3(`<div class="absolute h-4 w-4 animate-ping rounded-full bg-primary/20"${_scopeId2}></div>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`<div class="${ssrRenderClass([{ "bg-primary scale-110": yearIndex === 0 && entryIndex === 0 }, "relative h-2.5 w-2.5 rounded-full border-2 border-primary bg-background transition-all"])}"${_scopeId2}></div></div>`);
                        _push3(ssrRenderComponent(unref(Link), {
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<div class="${ssrRenderClass(entry.image ? "flex flex-col sm:flex-row" : "")}"${_scopeId3}>`);
                              if (entry.image) {
                                _push4(`<div class="relative w-full flex-shrink-0 sm:w-64 md:w-72"${_scopeId3}><div class="aspect-video w-full overflow-hidden rounded-t-lg sm:rounded-l-lg sm:rounded-tr-none"${_scopeId3}><img${ssrRenderAttr("src", `/storage/${entry.image}`)}${ssrRenderAttr("alt", entry.title)} class="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"${_scopeId3}></div>`);
                                if (entry.status === "draft") {
                                  _push4(`<span class="absolute top-2 right-2 rounded-md bg-yellow-500/90 px-1.5 py-0.5 text-xs font-medium text-yellow-900"${_scopeId3}> Taslak </span>`);
                                } else {
                                  _push4(`<!---->`);
                                }
                                _push4(`</div>`);
                              ...
                              _push4(`<div class="${ssrRenderClass(entry.image ? "flex min-w-0 flex-1 flex-col p-4" : "p-4")}"${_scopeId3}><div class="flex items-center gap-2 text-xs text-muted-foreground"${_scopeId3}><svg class="h-3 w-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId3}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId3}></path></svg><span${_scopeId3}>${ssrInterpolate(formatDate(entry.entry_date))}</span>`);
                              if (entry.status === "draft") {
                                _push4(`<span class="rounded-md bg-yellow-500/20 px-1.5 py-0.5 text-xs font-medium text-yellow-600 dark:text-yellow-400"${_scopeId3}> Taslak </span>`);
                              } else {
                                _push4(`<!---->`);
                              }
                              _push4(`</div><h3 class="mt-2 line-clamp-2 text-sm font-semibold text-foreground transition-colors group-hover:text-primary sm:text-base"${_scopeId3}>${ssrInterpolate(entry.title)}</h3>`);
                              if (entry.description) {
                                _push4(`<p class="mt-2 line-clamp-2 text-xs text-muted-foreground sm:text-sm"${_scopeId3}>${ssrInterpolate(entry.description)}</p>`);
                              } else {
                                _push4(`<!---->`);
                              }
                              _push4(`<div class="mt-3 flex items-center gap-1 text-xs text-muted-foreground transition-colors group-hover:text-primary"${_scopeId3}><span${_scopeId3}>Devamını oku</span><svg class="h-3 w-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId3}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"${_scopeId3}></path></svg></div></div></div>`);
                            } else {
                              return [
                                createVNode("div", {
                    ...
                    _push3(`<!--]--></div><div class="relative mt-8 flex items-center justify-center"${_scopeId2}><div class="flex items-center gap-2 rounded-full border border-border/50 bg-muted/30 px-4 py-2 backdrop-blur-sm"${_scopeId2}><div class="h-1.5 w-1.5 rounded-full bg-border"${_scopeId2}></div><p class="text-xs text-muted-foreground"${_scopeId2}>Yolculuğun başlangıcı</p></div></div></div>`);
                  } else {
                    _push3(`<div class="py-12 text-center"${_scopeId2}><div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-muted/50"${_scopeId2}><svg class="h-6 w-6 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId2}></path></svg></div><p class="text-sm text-muted-foreground"${_scopeId2}>${ssrInterpolate(selectedYear.value ? `${selectedYear.value} yılında kayıt bulunamadı` : "Henüz kayıt yok")}</p></div>`);
                  }
                } else {
                  return [
            ...
            if (__props.entries.length > 0) {
              _push2(`<div class="border-t border-border bg-muted/20"${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
                width: "detail",
                class: "py-4 sm:py-4"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-1.5 text-xs text-muted-foreground"${_scopeId2}><div class="flex items-center gap-1.5"${_scopeId2}><div class="h-1.5 w-1.5 rounded-full bg-primary"${_scopeId2}></div><span${_scopeId2}><span class="font-medium text-foreground"${_scopeId2}>${ssrInterpolate(__props.entries.length)}</span> kayıt</span></div><div class="flex items-center gap-1.5"${_scopeId2}><div class="h-1.5 w-1.5 rounded-full bg-primary/60"${_scopeId2}></div><span${_scopeId2}><span class="font-medium text-foreground"${_scopeId2}>${ssrInterpolate(years.value.length)}</span> yıl</span></div><div class="flex items-center gap-1.5"${_scopeId2}><div class="h-1.5 w-1.5 rounded-full bg-primary/30"${_scopeId2}></div><span${_scopeId2}>${ssrInterpolate(oldestYear.value)} - ${ssrInterpolate(newestYear.value)}</span></div></div>`);
                  } else {
                    return [
