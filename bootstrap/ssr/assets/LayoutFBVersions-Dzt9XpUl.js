...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    const titleName = computed(() => {
      ...
      return name ? name.charAt(0).toUpperCase() + name.slice(1) + " - Versiyonlar" : "Versiyonlar";
    });
