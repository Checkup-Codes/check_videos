...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (showDraw.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative h-[calc(100vh-3rem)] w-full lg:h-[calc(100vh-5.5rem)]" }, _attrs))} data-v-474eb651><div class="absolute left-4 top-[53px] z-10 lg:top-4" data-v-474eb651><button class="flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm text-foreground shadow-lg transition-all hover:bg-accent" data-v-474eb651><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-474eb651><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" data-v-474eb651></path></svg> Metne Dön </button></div>`);
        ...
        _push(ssrRenderComponent(_sfc_main$2, _attrs, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="mx-auto w-full max-w-4xl" data-v-474eb651${_scopeId}><div class="bg-background transition-colors" data-v-474eb651${_scopeId}><div class="p-3 pt-6 sm:p-6 sm:pt-12 lg:p-8 lg:pt-16" data-v-474eb651${_scopeId}><div class="mb-8" data-v-474eb651${_scopeId}>`);
              if (isLoading.value) {
                _push2(`<div class="space-y-3" data-v-474eb651${_scopeId}><div class="skeleton h-8 w-3/4 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-24 rounded-md" data-v-474eb651${_scopeId}></div></div>`);
              } else {
                _push2(`<!--[--><h1 class="mb-4 text-3xl font-bold leading-tight text-foreground sm:text-4xl" data-v-474eb651${_scopeId}>${ssrInterpolate(write.value.title)}</h1><div class="mb-6 flex flex-wrap items-center gap-3 text-sm" data-v-474eb651${_scopeId}><span class="inline-flex items-center gap-1.5 text-muted-foreground" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-474eb651${_scopeId}></path></svg><span class="font-medium" data-v-474eb651${_scopeId}>${ssrInterpolate(formatDate(write.value.created_at))}</span></span>`);
                if (writeCategories.value.length > 0) {
                  _push2(`<!--[--><span class="text-muted-foreground/40" data-v-474eb651${_scopeId}>•</span><div class="flex flex-wrap items-center gap-x-2 gap-y-1" data-v-474eb651${_scopeId}><!--[-->`);
                  ssrRenderList(writeCategories.value, (categoryPath, pathIndex) => {
                    _push2(`<!--[--><div class="inline-flex items-center gap-1.5" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" data-v-474eb651${_scopeId}></path></svg><!--[-->`);
                    ssrRenderList(categoryPath, (category, catIndex) => {
                      ...
                      if (catIndex < categoryPath.length - 1) {
                        _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-muted-foreground/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-474eb651${_scopeId}></path></svg>`);
                      } else {
                        _push2(`<!---->`);
                      }
                      _push2(`<!--]-->`);
                    ...
                    if (pathIndex < writeCategories.value.length - 1) {
                      _push2(`<span class="text-muted-foreground/40" data-v-474eb651${_scopeId}>|</span>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`<!--]-->`);
                ...
                if (write.value.hasDraw || writeDraws.value && writeDraws.value.length > 0 || write.value.writeDraws && write.value.writeDraws.length > 0) {
                  _push2(`<!--[--><span class="text-muted-foreground/40" data-v-474eb651${_scopeId}>•</span><button class="${ssrRenderClass([showDraw.value ? "bg-accent text-accent-foreground" : "", "inline-flex h-6 items-center justify-center gap-1 rounded-md border border-input bg-background px-2 text-xs font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"])}"${ssrRenderAttr("title", showDraw.value ? "Metne Dön" : "Çizime Git")} data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-3 w-3" data-v-474eb651${_scopeId}>`);
                  if (showDraw.value) {
                    _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-474eb651${_scopeId}></path>`);
                  } else {
                    _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-474eb651${_scopeId}></path>`);
                  }
                  _push2(`</svg><span class="hidden sm:inline" data-v-474eb651${_scopeId}>${ssrInterpolate(showDraw.value ? "Metne Dön" : "Çizime Git")}</span></button><!--]-->`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><!--]-->`);
              ...
              if (!isLoading.value && write.value.youtube_url) {
                _push2(`<div class="mb-8" data-v-474eb651${_scopeId}><div class="relative w-full overflow-hidden rounded-lg border border-border bg-muted/30" style="${ssrRenderStyle({ "padding-bottom": "56.25%" })}" data-v-474eb651${_scopeId}><iframe${ssrRenderAttr("src", getYoutubeEmbedUrl(write.value.youtube_url))} class="absolute inset-0 h-full w-full" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy" data-v-474eb651${_scopeId}></iframe></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (isLoading.value) {
                _push2(`<div class="space-y-3" data-v-474eb651${_scopeId}><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-4/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-3/4 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-32 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-2/3 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div></div>`);
              } else {
                _push2(`<div data-v-474eb651${_scopeId}><div class="content-container" data-v-474eb651${_scopeId}>`);
                if (isContentLoading.value) {
                  _push2(`<div class="space-y-4" data-v-474eb651${_scopeId}><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-4/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-3/4 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-32 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-2/3 rounded-md" data-v-474eb651${_scopeId}></div></div>`);
                } else if (contentLoadError.value) {
                  _push2(`<div class="rounded-lg border border-destructive/50 bg-destructive/10 p-4 text-center" data-v-474eb651${_scopeId}><p class="text-sm text-destructive" data-v-474eb651${_scopeId}>${ssrInterpolate(contentLoadError.value)}</p><button class="mt-2 text-sm text-primary hover:underline" data-v-474eb651${_scopeId}> Tekrar Dene </button></div>`);
                } else if (contentShouldLoad.value) {
                  _push2(`<div class="article-content ql-editor" data-v-474eb651${_scopeId}>${unref(processedContent) ?? ""}</div>`);
                } else {
                  _push2(`<div class="content-placeholder" data-v-474eb651${_scopeId}><div class="space-y-3" data-v-474eb651${_scopeId}><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-4/6 rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-full rounded-md" data-v-474eb651${_scopeId}></div><div class="skeleton h-4 w-3/4 rounded-md" data-v-474eb651${_scopeId}></div></div></div>`);
                }
                _push2(`</div></div>`);
              }
              if (!isLoading.value) {
                _push2(`<div class="mt-10 flex items-center gap-2 border-t border-border/60 pt-6" data-v-474eb651${_scopeId}><div class="inline-flex items-center gap-2 rounded-md bg-muted/50 px-3 py-1.5 text-sm" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-474eb651${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-474eb651${_scopeId}></path></svg><span class="font-medium text-foreground" data-v-474eb651${_scopeId}>${ssrInterpolate(formatNumber(write.value.views_count))}</span><span class="text-muted-foreground" data-v-474eb651${_scopeId}>görüntülenme</span></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div>`);
              if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
                _push2(`<button class="fixed right-4 top-1/2 z-50 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-colors hover:bg-primary/90 xl:hidden" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-474eb651${_scopeId}></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
                _push2(`<div class="${ssrRenderClass([{ "translate-x-full": !isTableOfContentsOpen.value }, "fixed right-0 top-12 z-40 h-[calc(100vh-3rem)] w-80 transform border-l border-border bg-popover shadow-2xl transition-transform duration-300 lg:h-[calc(100vh-5.5rem)] xl:hidden"])}" data-v-474eb651${_scopeId}><div class="flex h-full flex-col" data-v-474eb651${_scopeId}><div class="flex items-center justify-between border-b border-border p-4" data-v-474eb651${_scopeId}><h3 class="text-lg font-semibold text-foreground" data-v-474eb651${_scopeId}>İçindekiler</h3><button class="inline-flex h-8 w-8 items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-474eb651${_scopeId}></path></svg></button></div><div class="flex-1 overflow-y-auto p-4" data-v-474eb651${_scopeId}>`);
                if (tableOfContents.value.length === 0) {
                  _push2(`<div class="py-8 text-center text-sm text-muted-foreground" data-v-474eb651${_scopeId}> İçindekiler bulunamadı </div>`);
                } else {
                  _push2(`<nav class="space-y-0.5" data-v-474eb651${_scopeId}><!--[-->`);
                  ssrRenderList(tableOfContents.value, (item, index) => {
                    ...
                    ], "block cursor-pointer rounded-md px-2 py-1.5 text-sm transition-colors"])}" data-v-474eb651${_scopeId}>${ssrInterpolate(item.text)}</a>`);
                  });
                  _push2(`<!--]--></nav>`);
                }
                _push2(`</div></div></div>`);
              ...
              if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
                ...
                ])}" data-v-474eb651${_scopeId}><div class="flex max-h-[calc(100vh-7rem)] overflow-hidden rounded-l-lg border border-r-0 border-border bg-popover/95 shadow-2xl backdrop-blur supports-[backdrop-filter]:bg-popover/90" data-v-474eb651${_scopeId}><button class="flex w-11 shrink-0 items-center justify-center border-r border-border bg-muted/60 text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"${ssrRenderAttr("title", isTableOfContentsOpen.value ? "İçindekileri gizle" : "İçindekileri göster")} data-v-474eb651${_scopeId}><span class="sr-only" data-v-474eb651${_scopeId}>${ssrInterpolate(isTableOfContentsOpen.value ? "İçindekileri gizle" : "İçindekileri göster")}</span>`);
                if (isTableOfContentsOpen.value) {
                  _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" data-v-474eb651${_scopeId}></path></svg>`);
                } else {
                  _push2(`<span class="flex flex-col items-center gap-1" data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5" data-v-474eb651${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" data-v-474eb651${_scopeId}></path></svg><span class="[writing-mode:vertical-rl] rotate-180 text-[10px] font-semibold uppercase" data-v-474eb651${_scopeId}> İçindekiler </span></span>`);
                }
                _push2(`</button><div class="min-w-0 flex-1" data-v-474eb651${_scopeId}><div class="flex items-center justify-between border-b border-border p-3" data-v-474eb651${_scopeId}><h3 class="text-sm font-semibold text-foreground" data-v-474eb651${_scopeId}>İçindekiler</h3><button class="inline-flex h-7 w-7 items-center justify-center rounded-md text-xs font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"${ssrRenderAttr("title", isTableOfContentsOpen.value ? "Sabitlemeyi kaldır" : "Sabitle")} data-v-474eb651${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-474eb651${_scopeId}>`);
                if (isTableOfContentsOpen.value) {
                  _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-474eb651${_scopeId}></path>`);
                } else {
                  _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75A2.25 2.25 0 0014.25 4.5h-4.5A2.25 2.25 0 007.5 6.75v3.75m9 0h-9m9 0l.75 7.5h-10.5l.75-7.5" data-v-474eb651${_scopeId}></path>`);
                }
                _push2(`</svg></button></div><div class="max-h-[calc(100vh-10.5rem)] overflow-y-auto p-3" data-v-474eb651${_scopeId}>`);
                if (tableOfContents.value.length === 0) {
                  _push2(`<div class="py-4 text-center text-xs text-muted-foreground" data-v-474eb651${_scopeId}> İçindekiler bulunamadı </div>`);
                } else {
                  _push2(`<nav class="space-y-0.5" data-v-474eb651${_scopeId}><!--[-->`);
                  ssrRenderList(tableOfContents.value, (item, index) => {
                    _push2(`<a class="${ssrRenderClass([[
                      ...
                      getActiveHeadingClass(item.id),
                      activeHeadingId.value === item.id ? "bg-accent font-medium text-accent-foreground" : "text-muted-foreground hover:bg-accent/50 hover:text-foreground"
                    ], "block cursor-pointer rounded-md px-2 py-1.5 text-xs transition-colors"])}" data-v-474eb651${_scopeId}>${ssrInterpolate(item.text)}</a>`);
                  });
                  _push2(`<!--]--></nav>`);
                }
              ...
              if (!isLoading.value && showTableOfContents.value && isTableOfContentsOpen.value && !showDraw.value) {
                _push2(`<div class="fixed inset-0 z-30 bg-black/20 xl:hidden" data-v-474eb651${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-474eb651"]]);
export {
  Screen as default
};
