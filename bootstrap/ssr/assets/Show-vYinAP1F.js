import { defineComponent, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, Fragment, renderList, useSSRContext } from "vue";
          ...
          if (_push2) {
            ...
            if (__props.tenant.database.exists) {
              ...
              if (__props.tenant.database.error && !((_b = __props.tenant.database.table_details) == null ? void 0 : _b.length)) {
                ...
                _push2(`<div class="p-12 text-center"${_scopeId}><div class="w-16 h-16 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4"${_scopeId}><span class="text-3xl"${_scopeId}>📊</span></div><p class="text-slate-500 dark:text-slate-400"${_scopeId}> Bu database&#39;de henüz tablo yok </p></div>`);
              }
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-8" }, [
                    createVNode("div", { class: "flex items-center gap-4 mb-4" }, [
                      ...
                      __props.tenant.type === "main" ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: "px-3 py-1 bg-blue-600 text-white rounded-full text-sm font-semibold"
                    ...
                    createVNode("div", { class: "bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700" }, [
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        ...
                        createVNode("div", { class: "flex justify-between" }, [
                          ...
                          createVNode("span", { class: "font-bold text-slate-900 dark:text-white" }, toDisplayString(((_d = __props.tenant.storage.folders) == null ? void 0 : _d.length) || 0), 1)
                        ])
                      ])
                    ]),
                  ...
                  __props.tenant.database.exists ? (openBlock(), createBlock("div", {
                    key: 0,
                    ...
                    createVNode("div", { class: "p-6 border-b border-slate-200 dark:border-slate-700" }, [
                      ...
                      createVNode("p", { class: "text-sm text-slate-600 dark:text-slate-400 mt-1" }, toDisplayString(__props.tenant.database.name) + " - Toplam " + toDisplayString(__props.tenant.database.tables) + " tablo ", 1)
                    ]),
                    __props.tenant.database.error && !((_e = __props.tenant.database.table_details) == null ? void 0 : _e.length) ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "p-6"
                    }, [
                      createVNode("div", { class: "bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4" }, [
                        createVNode("div", { class: "flex items-start gap-3" }, [
                          ...
                          createVNode("div", null, [
                            createVNode("p", { class: "text-sm font-semibold text-yellow-800 dark:text-yellow-400 mb-1" }, " Tablo detayları yüklenemedi "),
                            createVNode("p", { class: "text-xs text-yellow-700 dark:text-yellow-500" }, toDisplayString(__props.tenant.database.error), 1)
                          ])
                        ])
                      ])
                    ])) : ((_f = __props.tenant.database.table_details) == null ? void 0 : _f.length) ? (openBlock(), createBlock("div", {
                      key: 1,
                      ...
                      createVNode("div", { class: "w-16 h-16 bg-slate-100 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4" }, [
                        createVNode("span", { class: "text-3xl" }, "📊")
                      ]),
                      createVNode("p", { class: "text-slate-500 dark:text-slate-400" }, " Bu database'de henüz tablo yok ")
                    ]))
