import { computed, ref, unref, withCtx, createBlock, createTextVNode, openBlock, createVNode, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, withDirectives, vModelRadio, vModelText, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const browserTitle = computed(() => {
      ...
      return ((_c = (_b = (_a = page.props) == null ? void 0 : _a.screen) == null ? void 0 : _b.seo) == null ? void 0 : _c.title) || ((_f = (_e = (_d = page.props) == null ? void 0 : _d.app) == null ? void 0 : _e.seo) == null ? void 0 : _f.title) || "Yeni Çalışma Alanı";
    });
    const form = useForm({
      images: [],
      status: "published",
