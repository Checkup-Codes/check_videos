      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Açıklama</span></label><textarea rows="3" class="textarea textarea-bordered w-full"${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea>`);
            ...
            _push2(`</div><div class="divider"${_scopeId}></div><div class="flex justify-end gap-2"${_scopeId}><button type="button" class="btn btn-error"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
              _push2(`<span class="loading loading-spinner loading-sm"${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` ${ssrInterpolate(processing.value ? "Siliniyor..." : "Sil")}</button><button type="button" class="btn btn-ghost"${_scopeId}>İptal</button><button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
              _push2(`<span class="loading loading-spinner loading-sm"${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
