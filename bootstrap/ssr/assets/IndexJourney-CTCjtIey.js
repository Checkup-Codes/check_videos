import { ref, computed, onMounted, onUnmounted, withCtx, unref, createBlock, openBlock, createVNode, createCommentVNode, toDisplayString, Fragment, renderList, createTextVNode, useSSRContext } from "vue";
              ...
              ssrRenderList(filteredEntries.value, (entry, index) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (entry.image) {
                        _push3(`<div class="relative"${_scopeId2}><div class="aspect-[21/9] w-full overflow-hidden sm:aspect-[3/1]"${_scopeId2}><img${ssrRenderAttr("src", `/storage/${entry.image}`)}${ssrRenderAttr("alt", entry.title)} class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"${_scopeId2}><div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"${_scopeId2}></div></div><div class="absolute bottom-0 left-0 right-0 p-4 sm:p-5"${_scopeId2}><div class="flex items-center gap-2 text-xs text-white/80 sm:text-sm"${_scopeId2}><svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span${_scopeId2}>${ssrInterpolate(formatDate(entry.entry_date))}</span>`);
                        if (entry.status === "draft") {
                          _push3(`<span class="rounded bg-yellow-500/90 px-1.5 py-0.5 text-xs font-medium text-yellow-900"${_scopeId2}> Taslak </span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div><h3 class="mt-1 text-lg font-semibold text-white sm:text-xl"${_scopeId2}>${ssrInterpolate(entry.title)}</h3></div></div>`);
                      } else {
                        _push3(`<div class="p-4 sm:p-5"${_scopeId2}><div class="flex items-start justify-between gap-4"${_scopeId2}><div class="min-w-0 flex-1"${_scopeId2}><div class="flex items-center gap-2 text-xs text-muted-foreground sm:text-sm"${_scopeId2}><svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span${_scopeId2}>${ssrInterpolate(formatDate(entry.entry_date))}</span>`);
                        if (entry.status === "draft") {
                          _push3(`<span class="rounded bg-yellow-500/20 px-1.5 py-0.5 text-xs font-medium text-yellow-600 dark:text-yellow-400"${_scopeId2}> Taslak </span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div><h3 class="mt-2 text-base font-semibold text-foreground group-hover:text-primary sm:text-lg"${_scopeId2}>${ssrInterpolate(entry.title)}</h3></div><div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-muted/50 transition-colors group-hover:bg-primary/10"${_scopeId2}><svg class="h-4 w-4 text-muted-foreground transition-all group-hover:translate-x-0.5 group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"${_scopeId2}></path></svg></div></div></div>`);
                      }
                    } else {
                      return [
                        entry.image ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "aspect-[21/9] w-full overflow-hidden sm:aspect-[3/1]" }, [
                            createVNode("img", {
                          ...
                          createVNode("div", { class: "absolute bottom-0 left-0 right-0 p-4 sm:p-5" }, [
                            createVNode("div", { class: "flex items-center gap-2 text-xs text-white/80 sm:text-sm" }, [
                              ...
                              entry.status === "draft" ? (openBlock(), createBlock("span", {
                                key: 0,
                                class: "rounded bg-yellow-500/90 px-1.5 py-0.5 text-xs font-medium text-yellow-900"
                              }, " Taslak ")) : createCommentVNode("", true)
                            ]),
                            createVNode("h3", { class: "mt-1 text-lg font-semibold text-white sm:text-xl" }, toDisplayString(entry.title), 1)
                          ])
                          ...
                          createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                            createVNode("div", { class: "min-w-0 flex-1" }, [
                              createVNode("div", { class: "flex items-center gap-2 text-xs text-muted-foreground sm:text-sm" }, [
                                (openBlock(), createBlock("svg", {
                                  class: "h-3.5 w-3.5",
                                  fill: "none",
                                  stroke: "currentColor",
                                ...
                                entry.status === "draft" ? (openBlock(), createBlock("span", {
                                  key: 0,
                                  class: "rounded bg-yellow-500/20 px-1.5 py-0.5 text-xs font-medium text-yellow-600 dark:text-yellow-400"
                                }, " Taslak ")) : createCommentVNode("", true)
                              ]),
                              createVNode("h3", { class: "mt-2 text-base font-semibold text-foreground group-hover:text-primary sm:text-lg" }, toDisplayString(entry.title), 1)
                            ]),
                            createVNode("div", { class: "flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-muted/50 transition-colors group-hover:bg-primary/10" }, [
                              (openBlock(), createBlock("svg", {
                                class: "h-4 w-4 text-muted-foreground transition-all group-hover:translate-x-0.5 group-hover:text-primary",
                                fill: "none",
                                stroke: "currentColor",
                                viewBox: "0 0 24 24"
                              }, [
