import { computed, inject, ref, onMounted, nextTick, onActivated, onDeactivated, onBeforeUnmount, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SubSidebarHeader, {
              ...
              description: String(languagePacks.value.length)
                        ...
                        ssrRenderList(languagePacks.value, (languagePack) => {
                          _push4(ssrRenderComponent(unref(Link), {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="flex w-full items-center justify-between" data-v-cc95dea5${_scopeId4}><div class="flex-1" data-v-cc95dea5${_scopeId4}><h4 class="${ssrRenderClass([
                                  getLinkClasses(`/rendition/words/${languagePack.slug}`) ? "text-primary-foreground" : "text-foreground",
                                  "text-[11px] font-medium leading-tight"
                                ])}" data-v-cc95dea5${_scopeId4}>${ssrInterpolate(languagePack.name)}</h4><div class="${ssrRenderClass([
                                  getLinkClasses(`/rendition/words/${languagePack.slug}`) ? "text-primary-foreground/70" : "text-muted-foreground",
                                  "text-[10px] uppercase"
                                ])}" data-v-cc95dea5${_scopeId4}>${ssrInterpolate(languagePack.language)}</div></div><div class="${ssrRenderClass([
                                ...
                                ])}" data-v-cc95dea5${_scopeId4}>${ssrInterpolate(languagePack.word_count || 0)}</div></div>`);
                              } else {
                                return [
...
const SidebarRendition = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cc95dea5"]]);
export {
