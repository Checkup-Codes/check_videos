...
import { _ as _sfc_main$2, a as _sfc_main$3 } from "./Form-C0ycMiS1.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    fetchCategories();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-screen-bg mx-auto mt-10 w-full max-w-full overflow-auto px-5 lg:mt-0" }, _attrs))}><div class="container mx-auto p-4"><h1 class="mb-4 text-2xl font-bold">Kategori Oluştur</h1>`);
