            ...
            ssrRenderList(resultAnswers.value, (answer, index) => {
              ...
              ssrRenderList(getQuestionOptions(answer.question), (option, optIndex) => {
                _push2(`<div class="${ssrRenderClass([{
                  ...
                  "border-red-500 bg-red-100 dark:bg-red-900": !option.is_correct && answer.selected_option_ids && answer.selected_option_ids.includes(option.id),
                  "border-border bg-background": !option.is_correct && (!answer.selected_option_ids || !answer.selected_option_ids.includes(option.id))
                ...
                if (!option.is_correct && answer.selected_option_ids && answer.selected_option_ids.includes(option.id)) {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(getQuestionOptions(answer.question), (option, optIndex) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex gap-2" }, [
                                ...
                                !option.is_correct && answer.selected_option_ids && answer.selected_option_ids.includes(option.id) ? (openBlock(), createBlock("span", {
                                  key: 1,
