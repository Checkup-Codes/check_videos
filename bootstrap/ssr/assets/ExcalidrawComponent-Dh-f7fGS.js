...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div id="excalidraw-container" class="relative h-[612px] w-full pb-10 pt-3 lg:pb-3"><div id="excali" class="h-full w-full"></div></div><!--]-->`);
    };
  }
};
