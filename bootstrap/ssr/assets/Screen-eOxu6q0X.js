    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="rounded-lg bg-base-100 p-6 shadow-lg" data-v-2d418cab${_scopeId}><div class="mb-4 flex items-center justify-between" data-v-2d418cab${_scopeId}><div class="flex-1" data-v-2d418cab${_scopeId}><h1 class="text-2xl font-bold" data-v-2d418cab${_scopeId}>Dil Paketleri</h1></div><div class="flex gap-2" data-v-2d418cab${_scopeId}><button class="btn btn-success btn-sm" data-v-2d418cab${_scopeId}>Tümünü Dışa Aktar</button>`);
            ...
            _push2(`</div></div><div class="divider my-2" data-v-2d418cab${_scopeId}></div><div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3" data-v-2d418cab${_scopeId}><!--[-->`);
            ssrRenderList(__props.languagePacks, (pack) => {
              _push2(`<div class="card-compact card bg-base-100 shadow-xl transition-shadow hover:shadow-2xl" data-v-2d418cab${_scopeId}><div class="card-body" data-v-2d418cab${_scopeId}><div class="flex items-center justify-between" data-v-2d418cab${_scopeId}><h2 class="card-title" data-v-2d418cab${_scopeId}>${ssrInterpolate(pack.name)}</h2><div class="badge badge-outline" data-v-2d418cab${_scopeId}>${ssrInterpolate(pack.language)}</div></div><p class="text-sm opacity-80" data-v-2d418cab${_scopeId}>${ssrInterpolate(truncateDescription(pack.description))}</p><div class="card-actions mt-3 justify-between" data-v-2d418cab${_scopeId}><div class="flex gap-2" data-v-2d418cab${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
              ...
              _push2(`<button class="btn btn-success btn-sm" data-v-2d418cab${_scopeId}>Dışa Aktar</button></div><div class="badge badge-lg" data-v-2d418cab${_scopeId}>${ssrInterpolate(pack.word_count || 0)} kelime</div></div></div></div>`);
            });
            _push2(`<!--]--></div>`);
            if (__props.languagePacks.length === 0) {
              _push2(`<div class="alert alert-info mt-6" data-v-2d418cab${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-6 w-6 shrink-0 stroke-current" data-v-2d418cab${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-2d418cab${_scopeId}></path></svg><span data-v-2d418cab${_scopeId}>Hiç dil paketi bulunmamaktadır.</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2d418cab"]]);
export {
  Screen as default
};
