import { ref, withCtx, unref, createVNode, withModifiers, withDirectives, vModelText, openBlock, createBlock, toDisplayString, createCommentVNode, vModelSelect, createTextVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex flex-col-reverse gap-2 pt-4 sm:flex-row sm:justify-between"${_scopeId}><button type="button" class="inline-flex items-center justify-center rounded-md border border-destructive/50 bg-destructive/10 px-4 py-2 text-sm font-medium text-destructive transition-colors hover:bg-destructive/20 disabled:opacity-50"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
            ...
            return [
              createVNode("div", { class: "rounded-lg border border-border bg-card p-4 shadow-sm sm:p-6" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("h1", { class: "text-xl font-bold text-foreground sm:text-2xl" }, "Dil Paketi Düzenle"),
                  createVNode("p", { class: "text-muted-foreground mt-1 text-sm" }, "Paket bilgilerini güncelleyin")
                ]),
                createVNode("form", {
