    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!showDraw.value) {
              _push2(`<div class="mx-auto max-w-4xl" data-v-81fec0cd${_scopeId}><div class="bg-base-100 transition-all duration-200" data-v-81fec0cd${_scopeId}><div class="p-6 pt-12 sm:p-8 sm:pt-16" data-v-81fec0cd${_scopeId}><div class="mb-8" data-v-81fec0cd${_scopeId}>`);
              if (isLoading.value) {
                _push2(`<div class="space-y-3" data-v-81fec0cd${_scopeId}><div class="skeleton h-8 w-3/4 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-24 rounded" data-v-81fec0cd${_scopeId}></div></div>`);
              } else {
                _push2(`<!--[--><h1 class="mb-3 text-2xl font-bold text-base-content" data-v-81fec0cd${_scopeId}>${ssrInterpolate(write.value.title)}</h1><div class="text-base-content/60 text-sm" data-v-81fec0cd${_scopeId}>${ssrInterpolate(formatDate(write.value.created_at))}</div><!--]-->`);
              }
              _push2(`</div>`);
              if (!isLoading.value) {
                _push2(`<div class="mb-6 flex items-center justify-between" data-v-81fec0cd${_scopeId}><button class="${ssrRenderClass([showDraw.value ? "border-primary bg-primary text-primary-content" : "text-base-content", "flex items-center gap-2 rounded-lg border border-base-300 bg-base-100 px-3 py-2 text-sm transition-all duration-200 hover:bg-base-200"])}" data-v-81fec0cd${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-81fec0cd${_scopeId}>`);
                if (showDraw.value) {
                  _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-81fec0cd${_scopeId}></path>`);
                } else {
                  _push2(`<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-81fec0cd${_scopeId}></path>`);
                }
                _push2(`</svg> ${ssrInterpolate(showDraw.value ? "Metni Göster" : "Çizimi Göster")}</button>`);
                if (unref(auth).user) {
                  _push2(`<div class="flex items-center gap-2" data-v-81fec0cd${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-81fec0cd${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" data-v-81fec0cd${_scopeId2}></path></svg>`);
                      } else {
                        return [
                  ...
                  _push2(`<button class="flex h-8 w-8 items-center justify-center rounded-lg bg-base-200 text-error transition-all duration-200 hover:bg-error hover:text-error-content" title="Sil" data-v-81fec0cd${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-81fec0cd${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" data-v-81fec0cd${_scopeId}></path></svg></button></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              if (isLoading.value) {
                _push2(`<div class="space-y-3" data-v-81fec0cd${_scopeId}><div class="skeleton h-4 w-full rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-4/6 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-full rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-3/4 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-32 w-full rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-2/3 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-full rounded" data-v-81fec0cd${_scopeId}></div></div>`);
              } else {
                _push2(`<div data-v-81fec0cd${_scopeId}><div class="content-container" data-v-81fec0cd${_scopeId}>`);
                if (contentShouldLoad.value) {
                  _push2(`<div class="article-content ql-editor" data-v-81fec0cd${_scopeId}>${unref(processedContent) ?? ""}</div>`);
                } else {
                  _push2(`<div class="content-placeholder" data-v-81fec0cd${_scopeId}><div class="space-y-3" data-v-81fec0cd${_scopeId}><div class="skeleton h-4 w-full rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-5/6 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-4/6 rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-full rounded" data-v-81fec0cd${_scopeId}></div><div class="skeleton h-4 w-3/4 rounded" data-v-81fec0cd${_scopeId}></div></div></div>`);
                }
                _push2(`</div></div>`);
              }
              if (!isLoading.value) {
                _push2(`<div class="text-base-content/60 mt-8 text-sm" data-v-81fec0cd${_scopeId}>${ssrInterpolate(formatNumber(write.value.views_count))} görüntülenme </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div>`);
            } else {
              _push2(`<div class="relative h-screen w-full" data-v-81fec0cd${_scopeId}><div class="absolute left-4 top-4 z-10" data-v-81fec0cd${_scopeId}><button class="flex items-center gap-2 rounded-lg border border-base-300 bg-base-100 px-3 py-2 text-sm text-base-content shadow-lg transition-all duration-200 hover:bg-base-200" data-v-81fec0cd${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-81fec0cd${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" data-v-81fec0cd${_scopeId}></path></svg> Metne Dön </button></div>`);
            ...
            if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
              _push2(`<button class="fixed right-4 top-1/2 z-50 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-primary text-primary-content shadow-lg transition-all duration-200 hover:shadow-xl 2xl:hidden" data-v-81fec0cd${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5" data-v-81fec0cd${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-81fec0cd${_scopeId}></path></svg></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
              _push2(`<div class="${ssrRenderClass([{ "translate-x-full": !isTableOfContentsOpen.value }, "fixed right-0 top-0 z-40 h-full w-80 transform bg-base-100 shadow-2xl transition-transform duration-300 2xl:hidden"])}" data-v-81fec0cd${_scopeId}><div class="flex h-full flex-col" data-v-81fec0cd${_scopeId}><div class="flex items-center justify-between border-b border-base-300 p-4" data-v-81fec0cd${_scopeId}><h3 class="text-lg font-semibold text-base-content" data-v-81fec0cd${_scopeId}>İçindekiler</h3><button class="btn btn-ghost btn-sm" data-v-81fec0cd${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4" data-v-81fec0cd${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-81fec0cd${_scopeId}></path></svg></button></div><div class="flex-1 overflow-y-auto p-4" data-v-81fec0cd${_scopeId}>`);
              if (tableOfContents.value.length === 0) {
                _push2(`<div class="text-base-content/60 py-8 text-center text-sm" data-v-81fec0cd${_scopeId}> İçindekiler bulunamadı </div>`);
              } else {
                _push2(`<div class="space-y-1" data-v-81fec0cd${_scopeId}><!--[-->`);
                ssrRenderList(tableOfContents.value, (item, index) => {
                  _push2(`<div class="${ssrRenderClass([[getTreeHeadingClass(item.level), getActiveHeadingClass(item.id)], "cursor-pointer rounded-lg p-2 text-sm transition-colors hover:bg-base-200"])}" data-v-81fec0cd${_scopeId}><span class="text-base-content" data-v-81fec0cd${_scopeId}>${ssrInterpolate(item.text)}</span></div>`);
                });
                _push2(`<!--]--></div>`);
              }
              _push2(`</div></div></div>`);
            ...
            if (!isLoading.value && showTableOfContents.value && !showDraw.value) {
              _push2(`<div class="fixed right-4 top-4 z-30 hidden w-64 2xl:block" data-v-81fec0cd${_scopeId}><div class="rounded-lg bg-base-100" data-v-81fec0cd${_scopeId}><div class="border-b border-base-300 p-3" data-v-81fec0cd${_scopeId}><h3 class="text-sm font-semibold text-base-content" data-v-81fec0cd${_scopeId}>İçindekiler</h3></div><div class="overflow-y-auto p-3" style="${ssrRenderStyle({ "max-height": "calc(100vh - 120px)" })}" data-v-81fec0cd${_scopeId}>`);
              if (tableOfContents.value.length === 0) {
                _push2(`<div class="text-base-content/60 py-4 text-center text-xs" data-v-81fec0cd${_scopeId}> İçindekiler bulunamadı </div>`);
              } else {
                _push2(`<div class="space-y-1" data-v-81fec0cd${_scopeId}><!--[-->`);
                ssrRenderList(tableOfContents.value, (item, index) => {
                  _push2(`<div class="${ssrRenderClass([[getTreeHeadingClass(item.level), getActiveHeadingClass(item.id)], "cursor-pointer rounded p-2 text-xs transition-colors hover:bg-base-200"])}" data-v-81fec0cd${_scopeId}><span class="text-base-content" data-v-81fec0cd${_scopeId}>${ssrInterpolate(item.text)}</span></div>`);
                });
                _push2(`<!--]--></div>`);
              }
              _push2(`</div></div></div>`);
            ...
            if (!isLoading.value && showTableOfContents.value && isTableOfContentsOpen.value && !showDraw.value) {
              _push2(`<div class="fixed inset-0 z-30 bg-black/20 2xl:hidden" data-v-81fec0cd${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-81fec0cd"]]);
export {
  Screen as default
};
