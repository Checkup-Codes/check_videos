      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="rounded-lg border bg-card text-card-foreground shadow-sm"${_scopeId}><div class="border-b px-6 py-4"${_scopeId}><h3 class="text-lg font-semibold"${_scopeId}>Font Tercihleri</h3><p class="text-sm text-muted-foreground"${_scopeId}>Başlık ve içerik fontlarını özelleştirin</p></div><div class="space-y-6 p-6"${_scopeId}><div class="space-y-3"${_scopeId}><label class="text-sm font-medium"${_scopeId}>Başlık Fontu</label><div class="grid grid-cols-2 gap-3"${_scopeId}><button class="${ssrRenderClass([
            ...
            ])}"${_scopeId}><div class="flex w-full items-center justify-between"${_scopeId}><span class="font-medium"${_scopeId}>Modern (Clash Display)</span>`);
            ...
            _push2(`</div><p class="text-xs text-muted-foreground"${_scopeId}>Minimalist ve modern görünüm</p><p class="font-clash text-lg"${_scopeId}>Örnek Başlık Metni</p></button><button class="${ssrRenderClass([
              "flex flex-col items-start gap-2 rounded-lg border-2 p-4 text-left transition-all",
              headingFont.value === "classic" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50 hover:bg-accent"
            ])}"${_scopeId}><div class="flex w-full items-center justify-between"${_scopeId}><span class="font-medium"${_scopeId}>Klasik (System)</span>`);
            if (headingFont.value === "classic") {
              _push2(`<div class="flex h-5 w-5 items-center justify-center rounded-full bg-primary"${_scopeId}><svg class="h-3 w-3 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"${_scopeId}></path></svg></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><p class="text-xs text-muted-foreground"${_scopeId}>Geleneksel sistem fontları</p><p class="text-lg" style="${ssrRenderStyle({ "font-family": "system-ui, -apple-system, sans-serif" })}"${_scopeId}>Örnek Başlık Metni</p></button></div></div><div class="space-y-3"${_scopeId}><label class="text-sm font-medium"${_scopeId}>İçerik Fontu</label><div class="grid grid-cols-2 gap-3"${_scopeId}><button class="${ssrRenderClass([
              "flex flex-col items-start gap-2 rounded-lg border-2 p-4 text-left transition-all",
              bodyFont.value === "new" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50 hover:bg-accent"
            ])}"${_scopeId}><div class="flex w-full items-center justify-between"${_scopeId}><span class="font-medium"${_scopeId}>Modern (Satoshi)</span>`);
            ...
            _push2(`</div><p class="text-xs text-muted-foreground"${_scopeId}>Geleneksel sistem fontları</p><p class="text-sm" style="${ssrRenderStyle({ "font-family": "system-ui, -apple-system, sans-serif" })}"${_scopeId}> Bu bir örnek içerik metnidir. Okunabilirliği test edin. </p></button></div></div></div></div></div></div>`);
          } else {
            return [
                        ...
                        createVNode("div", { class: "grid grid-cols-2 gap-3" }, [
                          createVNode("button", {
                            ...
                            createVNode("div", { class: "flex w-full items-center justify-between" }, [
                              createVNode("span", { class: "font-medium" }, "Modern (Clash Display)"),
                            ...
                            createVNode("p", { class: "text-xs text-muted-foreground" }, "Minimalist ve modern görünüm"),
                            createVNode("p", { class: "font-clash text-lg" }, "Örnek Başlık Metni")
                          ], 10, ["onClick"]),
                          createVNode("button", {
                            ...
                            createVNode("div", { class: "flex w-full items-center justify-between" }, [
                              createVNode("span", { class: "font-medium" }, "Klasik (System)"),
                            ...
                            createVNode("p", { class: "text-xs text-muted-foreground" }, "Geleneksel sistem fontları"),
                            createVNode("p", {
                              class: "text-lg",
                      ...
                      createVNode("div", { class: "space-y-3" }, [
                        ...
                        createVNode("div", { class: "grid grid-cols-2 gap-3" }, [
                          createVNode("button", {
                            ...
                            createVNode("div", { class: "flex w-full items-center justify-between" }, [
                              createVNode("span", { class: "font-medium" }, "Modern (Satoshi)"),
