...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: computedClass.value }, _attrs))}><div class="min-h-0 flex-1 overflow-y-auto overscroll-none"><div class="${ssrRenderClass([{ "xl:mx-auto": isWideScreen.value }, "mx-auto max-w-full sm:max-w-[920px]"])}">`);
