    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border bg-background p-2" data-v-f77fbd47${_scopeId}><div class="flex items-center justify-between gap-2" data-v-f77fbd47${_scopeId}><span class="text-xs font-semibold uppercase tracking-wider text-muted-foreground" data-v-f77fbd47${_scopeId}>Oyun Modları</span></div></div>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-1 p-3" data-v-f77fbd47${_scopeId2}><!--[-->`);
                  ssrRenderList(games.value, (game, index) => {
                    _push3(`<button class="${ssrRenderClass([{ "border-primary bg-primary text-primary-foreground": isActiveGame(game.route) }, "block w-full rounded-lg border border-border bg-card p-3 text-left text-sm font-medium text-foreground transition-all hover:bg-accent hover:text-accent-foreground"])}" data-v-f77fbd47${_scopeId2}>${ssrInterpolate(game.name)}</button>`);
                  });
                  _push3(`<!--]--></div>`);
                } else {
                  return [
                    createVNode("div", { class: "space-y-1 p-3" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(games.value, (game, index) => {
                        return openBlock(), createBlock("button", {
                          ...
                          class: ["block w-full rounded-lg border border-border bg-card p-3 text-left text-sm font-medium text-foreground transition-all hover:bg-accent hover:text-accent-foreground", { "border-primary bg-primary text-primary-foreground": isActiveGame(game.route) }]
...
const SidebarPackGame = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f77fbd47"]]);
export {
