import { ref, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withModifiers, withDirectives, vModelText, vModelSelect, vModelCheckbox, Fragment, renderList, withKeys, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      meaning: ((_j = props.word) == null ? void 0 : _j.meaning) || "",
      type: ((_k = props.word) == null ? void 0 : _k.type) || "",
      language: ((_l = props.word) == null ? void 0 : _l.language) || "",
      learning_status: ((_m = props.word) == null ? void 0 : _m.learning_status) || 0,
      flag: ((_n = props.word) == null ? void 0 : _n.flag) || false,
      difficulty_level: ((_o = props.word) == null ? void 0 : _o.difficulty_level) || "",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (props.word) {
              ...
              _push2(`</div><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Zorluk Seviyesi</span></label><select class="select select-bordered w-full" required${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, "") : ssrLooseEqual(unref(form).difficulty_level, "")) ? " selected" : ""}${_scopeId}>Zorluk seviyesi seçiniz</option><option${ssrRenderAttr("value", 1)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 1) : ssrLooseEqual(unref(form).difficulty_level, 1)) ? " selected" : ""}${_scopeId}>Kolay</option><option${ssrRenderAttr("value", 2)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 2) : ssrLooseEqual(unref(form).difficulty_level, 2)) ? " selected" : ""}${_scopeId}>Orta</option><option${ssrRenderAttr("value", 3)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 3) : ssrLooseEqual(unref(form).difficulty_level, 3)) ? " selected" : ""}${_scopeId}>Zor</option><option${ssrRenderAttr("value", 4)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).difficulty_level) ? ssrLooseContain(unref(form).difficulty_level, 4) : ssrLooseEqual(unref(form).difficulty_level, 4)) ? " selected" : ""}${_scopeId}>Çok Zor</option></select>`);
              ...
              _push2(`</div><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Öğrenme Durumu</span></label><select class="select select-bordered w-full"${_scopeId}><option${ssrRenderAttr("value", 0)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 0) : ssrLooseEqual(unref(form).learning_status, 0)) ? " selected" : ""}${_scopeId}>Öğrenilmedi</option><option${ssrRenderAttr("value", 1)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 1) : ssrLooseEqual(unref(form).learning_status, 1)) ? " selected" : ""}${_scopeId}>Öğreniliyor</option><option${ssrRenderAttr("value", 2)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).learning_status) ? ssrLooseContain(unref(form).learning_status, 2) : ssrLooseEqual(unref(form).learning_status, 2)) ? " selected" : ""}${_scopeId}>Öğrenildi</option></select></div><div class="form-control"${_scopeId}><label class="label cursor-pointer"${_scopeId}><span class="label-text"${_scopeId}>Öne Çıkar</span><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).flag) ? ssrLooseContain(unref(form).flag, null) : unref(form).flag) ? " checked" : ""} class="checkbox"${_scopeId}></label></div></div><div class="divider"${_scopeId}>İstatistikler</div><div class="card dark:bg-base-100 border border-gray-200 bg-white shadow transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-4"${_scopeId}><div class="grid grid-cols-1 gap-4 md:grid-cols-2"${_scopeId}><div class="stats shadow"${_scopeId}><div class="stat"${_scopeId}><div class="stat-title"${_scopeId}>Yanlış Sayısı</div><div class="stat-value"${_scopeId}>${ssrInterpolate(props.word.incorrect_count)}</div></div></div><div class="stats shadow"${_scopeId}><div class="stat"${_scopeId}><div class="stat-title"${_scopeId}>Toplam İnceleme</div><div class="stat-value"${_scopeId}>${ssrInterpolate(props.word.review_count)}</div></div></div></div></div></div><div class="divider"${_scopeId}>Dil Paketleri</div><div class="card dark:bg-base-100 border border-gray-200 bg-white shadow transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-4"${_scopeId}>`);
              if (props.languagePacks.length === 0) {
                ...
                ssrRenderList(props.languagePacks, (pack) => {
                  _push2(`<div class="form-control"${_scopeId}><label class="label cursor-pointer"${_scopeId}><span class="label-text"${_scopeId}>${ssrInterpolate(pack.name)} <span class="badge badge-sm badge-outline ml-1"${_scopeId}>${ssrInterpolate(getLanguageName(pack.language))}</span></span><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).language_pack_ids) ? ssrLooseContain(unref(form).language_pack_ids, pack.id) : unref(form).language_pack_ids) ? " checked" : ""}${ssrRenderAttr("value", pack.id)} class="checkbox checkbox-sm"${_scopeId}></label></div>`);
                });
                _push2(`<!--]--></div>`);
              }
              ...
              _push2(`</div></div><div class="divider"${_scopeId}>Örnek Cümleler</div><div class="card dark:bg-base-100 border border-gray-200 bg-white shadow transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-4"${_scopeId}><!--[-->`);
              ssrRenderList(unref(form).example_sentences, (sentence, index) => {
                _push2(`<div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2"${_scopeId}><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Cümle ${ssrInterpolate(index + 1)}</span></label><input${ssrRenderAttr("value", unref(form).example_sentences[index])} class="input input-bordered w-full"${_scopeId}></div><div class="flex items-end gap-2"${_scopeId}><div class="form-control w-full"${_scopeId}><label class="label"${_scopeId}><span class="label-text"${_scopeId}>Çeviri</span></label><input${ssrRenderAttr("value", unref(form).example_translations[index])} class="input input-bordered w-full"${_scopeId}></div><button type="button" class="btn btn-circle btn-outline btn-sm btn-error mb-2"${_scopeId}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button></div></div>`);
              });
              _push2(`<!--]--><button type="button" class="btn btn-outline btn-sm"${_scopeId}>Örnek Cümle Ekle</button></div></div><div class="divider"${_scopeId}>Eş Anlamlılar</div><div class="card dark:bg-base-100 border border-gray-200 bg-white shadow transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-4"${_scopeId}><div class="mb-4 flex flex-wrap gap-2"${_scopeId}><!--[-->`);
              ssrRenderList(unref(form).synonyms, (synonym, index) => {
                _push2(`<div class="badge badge-lg badge-outline gap-1"${_scopeId}>${ssrInterpolate(synonym)} <button type="button" class="btn btn-circle btn-ghost btn-xs"${_scopeId}><svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button></div>`);
              });
              _push2(`<!--]--></div><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", newSynonym.value)} type="text" class="input input-bordered w-full" placeholder="Yeni eş anlamlı kelime"${_scopeId}><button type="button" class="btn btn-outline"${_scopeId}>Ekle</button></div></div></div><div class="divider"${_scopeId}></div><div class="flex justify-end gap-2"${_scopeId}>`);
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 gap-6 md:grid-cols-2" }, [
                      ...
                      createVNode("div", { class: "form-control w-full" }, [
                        ...
                        unref(errors).meaning ? (openBlock(), createBlock("label", {
                          key: 0,
                          class: "label"
                        }, [
                          createVNode("span", { class: "label-text-alt text-error" }, toDisplayString(unref(errors).meaning), 1)
                        ])) : createCommentVNode("", true)
                      ]),
                      createVNode("div", { class: "form-control w-full" }, [
                        createVNode("label", { class: "label" }, [
                    ...
                    createVNode("div", { class: "card dark:bg-base-100 border border-gray-200 bg-white shadow transition-all duration-200 dark:border-gray-700" }, [
                            ...
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("label", { class: "label cursor-pointer" }, [
                                createVNode("span", { class: "label-text" }, [
                                  ...
                                  createVNode("span", { class: "badge badge-sm badge-outline ml-1" }, toDisplayString(getLanguageName(pack.language)), 1)
                                ]),
                                withDirectives(createVNode("input", {
                                  type: "checkbox",
