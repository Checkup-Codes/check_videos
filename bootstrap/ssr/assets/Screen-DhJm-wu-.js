    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<header class="flex h-[100%] items-center justify-center text-black"${_scopeId}><div class="text-center"${_scopeId}><h2 class="mb-4 text-4xl font-bold"${_scopeId}>Versiyonlar</h2></div></header>`);
          } else {
            return [
              createVNode("header", { class: "flex h-[100%] items-center justify-center text-black" }, [
                createVNode("div", { class: "text-center" }, [
                  createVNode("h2", { class: "mb-4 text-4xl font-bold" }, "Versiyonlar")
                ])
              ])
            ];
          }
