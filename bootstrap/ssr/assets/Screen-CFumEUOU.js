...
import { _ as _sfc_main$4 } from "./Card-V_bTdXom.js";
import { _ as _export_sfc, b as _sfc_main$3 } from "../ssr.js";
                ...
                !isLoading.value ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                    ...
                    createVNode("div", { class: "flex shrink-0 flex-wrap items-center gap-1.5" }, [
                      ...
                      unref(auth).user ? (openBlock(), createBlock(_sfc_main$3, {
                        key: 0,
                        onClick: ($event) => statusFilter.value = "private",
                        variant: statusFilter.value === "private" ? "default" : "outline",
                        size: "sm",
                      ...
                      statusFilter.value !== "all" ? (openBlock(), createBlock(_sfc_main$3, {
                        key: 2,
                        onClick: clearFilters,
                        variant: "ghost",
                        size: "sm",
