import { defineComponent, ref, computed, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, withDirectives, vModelCheckbox, withModifiers, vModelText, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderAttr, ssrLooseContain } from "vue/server-renderer";
              ...
              createVNode("div", { class: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-8" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-8" }, [
                    createVNode("h1", { class: "text-3xl font-bold text-slate-900 dark:text-white" }, " 🏢 Tenant Yönetimi "),
                    createVNode("p", { class: "mt-2 text-slate-600 dark:text-slate-400" }, " Tüm tenantlarınızı buradan yönetin ")
                  ]),
                    ...
                    createVNode("div", { class: "bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700" }, [
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("div", null, [
                          createVNode("p", { class: "text-sm font-medium text-slate-600 dark:text-slate-400" }, "Toplam Tenant"),
                  ...
                  createVNode("div", { class: "bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden" }, [
                    createVNode("div", { class: "overflow-x-auto" }, [
                      ...
                      __props.tenants.length === 0 ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "text-center py-12"
                      }, [
                        createVNode("p", { class: "text-slate-500 dark:text-slate-400 text-lg" }, " Henüz tenant eklenmemiş ")
