import { defineComponent, onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, onBeforeUnmount, createTextVNode, createVNode, createBlock, toDisplayString, openBlock } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="h-screen overflow-hidden bg-base-100"><nav class="border-b border-base-300 bg-base-200"><div class="mx-auto max-w-7xl px-4 sm:px-6"><div class="flex h-16 justify-between"><div class="flex"><div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">`);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("media.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Medya Yönetimi `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("social-media.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Sosyal Medya Yönetimi `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("seo.edit")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` SEO Yönetimi `);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("theme.management"),
        active: _ctx.route().current("theme.management")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Tema Yönetimi `);
          } else {
            return [
              createTextVNode("Tema Yönetimi ")
            ];
          }
        }),
        _: 1
      ...
      _push(`</div></div><div class="-me-2 flex items-center sm:hidden"><button class="text-base-content/60 inline-flex items-center justify-center rounded-md p-2 transition duration-150 ease-in-out hover:bg-base-300 hover:text-base-content focus:bg-base-300 focus:text-base-content focus:outline-none"><svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path class="${ssrRenderClass({
      ...
      _push(`</div><div class="border-t border-base-300 pb-1 pt-4"><div class="px-4"><div class="text-base font-medium text-base-content">${ssrInterpolate(_ctx.$page.props.auth.user.name)}</div><div class="text-base-content/70 text-sm font-medium">${ssrInterpolate(_ctx.$page.props.auth.user.email)}</div></div><div class="mt-3 space-y-1">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        href: _ctx.route("profile.edit")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<main class="overflow-y-auto" style="${ssrRenderStyle({ "height": "calc(100vh - 11rem)" })}">`);
