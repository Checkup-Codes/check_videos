    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ isNarrow: isNarrow.value }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isLoggedIn.value) {
              _push2(`<div class="shrink-0 border-b border-border bg-background/95 p-2" data-v-23aa8619${_scopeId}><div class="flex items-center justify-between gap-2" data-v-23aa8619${_scopeId}><div class="flex items-center gap-1" data-v-23aa8619${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-23aa8619${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" data-v-23aa8619${_scopeId2}></path></svg>`);
                    if (!isNarrow.value) {
                      _push3(`<span data-v-23aa8619${_scopeId2}>Liste</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-23aa8619${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" data-v-23aa8619${_scopeId2}></path></svg>`);
                    if (!isNarrow.value) {
                      _push3(`<span data-v-23aa8619${_scopeId2}>Kategori</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
...
const SidebarLayoutWrite = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-23aa8619"]]);
export {
