    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ isNarrow: isNarrow.value }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border bg-background p-2" data-v-675ab2c9${_scopeId}><div class="flex items-center justify-between gap-2" data-v-675ab2c9${_scopeId}><div class="flex items-center gap-1" data-v-675ab2c9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-675ab2c9${_scopeId2}>Servisler</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-675ab2c9${_scopeId2}>Projeler</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-675ab2c9${_scopeId2}>Müşteriler</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-1 p-2" data-v-675ab2c9${_scopeId2}>`);
                  if (currentView.value === "services") {
                    _push3(`<div class="space-y-1" data-v-675ab2c9${_scopeId2}>`);
                    if (!services.value || services.value.length === 0) {
                      _push3(`<div class="p-2 text-xs text-muted-foreground" data-v-675ab2c9${_scopeId2}> Henüz servis bulunmamaktadır. </div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<!--[-->`);
                    ssrRenderList(services.value, (service) => {
                      _push3(ssrRenderComponent(unref(Link), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center gap-2" data-v-675ab2c9${_scopeId3}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-675ab2c9${_scopeId3}><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" data-v-675ab2c9${_scopeId3}></path></svg><span class="truncate font-medium" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(service.name)}</span></div>`);
                            if (!isNarrow.value && service.description) {
                              _push4(`<span class="mt-0.5 truncate text-xs opacity-70" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(service.description)}</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
                  ...
                  if (currentView.value === "projects") {
                    ...
                    if (!projects.value || projects.value.length === 0) {
                      _push3(`<div class="p-2 text-xs text-muted-foreground" data-v-675ab2c9${_scopeId2}> Henüz proje bulunmamaktadır. </div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<!--[-->`);
                    ssrRenderList(projects.value, (project) => {
                      _push3(ssrRenderComponent(unref(Link), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center gap-2" data-v-675ab2c9${_scopeId3}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-675ab2c9${_scopeId3}><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" data-v-675ab2c9${_scopeId3}></path></svg><span class="truncate font-medium" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(project.project_name)}</span></div>`);
                            if (!isNarrow.value && project.customer) {
                              _push4(`<span class="mt-0.5 truncate text-xs opacity-70" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(project.customer.first_name)} ${ssrInterpolate(project.customer.last_name)}</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
                  ...
                  if (currentView.value === "customers") {
                    ...
                    if (!customers.value || customers.value.length === 0) {
                      _push3(`<div class="p-2 text-xs text-muted-foreground" data-v-675ab2c9${_scopeId2}> Henüz müşteri bulunmamaktadır. </div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<!--[-->`);
                    ssrRenderList(customers.value, (customer) => {
                      _push3(ssrRenderComponent(unref(Link), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex items-center gap-2" data-v-675ab2c9${_scopeId3}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-v-675ab2c9${_scopeId3}><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" data-v-675ab2c9${_scopeId3}></path></svg><span class="truncate font-medium" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(customer.first_name)} ${ssrInterpolate(customer.last_name)}</span></div>`);
                            if (!isNarrow.value) {
                              _push4(`<span class="mt-0.5 truncate text-xs opacity-70" data-v-675ab2c9${_scopeId3}>${ssrInterpolate(customer.email)}</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
...
const SidebarLayoutProject = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-675ab2c9"]]);
