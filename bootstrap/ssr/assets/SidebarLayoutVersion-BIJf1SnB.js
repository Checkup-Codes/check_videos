...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="fixed z-30 mt-14 w-full shadow-lg shadow-subsidebar-shadow lg:mt-0 lg:w-[27%]"><div class="flex cursor-pointer justify-between text-sm text-black lg:grid-cols-2"><div class="rounded p-3 font-semibold underline underline-offset-4"><div class="rounded bg-gray-100 p-2">Versiyonlar</div></div>`);
      if (unref(auth).user) {
        _push(`<div class="">`);
