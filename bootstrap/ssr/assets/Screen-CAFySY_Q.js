import { ref, computed, onMounted, nextTick, withCtx, unref, createBlock, createTextVNode, openBlock, createVNode, toDisplayString, createCommentVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</svg> ${ssrInterpolate(showDraw.value ? "Metni Göster" : "Çizim Göster")}</button>`);
            if (unref(auth).user) {
            ...
            return [
              createVNode("div", { class: "card border border-base-200 bg-base-100 shadow-md transition-all duration-200" }, [
                createVNode("div", { class: "card-body p-4 sm:p-6" }, [
                  ...
                  createVNode("div", { class: "sticky bottom-0 left-0 right-0 z-10 -mx-4 mt-4 border-t border-base-200 bg-base-100 p-2 sm:static sm:z-0 sm:mx-0 sm:mt-0 sm:border-0 sm:bg-transparent sm:p-0" }, [
