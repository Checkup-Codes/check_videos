...
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrInterpolate } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ name: "WriteList" }, {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-1 p-2" }, _attrs))} data-v-448dd22c><!--[-->`);
      ssrRenderList(filteredWrites.value, (write) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: ["block rounded-lg border border-transparent p-3", [
            activeWrite.value === getActiveWritePath(write) ? "bg-primary text-primary-foreground" : "border-border bg-card hover:bg-accent"
          ]]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="${ssrRenderClass([activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground font-normal" : "text-foreground font-normal", "line-clamp-2 text-[10px] leading-tight"])}" style="${ssrRenderStyle({ "font-family": "'Satoshi', system-ui, sans-serif", "font-weight": "400" })}" data-v-448dd22c${_scopeId}>${ssrInterpolate(write.title)}</h3><div class="${ssrRenderClass([activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground/70" : "text-muted-foreground", "flex flex-col gap-1 text-[9px] sm:flex-row sm:items-center sm:justify-between"])}" style="${ssrRenderStyle({ "font-family": "'Satoshi', system-ui, sans-serif", "font-weight": "400" })}" data-v-448dd22c${_scopeId}><div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-3" data-v-448dd22c${_scopeId}><span class="flex items-center gap-1" data-v-448dd22c${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, { class: "h-3 w-3 flex-shrink-0" }, null, _parent2, _scopeId));
              _push2(`<span class="truncate" data-v-448dd22c${_scopeId}>${ssrInterpolate(formatDate(write.created_at))}</span></span><span class="flex items-center gap-1" data-v-448dd22c${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, { class: "h-3 w-3 flex-shrink-0" }, null, _parent2, _scopeId));
              _push2(`<span class="truncate" data-v-448dd22c${_scopeId}>${ssrInterpolate(formatNumber(write.views_count))} görüntülenme</span></span></div><div class="flex items-center gap-1 self-start sm:self-center" data-v-448dd22c${_scopeId}>`);
              if (write.status === "private") {
                _push2(`<span class="text-yellow-500 dark:text-yellow-400" title="Gizli yazı" data-v-448dd22c${_scopeId}>`);
              ...
              if (write.status === "link_only") {
                _push2(`<span class="text-blue-500 dark:text-blue-400" title="Sadece link" data-v-448dd22c${_scopeId}>`);
              ...
              return [
                createVNode("h3", {
                  class: ["line-clamp-2 text-[10px] leading-tight", activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground font-normal" : "text-foreground font-normal"],
                  style: { "font-family": "'Satoshi', system-ui, sans-serif", "font-weight": "400" }
                }, toDisplayString(write.title), 3),
                createVNode("div", {
                  class: ["flex flex-col gap-1 text-[9px] sm:flex-row sm:items-center sm:justify-between", activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground/70" : "text-muted-foreground"],
                  style: { "font-family": "'Satoshi', system-ui, sans-serif", "font-weight": "400" }
                }, [
      ...
      if (filteredWrites.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center text-muted-foreground" data-v-448dd22c><div data-v-448dd22c>Henüz yazı bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const WriteList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-448dd22c"]]);
export {
