...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="fixed z-10 mt-14 w-full shadow-right shadow-gray-100 lg:mt-0 lg:w-[27%]"><div class="flex cursor-pointer justify-between text-sm text-black"><div><div class="m-2 space-y-4 rounded p-1 font-bold text-black"><div class="flex"><div class="${ssrRenderClass([category.value ? "w-auto" : "w-32", "flex content-center items-center rounded-lg border-2 border-sidebar bg-gray-200 p-1 pl-3 hover:border-black"])}"> Kategori seç `);
      if (category.value) {
      ...
      _push(`</div><div class="h-[92vh] overflow-auto"><div class="sticky top-0 z-20 bg-sidebar"><div style="${ssrRenderStyle(showCategories.value ? null : { display: "none" })}" class="grid grid-cols-3 gap-1 bg-sidebar px-4 pb-3 text-sm"><!--[-->`);
      ...
      ssrRenderList(writes.value, (write) => {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="py-0.5 font-bold"${_scopeId}>${ssrInterpolate(write.title)}</div><div class="py-1 text-sm text-gray-400"${_scopeId}>${ssrInterpolate(formatDate(write.published_at))}</div>`);
            } else {
              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/WritesCategories/Categories/SidebarLayoutCategory.vue");
