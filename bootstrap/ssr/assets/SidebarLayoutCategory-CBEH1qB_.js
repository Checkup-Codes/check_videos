...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))} data-v-c1fbd4cb>`);
      if (flashSuccess.value) {
        _push(`<div class="fixed right-4 top-10 z-50" data-v-c1fbd4cb><div class="relative rounded border border-green-400 bg-green-100 px-4 py-3 text-green-700" role="alert" data-v-c1fbd4cb><strong class="font-bold" data-v-c1fbd4cb>Başarılı! </strong><span class="block sm:inline" data-v-c1fbd4cb>${ssrInterpolate(flashSuccess.value)}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="fixed z-30 mt-14 w-full shadow-lg shadow-subsidebar-shadow lg:mt-0 lg:w-[27%]" data-v-c1fbd4cb><div class="flex cursor-pointer justify-between text-sm text-black" data-v-c1fbd4cb><div data-v-c1fbd4cb><div class="m-2 space-y-4 rounded p-1 font-bold text-black" data-v-c1fbd4cb><div class="flex" data-v-c1fbd4cb><div class="${ssrRenderClass([category.value ? "w-auto" : "w-32", "flex content-center items-center rounded-lg border-2 border-sidebar bg-gray-200 p-1 pl-3 hover:border-black"])}" data-v-c1fbd4cb> Kategori seç `);
      if (category.value) {
        _push(`<span data-v-c1fbd4cb> : <span class="px-1" data-v-c1fbd4cb>${ssrInterpolate(category.value.name)}</span><span data-v-c1fbd4cb></span></span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="pr-1" data-v-c1fbd4cb>`);
      _push(ssrRenderComponent(DropdownSvg, null, null, _parent));
      _push(`</span></div>`);
      if (category.value) {
        _push(`<div class="duration-50 mx-3 flex content-center items-center rounded-lg transition-all" data-v-c1fbd4cb>`);
      ...
      _push(`</div></div></div>`);
      if (unref(auth).user) {
        _push(`<div data-v-c1fbd4cb>`);
        _push(ssrRenderComponent(unref(Link), { href: "/writes/create" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="mx-2 rounded p-1 text-center font-bold text-black underline" data-v-c1fbd4cb${_scopeId}>Yeni Yazı Ekle</div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(Link), { href: "/categories/create" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="mx-2 rounded p-1 text-center font-bold text-black underline" data-v-c1fbd4cb${_scopeId}>Kategori Ekle</div>`);
            } else {
              return [
      ...
      _push(`</div><div class="h-[100vh] overflow-auto" data-v-c1fbd4cb><div class="sticky top-0 z-20 bg-sidebar" data-v-c1fbd4cb><div style="${ssrRenderStyle(showCategories.value ? null : { display: "none" })}" class="grid grid-cols-3 gap-1 bg-sidebar px-4 pb-3 text-sm" data-v-c1fbd4cb><!--[-->`);
      ssrRenderList(categories.value, (category2) => {
        _push(`<div class="transition-all duration-100" data-v-c1fbd4cb>`);
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="rounded p-1 text-center font-bold" data-v-c1fbd4cb${_scopeId}>${ssrInterpolate(category2.name)}</div>`);
            } else {
              return [
      ...
      ssrRenderList(writes.value, (write) => {
        _push(`<div class="px-3 py-1" data-v-c1fbd4cb>`);
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="py-0.5 font-bold" data-v-c1fbd4cb${_scopeId}>${ssrInterpolate(write.title)}</div><div class="py-1 text-sm text-gray-400" data-v-c1fbd4cb${_scopeId}>${ssrInterpolate(formatDate(write.published_at))}</div>`);
            } else {
              return [
...
const SidebarLayoutCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c1fbd4cb"]]);
export {
