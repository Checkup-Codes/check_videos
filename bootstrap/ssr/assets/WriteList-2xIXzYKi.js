...
const _sfc_main = {
  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-3c97794e><div class="min-h-full" data-v-3c97794e><!--[-->`);
      ssrRenderList(__props.writes, (write) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="font-semibold" data-v-3c97794e${_scopeId}>${ssrInterpolate(write.title)}</div><div class="flex items-center justify-between text-xs" data-v-3c97794e${_scopeId}><span data-v-3c97794e${_scopeId}>${ssrInterpolate(formatDate(write.created_at))}</span><span data-v-3c97794e${_scopeId}>${ssrInterpolate(write.views_count)} görüntülenme</span></div>`);
            } else {
              return [
...
const WriteList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3c97794e"]]);
export {
