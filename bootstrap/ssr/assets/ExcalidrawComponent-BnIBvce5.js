...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bg-base-100 px-2 lg:p-3"><div class="flex justify-between rounded-md px-1 py-2 text-base-content sm:mx-3 md:mx-5"><div class="flex"><label for="versionDropdown" class="my-auto text-nowrap px-3 font-semibold">Versiyon Seç:</label><select id="versionDropdown" class="select-bordered select select-sm mx-5 bg-base-100 text-base-content"><!--[-->`);
      ...
      if (unref(props).auth.user) {
        _push(`<button class="btn btn-ghost btn-sm">Sil</button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(props).auth.user) {
