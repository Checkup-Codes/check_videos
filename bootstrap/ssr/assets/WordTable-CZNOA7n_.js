...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container bg-theme-background px-5 text-theme-text" }, _attrs))}><table class="w-full table-auto"><thead><tr><th>Kelime</th><th>Türkçe</th><th>İngilizce</th></tr></thead><tbody><!--[-->`);
