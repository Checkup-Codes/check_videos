            ...
            _push2(ssrRenderComponent(_sfc_main$4, { elevated: "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><div class="form-control w-full"${_scopeId2}><label class="label"${_scopeId2}><span class="label-text"${_scopeId2}>JSON Dosyası İçe Aktar (Opsiyonel)</span></label><input type="file" accept=".json" class="file-input file-input-bordered w-full"${_scopeId2}><label class="label"${_scopeId2}><span class="label-text-alt"${_scopeId2}>Daha önce dışa aktarılmış bir JSON dosyasını yükleyerek kelimeleri otomatik olarak içe aktarabilirsiniz.</span></label>`);
                  if (unref(errors).import_file) {
                    _push3(`<label class="label"${_scopeId2}><span class="label-text-alt text-error"${_scopeId2}>${ssrInterpolate(unref(errors).import_file)}</span></label>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div class="divider"${_scopeId2}></div><div class="flex justify-end gap-2"${_scopeId2}><button type="button" class="btn btn-ghost"${_scopeId2}>İptal</button><button type="submit" class="btn btn-primary"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId2}>`);
                  if (processing.value) {
