...
const _sfc_main = /* @__PURE__ */ Object.assign({ name: "WriteList" }, {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-1 p-2" }, _attrs))} data-v-eff10b64><!--[-->`);
      ssrRenderList(filteredWrites.value, (write) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="${ssrRenderClass([activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground" : "text-foreground", "line-clamp-2 text-sm font-medium leading-tight"])}" data-v-eff10b64${_scopeId}>${ssrInterpolate(write.title)}</h3><div class="${ssrRenderClass([activeWrite.value === getActiveWritePath(write) ? "text-primary-foreground/70" : "text-muted-foreground", "flex flex-col gap-1 text-xs sm:flex-row sm:items-center sm:justify-between"])}" data-v-eff10b64${_scopeId}><div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-3" data-v-eff10b64${_scopeId}><span class="flex items-center gap-1" data-v-eff10b64${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$1, { class: "h-3 w-3 flex-shrink-0" }, null, _parent2, _scopeId));
              _push2(`<span class="truncate" data-v-eff10b64${_scopeId}>${ssrInterpolate(formatDate(write.created_at))}</span></span><span class="flex items-center gap-1" data-v-eff10b64${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, { class: "h-3 w-3 flex-shrink-0" }, null, _parent2, _scopeId));
              _push2(`<span class="truncate" data-v-eff10b64${_scopeId}>${ssrInterpolate(formatNumber(write.views_count))} görüntülenme</span></span></div><div class="flex items-center gap-1 self-start sm:self-center" data-v-eff10b64${_scopeId}>`);
              if (write.status === "private") {
                _push2(`<span class="text-yellow-500 dark:text-yellow-400" title="Gizli yazı" data-v-eff10b64${_scopeId}>`);
              ...
              if (write.status === "link_only") {
                _push2(`<span class="text-blue-500 dark:text-blue-400" title="Sadece link" data-v-eff10b64${_scopeId}>`);
      ...
      if (filteredWrites.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center text-muted-foreground" data-v-eff10b64><div data-v-eff10b64>Henüz yazı bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const WriteList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eff10b64"]]);
export {
