import { computed, ref, onMounted, unref, withCtx, createTextVNode, createVNode, withModifiers, openBlock, createBlock, Fragment, renderList, createCommentVNode, toDisplayString, withDirectives, vModelRadio, Teleport, vModelText, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderClass, ssrRenderTeleport } from "vue/server-renderer";
...
import { I as ImageCropper } from "./ImageCropper-rr4d9pon.js";
import "../ssr.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const browserTitle = computed(() => {
      var _a, _b, _c;
      return ((_c = (_b = (_a = page.props) == null ? void 0 : _a.screen) == null ? void 0 : _b.seo) == null ? void 0 : _c.title) || "Çalışma Alanı Düzenle";
    });
    const form = useForm({
      images: [],
    ...
    onMounted(() => {
      var _a;
      if (((_a = props.workspace.products) == null ? void 0 : _a.length) > 0) {
    ...
    const handleCrop = (blob) => {
      var _a;
      const fileName = ((_a = pendingFiles.value[currentCropIndex.value]) == null ? void 0 : _a.name) || `image-${Date.now()}.jpg`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, { width: "content" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    title: "Çalışma Alanını Düzenle",
                    description: "Çalışma alanınızı ve ürünlerinizi güncelleyin"
                  }, null, _parent3, _scopeId2));
                  _push3(`<form class="space-y-6"${_scopeId2}><div class="rounded-xl bg-card p-6 ring-1 ring-border/50"${_scopeId2}><h2 class="mb-4 text-lg font-semibold text-foreground"${_scopeId2}>Görseller</h2><div class="space-y-4"${_scopeId2}>`);
                  if (currentImages.value.length > 0 && imagePreviews.value.length === 0) {
                    _push3(`<div${_scopeId2}><p class="mb-2 text-sm text-muted-foreground"${_scopeId2}>Mevcut Görseller</p><div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4"${_scopeId2}><!--[-->`);
                    ssrRenderList(currentImages.value, (image, index) => {
                      _push3(`<div class="aspect-video overflow-hidden rounded-lg ring-1 ring-border"${_scopeId2}><img${ssrRenderAttr("src", `/storage/${image}`)} alt="Current" class="h-full w-full object-cover"${_scopeId2}></div>`);
                    });
                    _push3(`<!--]--></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<label class="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border px-6 py-8 transition-colors hover:border-primary"${_scopeId2}><svg class="mb-2 h-10 w-10 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span class="text-sm font-medium text-foreground"${_scopeId2}>${ssrInterpolate(currentImages.value.length > 0 ? "Resimleri Değiştir" : "Resim Yükle")}</span><span class="mt-1 text-xs text-muted-foreground"${_scopeId2}>PNG, JPG, WEBP - max 5MB</span><input type="file" accept="image/*" multiple class="hidden"${_scopeId2}></label>`);
                  if (imagePreviews.value.length > 0) {
                    _push3(`<div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4"${_scopeId2}><!--[-->`);
                    ssrRenderList(imagePreviews.value, (preview, index) => {
                      _push3(`<div class="group relative aspect-video overflow-hidden rounded-lg ring-1 ring-border"${_scopeId2}><img${ssrRenderAttr("src", preview)} alt="Preview" class="h-full w-full object-cover"${_scopeId2}><button type="button" class="absolute right-2 top-2 rounded-full bg-destructive p-1.5 text-destructive-foreground opacity-0 transition-opacity group-hover:opacity-100"${_scopeId2}><svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId2}></path></svg></button></div>`);
                    });
                    _push3(`<!--]--></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div></div><div class="rounded-xl bg-card p-6 ring-1 ring-border/50"${_scopeId2}><h2 class="mb-4 text-lg font-semibold text-foreground"${_scopeId2}>Durum</h2><div class="flex gap-4"${_scopeId2}><label class="flex cursor-pointer items-center gap-2"${_scopeId2}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).status, "published")) ? " checked" : ""} value="published" class="h-4 w-4 border-input text-primary focus:ring-primary"${_scopeId2}><span class="text-sm text-foreground"${_scopeId2}>Yayınla</span></label><label class="flex cursor-pointer items-center gap-2"${_scopeId2}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).status, "draft")) ? " checked" : ""} value="draft" class="h-4 w-4 border-input text-primary focus:ring-primary"${_scopeId2}><span class="text-sm text-foreground"${_scopeId2}>Taslak</span></label></div></div><div class="rounded-xl bg-card p-6 ring-1 ring-border/50"${_scopeId2}><div class="mb-4 flex items-center justify-between"${_scopeId2}><h2 class="text-lg font-semibold text-foreground"${_scopeId2}>Ürünler</h2><button type="button" class="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"${_scopeId2}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"${_scopeId2}></path></svg> Ürün Ekle </button></div>`);
                  if (unref(form).products.length === 0) {
                    _push3(`<div class="rounded-lg border border-dashed border-border py-8 text-center"${_scopeId2}><p class="text-sm text-muted-foreground"${_scopeId2}>Henüz ürün eklenmedi</p></div>`);
                  } else {
                    _push3(`<div class="space-y-3"${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(form).products, (product, index) => {
                      _push3(`<div class="${ssrRenderClass([{ "border-destructive": hasProductError(index) }, "flex items-center justify-between rounded-lg border border-border bg-background p-4"])}"${_scopeId2}><div class="min-w-0 flex-1"${_scopeId2}><h3 class="font-medium text-foreground"${_scopeId2}>${ssrInterpolate(product.name)}</h3>`);
                      if (product.features) {
                        _push3(`<p class="mt-1 truncate text-sm text-muted-foreground"${_scopeId2}>${ssrInterpolate(product.features)}</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      if (product.link) {
                        _push3(`<a${ssrRenderAttr("href", product.link)} target="_blank" class="mt-1 inline-flex items-center gap-1 text-xs text-primary hover:underline"${_scopeId2}><span${_scopeId2}>Link</span><svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"${_scopeId2}></path></svg></a>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      if (hasProductError(index)) {
                        _push3(`<div class="mt-2 text-xs text-destructive"${_scopeId2}>`);
                        if (product.name.length > 255) {
                          _push3(`<p${_scopeId2}>İsim 255 karakteri aşamaz (${ssrInterpolate(product.name.length)}/255)</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        if (product.link && !isValidUrl(product.link)) {
                          _push3(`<p${_scopeId2}>Geçersiz URL formatı</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        if (product.link && product.link.length > 500) {
                          _push3(`<p${_scopeId2}>Link 500 karakteri aşamaz (${ssrInterpolate(product.link.length)}/500)</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div>`);
                      ...
                      _push3(`</div><div class="ml-4 flex items-center gap-2"${_scopeId2}><button type="button" class="rounded-lg p-2 text-muted-foreground hover:bg-accent hover:text-foreground"${_scopeId2}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"${_scopeId2}></path></svg></button><button type="button" class="rounded-lg p-2 text-destructive hover:bg-destructive/10"${_scopeId2}><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"${_scopeId2}></path></svg></button></div></div>`);
                    });
                    _push3(`<!--]--></div>`);
                  }
                  if (hasAnyProductError.value) {
                    _push3(`<div class="mt-4 rounded-lg bg-destructive/10 p-3 text-sm text-destructive"${_scopeId2}> Bazı ürünlerde hata var. Lütfen düzeltin. </div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  ...
                  _push3(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing || hasAnyProductError.value) ? " disabled" : ""} class="rounded-lg bg-primary px-6 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 disabled:opacity-50"${_scopeId2}>${ssrInterpolate(unref(form).processing ? "Güncelleniyor..." : "Güncelle")}</button></div></form>`);
                } else {
                  return [
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "rounded-xl bg-card p-6 ring-1 ring-border/50" }, [
                        ...
                        createVNode("div", { class: "space-y-4" }, [
                          currentImages.value.length > 0 && imagePreviews.value.length === 0 ? (openBlock(), createBlock("div", { key: 0 }, [
                            createVNode("p", { class: "mb-2 text-sm text-muted-foreground" }, "Mevcut Görseller"),
                            createVNode("div", { class: "grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4" }, [
                              (openBlock(true), createBlock(Fragment, null, renderList(currentImages.value, (image, index) => {
                                return openBlock(), createBlock("div", {
                                  key: index,
                                  class: "aspect-video overflow-hidden rounded-lg ring-1 ring-border"
                                }, [
                                  createVNode("img", {
                                    src: `/storage/${image}`,
                                    alt: "Current",
                          ...
                          createVNode("label", { class: "flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border px-6 py-8 transition-colors hover:border-primary" }, [
                            ...
                            createVNode("span", { class: "text-sm font-medium text-foreground" }, toDisplayString(currentImages.value.length > 0 ? "Resimleri Değiştir" : "Resim Yükle"), 1),
                      ...
                      createVNode("div", { class: "flex items-center justify-end gap-3" }, [
                        ...
                        }, toDisplayString(unref(form).processing ? "Güncelleniyor..." : "Güncelle"), 9, ["disabled"])
                      ])
                    ], 32)
                  ];
                }
            ...
            _push2(ssrRenderComponent(ImageCropper, {
              ...
              "image-src": cropperImageSrc.value,
              "aspect-ratio": 16 / 9,
              onCrop: handleCrop,
            ...
            return [
              createVNode(_sfc_main$2, { width: "content" }, {
                default: withCtx(() => [
                  createVNode(_sfc_main$3, {
                    title: "Çalışma Alanını Düzenle",
                    description: "Çalışma alanınızı ve ürünlerinizi güncelleyin"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Workspace/EditWorkspace.vue");
