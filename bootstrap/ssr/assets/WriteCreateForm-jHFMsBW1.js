import { ref, watch, unref, withCtx, createVNode, withDirectives, createBlock, createCommentVNode, vModelSelect, openBlock, toDisplayString, Fragment, renderList, vModelCheckbox, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              submitText: "Yazıyı Kaydet",
              loading: unref(form).processing,
              onSubmit: createWrite
            }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$3), {
                    ...
                    type: "datetime-local",
                    error: errors.value.published_at || unref(form).errors.published_at
                  }, null, _parent3, _scopeId2));
