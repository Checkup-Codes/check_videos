      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="w-full sm:w-auto"${_scopeId}><h2 class="text-primary truncate text-xl font-bold sm:text-2xl"${_scopeId}>Yeni Ders Ekle</h2></div></div><div class="card card-compact dark:bg-base-100 mt-5 w-full border border-gray-200 bg-white shadow-md shadow-sm transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-6"${_scopeId}><form class="p-4"${_scopeId}><div class="form-control mb-4 w-full"${_scopeId}><label for="title" class="label"${_scopeId}><span class="label-text font-medium"${_scopeId}>Ders Başlığı</span></label><input${ssrRenderAttr("value", unref(form).title)} type="text" id="title" placeholder="Ders başlığını girin" class="${ssrRenderClass([{ "input-error": unref(form).errors.title }, "input input-bordered w-full"])}"${_scopeId}>`);
            ...
            _push2(`</div><div class="form-control mb-4 w-full"${_scopeId}><label for="slug" class="label"${_scopeId}><span class="label-text font-medium"${_scopeId}>Slug</span></label><div class="flex items-center gap-2"${_scopeId}><input${ssrRenderAttr("value", unref(form).slug)} type="text" id="slug" placeholder="Slug girin (slug-format)" class="${ssrRenderClass([{ "input-error": unref(form).errors.slug }, "input input-bordered w-full"])}"${_scopeId}><button type="button" class="btn btn-square btn-outline shrink-0"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"${_scopeId}></path></svg></button></div>`);
            ...
            _push2(` Kaydet </button></div></form></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "mb-5" }, [
                ...
                createVNode("div", { class: "card card-compact dark:bg-base-100 mt-5 w-full border border-gray-200 bg-white shadow-md shadow-sm transition-all duration-200 dark:border-gray-700" }, [
