        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(test).questions, (question, index) => {
              _push2(`<div${ssrRenderAttr("id", `question-${question.id}`)} class="scroll-mt-24 space-y-4 rounded-lg border border-border bg-card p-6"${_scopeId}><div${_scopeId}><div${_scopeId}><div class="mb-2 flex flex-wrap items-center gap-2"${_scopeId}><span class="rounded-md bg-primary px-2 py-1 text-sm font-semibold text-primary-foreground"${_scopeId}> Soru ${ssrInterpolate(index + 1)}</span><span class="text-sm text-muted-foreground"${_scopeId}>(${ssrInterpolate(question.points)} puan)</span>`);
              if (isQuestionAnswered(question.id)) {
                _push2(`<button type="button" class="ml-auto inline-flex h-8 items-center justify-center rounded-md border border-border bg-background px-3 text-xs font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"${_scopeId}> Seçimi temizle </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><p class="whitespace-pre-wrap text-lg font-medium text-foreground"${_scopeId}>${ssrInterpolate(question.question_text)}</p></div></div><div class="space-y-2"${_scopeId}>`);
              if (question.question_type === "single_choice" || question.question_type === "multiple_choice" && hasOnlyOneCorrectAnswer(question)) {
                ...
                ssrRenderList(question.options, (option, optIndex) => {
                  _push2(`<label${ssrRenderAttr("for", `question-${question.id}-option-${option.id}`)} class="${ssrRenderClass([{
                    "border-primary bg-primary/10 ring-2 ring-primary/20 dark:bg-primary/20": answers.value[question.id] === option.id,
                    "border-border bg-background hover:border-primary/50 hover:bg-accent": answers.value[question.id] !== option.id
                  }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-option-${option.id}`)} type="radio"${ssrRenderAttr("name", `question-${question.id}`)}${ssrRenderAttr("value", option.id)}${ssrIncludeBooleanAttr(ssrLooseEqual(answers.value[question.id], option.id)) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:border-primary dark:checked:bg-primary"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([answers.value[question.id] === option.id ? "text-primary" : "text-muted-foreground", "font-semibold transition-colors"])}"${_scopeId}>${ssrInterpolate(String.fromCharCode(65 + optIndex))}. </span><span class="${ssrRenderClass([answers.value[question.id] === option.id ? "font-medium text-foreground" : "text-foreground", "whitespace-pre-wrap transition-colors"])}"${_scopeId}>${ssrInterpolate(option.option_text)}</span></div></div></label>`);
                });
                _push2(`<!--]-->`);
                ...
                ssrRenderList(question.options, (option, optIndex) => {
                  ...
                  }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-option-${option.id}`)} type="checkbox"${ssrRenderAttr("value", option.id)}${ssrIncludeBooleanAttr(Array.isArray(answers.value[question.id]) ? ssrLooseContain(answers.value[question.id], option.id) : answers.value[question.id]) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer rounded border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:border-primary dark:checked:bg-primary"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><span class="${ssrRenderClass([isOptionSelected(question.id, option.id) ? "text-primary" : "text-muted-foreground", "font-semibold transition-colors"])}"${_scopeId}>${ssrInterpolate(String.fromCharCode(65 + optIndex))}. </span><span class="${ssrRenderClass([
                ...
                _push2(`<!--[--><label${ssrRenderAttr("for", `question-${question.id}-true`)} class="${ssrRenderClass([{
                  "border-primary bg-primary/10 ring-2 ring-primary/20 dark:bg-primary/20": answers.value[question.id] === true,
                  "border-border bg-background hover:border-primary/50 hover:bg-accent": answers.value[question.id] !== true
                }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-true`)} type="radio"${ssrRenderAttr("name", `question-${question.id}`)}${ssrRenderAttr("value", true)}${ssrIncludeBooleanAttr(ssrLooseEqual(answers.value[question.id], true)) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:border-primary dark:checked:bg-primary"${_scopeId}><div class="flex-1"${_scopeId}><span class="${ssrRenderClass([answers.value[question.id] === true ? "text-primary" : "text-foreground", "whitespace-pre-wrap font-medium transition-colors"])}"${_scopeId}> Doğru </span></div></label><label${ssrRenderAttr("for", `question-${question.id}-false`)} class="${ssrRenderClass([{
                  "border-primary bg-primary/10 ring-2 ring-primary/20 dark:bg-primary/20": answers.value[question.id] === false,
                  "border-border bg-background hover:border-primary/50 hover:bg-accent": answers.value[question.id] !== false
                }, "flex cursor-pointer items-start gap-3 rounded-lg border-2 p-4 transition-all duration-200"])}"${_scopeId}><input${ssrRenderAttr("id", `question-${question.id}-false`)} type="radio"${ssrRenderAttr("name", `question-${question.id}`)}${ssrRenderAttr("value", false)}${ssrIncludeBooleanAttr(ssrLooseEqual(answers.value[question.id], false)) ? " checked" : ""} class="mt-1 h-5 w-5 cursor-pointer border-2 border-muted-foreground/30 text-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:border-muted-foreground/50 dark:bg-background dark:checked:border-primary dark:checked:bg-primary"${_scopeId}><div class="flex-1"${_scopeId}><span class="${ssrRenderClass([answers.value[question.id] === false ? "text-primary" : "text-foreground", "whitespace-pre-wrap font-medium transition-colors"])}"${_scopeId}> Yanlış </span></div></label><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
                      ...
                      createVNode("div", null, [
                        createVNode("div", null, [
                          createVNode("div", { class: "mb-2 flex flex-wrap items-center gap-2" }, [
                            ...
                            isQuestionAnswered(question.id) ? (openBlock(), createBlock("button", {
                              key: 0,
                              type: "button",
                            ...
                            }, " Seçimi temizle ", 8, ["onClick"])) : createCommentVNode("", true)
                          ]),
