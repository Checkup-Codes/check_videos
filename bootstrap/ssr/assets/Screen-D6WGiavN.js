      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Kaydediliyor..." : "Müşteriyi Kaydet")}</button></div></div></div></form></div>`);
          } else {
            return [
              createVNode("div", { class: "mx-auto max-w-4xl" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("h1", { class: "text-xl font-semibold text-foreground" }, "Yeni Müşteri"),
                  createVNode("p", { class: "mt-1 text-xs text-muted-foreground" }, "Yeni müşteri bilgilerini girin")
                ]),
                createVNode("form", {
                    ...
                    createVNode("div", { class: "space-y-4" }, [
                      createVNode("div", { class: "grid grid-cols-1 gap-4 md:grid-cols-2" }, [
                        ...
                        createVNode("div", {
                          ...
                          createVNode("label", { class: "mb-1.5 block text-xs font-medium text-foreground" }, "Soy Adı"),
                          withDirectives(createVNode("input", {
