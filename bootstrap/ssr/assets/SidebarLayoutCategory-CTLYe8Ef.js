import { computed, inject, ref, watch, onMounted, nextTick, onActivated, onDeactivated, onBeforeUnmount, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext } from "vue";
...
import CategoryTree from "./CategoryTree-BNzlPWkF.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ isNarrow: isNarrow.value }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border/50 bg-background/95 p-2.5 backdrop-blur-sm" data-v-ad189bf8${_scopeId}><div class="flex items-center justify-between gap-2" data-v-ad189bf8${_scopeId}><div class="flex items-center gap-1 rounded-lg bg-muted/50 p-0.5" data-v-ad189bf8${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-ad189bf8${_scopeId2}>Liste</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-ad189bf8${_scopeId2}>Kategori</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(`</div><div class="flex items-center gap-1" data-v-ad189bf8${_scopeId}><button class="${ssrRenderClass([
              areAllCategoriesExpanded.value ? "bg-accent text-accent-foreground shadow-sm" : "text-muted-foreground hover:bg-accent/50 hover:text-foreground",
              "inline-flex h-7 items-center gap-1.5 rounded-lg px-2.5 text-xs font-medium transition-all duration-200"
            ])}"${ssrRenderAttr("title", areAllCategoriesExpanded.value ? "Tümünü Daralt" : "Tümünü Genişlet")} data-v-ad189bf8${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              class: ["h-3.5 w-3.5 transition-transform duration-200", { "rotate-180": areAllCategoriesExpanded.value }]
            }, null, _parent2, _scopeId));
            _push2(`<span class="text-xs" data-v-ad189bf8${_scopeId}>${ssrInterpolate(areAllCategoriesExpanded.value ? "Daralt" : "Genişlet")}</span></button></div></div></div>`);
...
const SidebarLayoutCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ad189bf8"]]);
export {
