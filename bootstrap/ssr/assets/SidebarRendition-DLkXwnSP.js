          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$4, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="w-full overflow-y-auto" data-v-e964031c${_scopeId2}><div class="min-h-full" data-v-e964031c${_scopeId2}><ul class="menu w-full rounded-box bg-base-100" data-v-e964031c${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(languagePacks), (languagePack) => {
                    _push3(`<li class="mb-1" data-v-e964031c${_scopeId2}><div class="flex w-full items-center" data-v-e964031c${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="text-base" data-v-e964031c${_scopeId3}>${ssrInterpolate(languagePack.name)}</span><span class="text-base-content/70 ml-2 text-xs uppercase" data-v-e964031c${_scopeId3}>${ssrInterpolate(languagePack.language)}</span>`);
                        } else {
                          return [
                    ...
                    _push3(`<div class="badge badge-outline badge-sm" data-v-e964031c${_scopeId2}>${ssrInterpolate(languagePack.word_count || 0)}</div></div></li>`);
                  });
                  _push3(`<!--]--></ul></div></div>`);
                } else {
                  return [
...
const SidebarRendition = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e964031c"]]);
export {
