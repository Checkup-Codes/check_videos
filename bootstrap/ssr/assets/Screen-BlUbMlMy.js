        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (props.word) {
              ...
              _push2(`<button type="submit" class="btn btn-primary tooltip tooltip-top shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95" data-tip="Shift + Enter ile kaydet"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
              if (processing.value) {
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "flex justify-end gap-3" }, [
                      ...
                      createVNode("button", {
                        ...
                        onKeydown: withKeys(withModifiers(submitForm, ["shift", "prevent"]), ["enter"]),
