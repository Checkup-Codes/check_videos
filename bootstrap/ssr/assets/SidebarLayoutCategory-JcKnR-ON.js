import { inject, computed, ref, watch, onMounted, mergeProps, withCtx, unref, createBlock, createCommentVNode, openBlock, KeepAlive, createVNode, useSSRContext } from "vue";
...
import CategoryTree from "./CategoryTree-DErSMb25.js";
import PerformanceMonitorButton from "./PerformanceMonitorButton-DlwfT3Bl.js";
                  ...
                  return [
                    (openBlock(), createBlock(KeepAlive, null, [
                      showCategories.value ? (openBlock(), createBlock(CategoryTree, {
                        ...
                        getLinkClasses,
                        expandAll: areAllCategoriesExpanded.value
                      }, null, 8, ["expandAll"])) : createCommentVNode("", true)
                    ], 1024))
                  ];
                }
              }),
...
const SidebarLayoutCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db3a6d31"]]);
export {
