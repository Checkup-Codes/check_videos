    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        sidebar: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isSidebarCollapsed.value && isMounted.value && shouldShowSidebarOnMobile.value && screenName.value === "versions") {
            ...
            return [
              isSidebarCollapsed.value && isMounted.value && shouldShowSidebarOnMobile.value && screenName.value === "versions" ? (openBlock(), createBlock(KeepAlive, {
                key: 0,
                max: 5,
