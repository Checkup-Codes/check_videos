        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(category).description) {
              _push2(`<p class="text-muted-foreground"${_scopeId}>${ssrInterpolate(unref(stripHtml)(unref(category).description))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if (test.description) {
                        _push3(`<p class="mt-2 text-sm text-muted-foreground line-clamp-2"${_scopeId2}>${ssrInterpolate(unref(stripHtml)(test.description))}</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      ...
                      return [
                        ...
                        }, toDisplayString(unref(stripHtml)(test.description)), 1)) : createCommentVNode("", true),
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-4xl space-y-6 p-6" }, [
                createVNode("div", { class: "space-y-4" }, [
                  ...
                  }, toDisplayString(unref(stripHtml)(unref(category).description)), 1)) : createCommentVNode("", true)
                ]),
