...
import JourneyTimeline from "./JourneyTimeline-fifSasav.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const entryCount = computed(() => {
      return Object.values(entriesByYear.value).reduce((total, entries) => total + ((entries == null ? void 0 : entries.length) || 0), 0);
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(SubSidebarHeader, {
              title: "Yolculuk",
              description: String(entryCount.value)
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$3, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(JourneyTimeline, { entriesByYear: entriesByYear.value }, null, _parent4, _scopeId3));
                      } else {
                        return [
...
const SidebarLayoutJourney = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aeb4a9cd"]]);
export {
