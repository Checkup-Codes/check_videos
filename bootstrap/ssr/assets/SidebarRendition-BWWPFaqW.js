          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$4, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="w-full overflow-y-auto" data-v-1b75b89b${_scopeId2}><div class="min-h-full" data-v-1b75b89b${_scopeId2}><ul class="menu bg-base-100 rounded-box w-full" data-v-1b75b89b${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(languagePacks), (languagePack) => {
                    _push3(`<li class="mb-1" data-v-1b75b89b${_scopeId2}><div class="flex w-full items-center" data-v-1b75b89b${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="text-base" data-v-1b75b89b${_scopeId3}>${ssrInterpolate(languagePack.name)}</span><span class="text-base-content/70 ml-2 text-xs uppercase" data-v-1b75b89b${_scopeId3}>${ssrInterpolate(languagePack.language)}</span>`);
                        } else {
                          return [
                    ...
                    _push3(`<div class="badge badge-sm badge-outline" data-v-1b75b89b${_scopeId2}>${ssrInterpolate(languagePack.word_count || 0)}</div></div></li>`);
                  });
                  _push3(`<!--]--></ul></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "w-full overflow-y-auto" }, [
                      createVNode("div", { class: "min-h-full" }, [
                        createVNode("ul", { class: "menu bg-base-100 rounded-box w-full" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(languagePacks), (languagePack) => {
                            return openBlock(), createBlock("li", {
                              ...
                              createVNode("div", { class: "flex w-full items-center" }, [
                                ...
                                createVNode("div", { class: "badge badge-sm badge-outline" }, toDisplayString(languagePack.word_count || 0), 1)
                              ])
                            ]);
                          }), 128))
                        ])
...
const SidebarRendition = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1b75b89b"]]);
export {
