...
import { _ as _sfc_main$2, b as _sfc_main$3, a as _sfc_main$4 } from "./TextInput-D6xpWjYM.js";
import { P as PrimaryButton } from "./PrimaryButton-D3PdNJOi.js";
import { _ as _sfc_main$5 } from "./SecondaryButton-BnTdryPo.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200"${_scopeId}>Sosyal Medya Yönetimi</h2>`);
          } else {
            return [
              createVNode("h2", { class: "text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200" }, "Sosyal Medya Yönetimi")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(availablePlatforms, (icon, platform) => {
              _push2(`<option${ssrRenderAttr("value", platform)}${_scopeId}>${ssrInterpolate(platform)}</option>`);
            });
            _push2(`<!--]--></select>`);
