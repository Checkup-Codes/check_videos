...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-1 p-2" }, _attrs))} data-v-85bb6d61><!--[-->`);
      ssrRenderList(filteredParentCategories.value, (category) => {
        _push(`<div class="space-y-1" data-v-85bb6d61><div class="${ssrRenderClass([
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex items-center justify-between gap-2" data-v-85bb6d61${_scopeId}><div class="flex min-w-0 flex-1 items-center gap-2" data-v-85bb6d61${_scopeId}>`);
              if (category.status === "hidden") {
                _push2(`<span class="flex h-4 w-4 shrink-0 items-center justify-center rounded bg-yellow-500/10 text-yellow-600 dark:text-yellow-400" title="Gizli kategori" data-v-85bb6d61${_scopeId}>`);
              ...
              if (hasLinkOnlyWrites(category)) {
                _push2(`<span class="flex h-4 w-4 shrink-0 items-center justify-center rounded bg-primary/10 text-primary" title="Sadece link yazıları" data-v-85bb6d61${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$2, { class: "h-2.5 w-2.5" }, null, _parent2, _scopeId));
                _push2(`</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<h4 class="truncate"${ssrRenderAttr("title", category.name)} data-v-85bb6d61${_scopeId}>${ssrInterpolate(category.name)}</h4></div><div class="flex shrink-0 items-center gap-1.5" data-v-85bb6d61${_scopeId}>`);
              if (category.children.length) {
                _push2(`<button class="inline-flex h-5 w-5 items-center justify-center rounded text-xs transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1" data-v-85bb6d61${_scopeId}>`);
              ...
              _push2(`<div class="inline-flex items-center rounded-full border border-border bg-secondary px-2 py-0.5 text-xs font-semibold text-secondary-foreground" data-v-85bb6d61${_scopeId}>${ssrInterpolate(getTotalWriteCount(category))}</div></div></div>`);
            } else {
              return [
        ...
        if (category.children.length) {
          _push(`<div class="ml-4 space-y-0.5" style="${ssrRenderStyle(!isCollapsed(category.id) ? null : { display: "none" })}" data-v-85bb6d61><!--[-->`);
          ssrRenderList(category.children, (child) => {
            _push(`<div data-v-85bb6d61><div class="${ssrRenderClass([
              "rounded-md transition-colors",
            ...
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="flex items-center justify-between gap-2" data-v-85bb6d61${_scopeId}><div class="flex min-w-0 flex-1 items-center gap-1.5" data-v-85bb6d61${_scopeId}>`);
                  ...
                  _push2(`<span class="truncate"${ssrRenderAttr("title", child.name)} data-v-85bb6d61${_scopeId}>${ssrInterpolate(child.name)}</span></div><div class="flex shrink-0 items-center gap-1" data-v-85bb6d61${_scopeId}>`);
                  ...
                  _push2(`<div class="inline-flex items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-[10px] font-semibold text-secondary-foreground" data-v-85bb6d61${_scopeId}>${ssrInterpolate(getTotalWriteCount(child))}</div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center justify-between gap-2" }, [
            ...
            if (child.children.length) {
              _push(`<div class="ml-4 space-y-0.5" style="${ssrRenderStyle(!isCollapsed(child.id) ? null : { display: "none" })}" data-v-85bb6d61><!--[-->`);
              ssrRenderList(child.children, (subChild) => {
                ...
                _push(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      _push2(`<div class="flex items-center justify-between gap-1.5" data-v-85bb6d61${_scopeId}><div class="flex min-w-0 flex-1 items-center gap-1.5" data-v-85bb6d61${_scopeId}>`);
                      if (subChild.status === "hidden" || subChild.parent_hidden) {
                        _push2(`<span class="flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded bg-yellow-500/10 text-yellow-600 dark:text-yellow-400" title="Gizli kategori" data-v-85bb6d61${_scopeId}>`);
                        _push2(ssrRenderComponent(_sfc_main$1, { class: "h-2 w-2" }, null, _parent2, _scopeId));
                        _push2(`</span>`);
                      } else {
                        _push2(`<!---->`);
                      }
                      _push2(`<span class="truncate"${ssrRenderAttr("title", subChild.name)} data-v-85bb6d61${_scopeId}>${ssrInterpolate(subChild.name)}</span></div><div class="inline-flex shrink-0 items-center rounded-full border border-border bg-secondary px-1.5 py-0.5 text-[10px] font-semibold text-secondary-foreground" data-v-85bb6d61${_scopeId}>${ssrInterpolate(getTotalWriteCount(subChild))}</div></div>`);
                    } else {
                      return [
      ...
      if (filteredParentCategories.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center text-muted-foreground opacity-50" data-v-85bb6d61><div data-v-85bb6d61>Henüz kategori bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const CategoryTree = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-85bb6d61"]]);
export {
