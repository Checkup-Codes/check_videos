...
import { _ as _sfc_main$2 } from "./CheckLayout-Da2ai0yI.js";
import SidebarLayoutWrite from "./SidebarLayoutWrite-CDENwiET.js";
import SidebarLayoutCategory from "./SidebarLayoutCategory-DBb_Q2D9.js";
import { _ as _sfc_main$1 } from "./FlashMessage-C3JOGPFR.js";
import { u as useSidebar } from "./useSidebar-D-dtiIC8.js";
import { useStore } from "vuex";
import "./WriteList-CfuyWny4.js";
...
import "./CategoryTree-BnEcjvLU.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoggedIn.value && !shouldHideSidebarContent.value && !isIndexPage.value) {
        _push(`<div class="fixed bottom-6 right-6 z-50 hidden lg:block lg:bottom-8 lg:right-8">`);
        if (showSidebarHint.value) {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        isCollapsed: shouldRenderSidebar.value,
        ...
        sidebar: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (shouldShowSidebarOnMobile.value && shouldRenderSidebar.value && isMounted.value) {
            ...
            return [
              shouldShowSidebarOnMobile.value && shouldRenderSidebar.value && isMounted.value ? (openBlock(), createBlock(KeepAlive, {
                key: 0,
                max: 5,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([shouldShowMainContentOnMobile.value ? "block" : "hidden lg:block", "h-full min-h-0 overflow-hidden", mainContentClass.value])}"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "screen", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", {
                class: [shouldShowMainContentOnMobile.value ? "block" : "hidden lg:block", "h-full min-h-0 overflow-hidden", mainContentClass.value]
              }, [
