...
import SidebarLayoutVersion from "./SidebarLayoutVersion-m4mfHEzq.js";
import { usePage, Head } from "@inertiajs/vue3";
import "./CheckSubsidebar-DfwdLh-u.js";
import "./VersionList-oGIZm7k9.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, { isCollapsed: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              isSidebarCollapsed.value && unref(screenName) === "versions" ? (openBlock(), createBlock(SidebarLayoutVersion, {
                key: 0,
                "onUpdate:isCollapsed": handleSidebarCollapse,
                class: sidebarStyle.value
