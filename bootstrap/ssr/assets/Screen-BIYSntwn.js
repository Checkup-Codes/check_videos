      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-5 w-full"${_scopeId}><div class="card card-compact dark:bg-base-100 w-full border border-gray-200 bg-white shadow-md shadow-sm transition-all duration-200 dark:border-gray-700"${_scopeId}><div class="card-body p-4"${_scopeId}>`);
            if (__props.projects.length === 0) {
              ...
              _push2(`<div class="overflow-x-auto"${_scopeId}><table class="table-zebra table"${_scopeId}><thead${_scopeId}><tr${_scopeId}><th class="text-left"${_scopeId}>#</th><th class="text-left"${_scopeId}>İsim</th><th class="text-center"${_scopeId}>Durum</th><th class="text-center"${_scopeId}>Müşteri</th><th class="text-center"${_scopeId}>Oluşturma Tarihi</th><th class="text-center"${_scopeId}>İşlemler</th></tr></thead><tbody${_scopeId}><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-5 w-full" }, [
                createVNode("div", { class: "card card-compact dark:bg-base-100 w-full border border-gray-200 bg-white shadow-md shadow-sm transition-all duration-200 dark:border-gray-700" }, [
