        ...
        screen: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (filteredEntries.value.length > 0) {
              _push2(`<div class="${ssrRenderClass([{ "xl:-translate-x-[80px]": showYearFilter.value && isYearFilterOpen.value }, "relative transition-all duration-300"])}"${_scopeId}><div class="absolute bottom-0 left-2 top-0 w-px bg-border sm:left-3"${_scopeId}></div><div class="space-y-4"${_scopeId}><!--[-->`);
              ssrRenderList(filteredEntries.value, (entry, index) => {
                ...
                _push2(`<div class="${ssrRenderClass([{ "bg-primary": index === 0 }, "relative h-2 w-2 rounded-full border border-primary bg-background"])}"${_scopeId}></div></div>`);
              ...
              _push2(`<!--]--></div><div class="relative mt-4 pl-8 sm:pl-10"${_scopeId}><div class="absolute left-0 top-0 flex h-4 w-4 items-center justify-center sm:left-1"${_scopeId}><div class="h-1.5 w-1.5 rounded-full bg-border"${_scopeId}></div></div><p class="text-xs text-muted-foreground"${_scopeId}>Yolculuğun başlangıcı</p></div></div>`);
            } else {
              ...
              createVNode("div", { class: "min-h-screen bg-background" }, [
                createVNode("div", { class: "mx-auto max-w-4xl px-4 py-6 sm:px-6" }, [
                  ...
                  filteredEntries.value.length > 0 ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "absolute bottom-0 left-2 top-0 w-px bg-border sm:left-3" }),
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(filteredEntries.value, (entry, index) => {
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "absolute left-0 top-3 flex h-4 w-4 items-center justify-center sm:left-1" }, [
                            ...
                            createVNode("div", {
                              class: ["relative h-2 w-2 rounded-full border border-primary bg-background", { "bg-primary": index === 0 }]
                            }, null, 2)
                          ]),
                    ...
                    createVNode("div", { class: "relative mt-4 pl-8 sm:pl-10" }, [
                      createVNode("div", { class: "absolute left-0 top-0 flex h-4 w-4 items-center justify-center sm:left-1" }, [
