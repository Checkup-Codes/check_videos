import { defineComponent, computed, ref, onMounted, unref, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Tenantları Yönet → `);
                } else {
                  return [
                    createTextVNode(" Tenantları Yönet → ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</div></div></div><div class="grid grid-cols-1 gap-6 lg:grid-cols-3"${_scopeId}><div class="rounded-lg border bg-card text-card-foreground shadow-sm lg:col-span-2"${_scopeId}><div class="border-b px-6 py-4"${_scopeId}><h3 class="text-lg font-semibold"${_scopeId}>Son Yazılarınız</h3></div><div class="divide-y"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5" }, [
                    ...
                    createVNode("div", { class: "rounded-lg border bg-card text-card-foreground shadow-sm" }, [
                      createVNode("div", { class: "p-6" }, [
                        createVNode("div", { class: "flex items-center justify-between space-x-4" }, [
                          createVNode("div", { class: "space-y-1" }, [
                            createVNode("p", { class: "text-sm font-medium text-muted-foreground" }, "Tenant Yönetimi"),
                            createVNode("p", { class: "text-2xl font-bold" }, "🏢")
                          ]),
                          createVNode("div", { class: "flex h-12 w-12 items-center justify-center rounded-full bg-primary/10" }, [
                            (openBlock(), createBlock("svg", {
                              class: "h-6 w-6 text-primary",
