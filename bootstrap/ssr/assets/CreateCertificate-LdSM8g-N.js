          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="p-6 pt-12 sm:p-8 sm:pt-16"${_scopeId2}><div class="mx-auto max-w-3xl"${_scopeId2}><h1 class="mb-8 text-2xl font-bold text-foreground"${_scopeId2}>Yeni Sertifika</h1><form class="space-y-6"${_scopeId2}><div${_scopeId2}><label class="mb-2 block text-sm font-medium text-foreground"${_scopeId2}>Başlık <span class="text-destructive"${_scopeId2}>*</span></label><input${ssrRenderAttr("value", unref(form).title)} type="text" required class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring" placeholder="Sertifika adı"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "p-6 pt-12 sm:p-8 sm:pt-16" }, [
                      createVNode("div", { class: "mx-auto max-w-3xl" }, [
                        createVNode("h1", { class: "mb-8 text-2xl font-bold text-foreground" }, "Yeni Sertifika"),
                        createVNode("form", {
