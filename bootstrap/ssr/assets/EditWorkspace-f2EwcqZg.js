import { computed, ref, onMounted, unref, withCtx, createBlock, createTextVNode, openBlock, createVNode, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, withDirectives, vModelRadio, vModelText, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const browserTitle = computed(() => {
      ...
      return ((_c = (_b = (_a = page.props) == null ? void 0 : _a.screen) == null ? void 0 : _b.seo) == null ? void 0 : _c.title) || ((_f = (_e = (_d = page.props) == null ? void 0 : _d.app) == null ? void 0 : _e.seo) == null ? void 0 : _f.title) || "Çalışma Alanı Düzenle";
    });
    const props = __props;
    const form = useForm({
      images: [],
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: `/workspace/${__props.workspace.id}`,
            ...
            _push2(`<h1 class="text-3xl font-bold tracking-tight text-foreground"${_scopeId}>Çalışma Alanını Düzenle</h1><p class="mt-2 text-muted-foreground"${_scopeId}>Çalışma alanınızı ve ürünlerinizi güncelleyin.</p></div><form class="space-y-6"${_scopeId}>`);
            if (__props.workspace.images && __props.workspace.images.length > 0 && imagePreviews.value.length === 0) {
              _push2(`<div${_scopeId}><label class="mb-2 block text-sm font-medium text-foreground"${_scopeId}>Mevcut Resimler</label><div class="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4"${_scopeId}><!--[-->`);
              ssrRenderList(__props.workspace.images, (image, index) => {
                _push2(`<div class="relative group"${_scopeId}><img${ssrRenderAttr("src", `/storage/${image}`)} alt="Current" class="h-32 w-full rounded-lg border border-border object-cover"${_scopeId}></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div${_scopeId}><label for="images" class="mb-2 block text-sm font-medium text-foreground"${_scopeId}>${ssrInterpolate(__props.workspace.images && __props.workspace.images.length > 0 ? "Resimleri Değiştir" : "Resimler Ekle")}</label><div class="relative"${_scopeId}><input id="images" type="file" accept="image/*" multiple class="w-full cursor-pointer rounded-lg border border-input bg-background px-4 py-2.5 text-foreground file:mr-4 file:rounded-md file:border-0 file:bg-primary file:px-4 file:py-1 file:text-sm file:font-medium file:text-primary-foreground hover:file:bg-primary/90"${_scopeId}></div>`);
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-4xl py-8" }, [
                createVNode("div", { class: "mb-8" }, [
                  ...
                  createVNode("h1", { class: "text-3xl font-bold tracking-tight text-foreground" }, "Çalışma Alanını Düzenle"),
                  createVNode("p", { class: "mt-2 text-muted-foreground" }, "Çalışma alanınızı ve ürünlerinizi güncelleyin.")
                ]),
                createVNode("form", {
                  onSubmit: withModifiers(submit, ["prevent"]),
                  class: "space-y-6"
                }, [
                  __props.workspace.images && __props.workspace.images.length > 0 && imagePreviews.value.length === 0 ? (openBlock(), createBlock("div", { key: 0 }, [
                    createVNode("label", { class: "mb-2 block text-sm font-medium text-foreground" }, "Mevcut Resimler"),
                    createVNode("div", { class: "grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4" }, [
                  ...
                  createVNode("div", null, [
                    ...
                    }, toDisplayString(__props.workspace.images && __props.workspace.images.length > 0 ? "Resimleri Değiştir" : "Resimler Ekle"), 1),
