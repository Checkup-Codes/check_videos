import { computed, withCtx, unref, openBlock, createBlock, createVNode, createTextVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mb-5 w-full"${_scopeId}><div class="card-compact card w-full border border-border bg-card shadow-sm transition-all duration-200"${_scopeId}><div class="card-body"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-5 w-full" }, [
                createVNode("div", { class: "card-compact card w-full border border-border bg-card shadow-sm transition-all duration-200" }, [
