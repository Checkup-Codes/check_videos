...
import SidebarLayoutWrite from "./SidebarLayoutWrite-CXMxx1aj.js";
import SidebarLayoutCategory from "./SidebarLayoutCategory-CedLfezR.js";
...
import "./CategoryTree-Ch9CShgM.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        sidebar: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(shouldShowSidebarOnMobile) && shouldRenderSidebar.value && isMounted.value) {
            ...
            return [
              unref(shouldShowSidebarOnMobile) && shouldRenderSidebar.value && isMounted.value ? (openBlock(), createBlock(KeepAlive, {
                key: 0,
                max: 5,
