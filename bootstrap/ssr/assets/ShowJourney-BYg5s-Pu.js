        ...
        screen: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.entry.image) {
              _push2(`<div class="aspect-video overflow-hidden"${_scopeId}><img${ssrRenderAttr("src", `/storage/${__props.entry.image}`)}${ssrRenderAttr("alt", __props.entry.title)} class="h-full w-full object-cover"${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="p-6 sm:p-8"${_scopeId}><div class="mb-4 flex flex-wrap items-center gap-3"${_scopeId}><span class="inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId}></path></svg> ${ssrInterpolate(formatDate(__props.entry.entry_date))}</span>`);
            ...
            _push2(`</div><h1 class="mb-6 text-3xl font-bold tracking-tight text-foreground sm:text-4xl"${_scopeId}>${ssrInterpolate(__props.entry.title)}</h1>`);
            if (__props.entry.description) {
              _push2(`<div class="prose prose-neutral max-w-none dark:prose-invert"${_scopeId}><p class="whitespace-pre-wrap text-lg leading-relaxed text-muted-foreground"${_scopeId}>${ssrInterpolate(__props.entry.description)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></article><div class="mt-8 flex items-center justify-between"${_scopeId}>`);
            if (prevEntry.value) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-muted-foreground transition-transform group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"${_scopeId2}></path></svg><div class="text-left"${_scopeId2}><div class="text-xs text-muted-foreground"${_scopeId2}>Önceki</div><div class="text-sm font-medium text-foreground"${_scopeId2}>${ssrInterpolate(prevEntry.value.title)}</div></div>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
            ...
            if (nextEntry.value) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="text-right"${_scopeId2}><div class="text-xs text-muted-foreground"${_scopeId2}>Sonraki</div><div class="text-sm font-medium text-foreground"${_scopeId2}>${ssrInterpolate(nextEntry.value.title)}</div></div><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-muted-foreground transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"${_scopeId2}></path></svg>`);
                  } else {
                    return [
