...
import { _ as _sfc_main$3 } from "./TopSubsidebar-CDC7ECSa.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$4, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="w-full overflow-y-auto" data-v-d4b4b289${_scopeId2}><div class="min-h-full space-y-1 p-3" data-v-d4b4b289${_scopeId2}><!--[-->`);
                  ssrRenderList(languagePacks.value, (languagePack) => {
                    ...
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex-1" data-v-d4b4b289${_scopeId3}><div class="text-sm font-medium text-base-content" data-v-d4b4b289${_scopeId3}>${ssrInterpolate(languagePack.name)}</div><div class="text-base-content/60 text-xs uppercase" data-v-d4b4b289${_scopeId3}>${ssrInterpolate(languagePack.language)}</div></div><div class="badge badge-sm" data-v-d4b4b289${_scopeId3}>${ssrInterpolate(languagePack.word_count || 0)}</div>`);
                        } else {
                          return [
...
const SidebarRendition = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4b4b289"]]);
export {
