import { ref, computed, onMounted, nextTick, onUnmounted, watch, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            }, "space-y-6 p-3 pt-6 transition-all duration-300 max-w-full sm:p-6 sm:pt-12 lg:max-w-[800px] lg:pt-16"])}"${_scopeId}><div class="space-y-4"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><h1 class="text-3xl font-bold text-foreground"${_scopeId}>${ssrInterpolate(unref(test).title)}</h1><div class="flex gap-2"${_scopeId}>`);
            ...
            if (unref(test).questions && unref(test).questions.length > 0) {
              ...
              _push2(`</div><div class="${ssrRenderClass([{ "blur-sm select-none pointer-events-none": !showQuestions.value }, "space-y-6 max-w-full lg:max-w-[800px]"])}"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", {
                ...
                unref(test).questions && unref(test).questions.length > 0 ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", {
                    class: ["space-y-6 max-w-full lg:max-w-[800px]", { "blur-sm select-none pointer-events-none": !showQuestions.value }]
                  }, [
