import { ref, computed, onMounted, onUnmounted, withCtx, unref, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, createTextVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderStyle } from "vue/server-renderer";
import { Link } from "@inertiajs/vue3";
import _sfc_main$1 from "./LayoutJourney-D_n4XhLc.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        screen: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-background"${_scopeId}><div class="mx-auto max-w-4xl px-4 py-6 sm:px-6"${_scopeId}><h1 class="xl:-translate-x-[80px] mb-6 text-2xl font-semibold text-foreground"${_scopeId}>Yolculuk</h1>`);
            if (groupedByYear.value.length > 0) {
              _push2(`<div class="${ssrRenderClass([{ "xl:-translate-x-[80px]": showYearFilter.value && isYearFilterOpen.value }, "relative transition-all duration-300"])}"${_scopeId}><div class="space-y-8"${_scopeId}><!--[-->`);
              ssrRenderList(groupedByYear.value, (yearGroup, yearIndex) => {
                _push2(`<div class="relative"${_scopeId}><div class="relative mb-6 flex items-center"${_scopeId}><div class="h-px flex-1 bg-gradient-to-r from-transparent to-border"${_scopeId}></div><div class="mx-4 flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 backdrop-blur-sm"${_scopeId}><svg class="h-3.5 w-3.5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId}></path></svg><span class="text-sm font-semibold text-primary"${_scopeId}>${ssrInterpolate(yearGroup.year)}</span><span class="text-xs text-muted-foreground"${_scopeId}>${ssrInterpolate(yearGroup.entries.length)} kayıt</span></div><div class="h-px flex-1 bg-gradient-to-l from-transparent to-border"${_scopeId}></div></div><div class="relative"${_scopeId}><div class="absolute bottom-0 left-2 top-0 w-px border-l-2 border-dashed border-border/60 sm:left-3"${_scopeId}></div><div class="space-y-4"${_scopeId}><!--[-->`);
                ssrRenderList(yearGroup.entries, (entry, entryIndex) => {
                  _push2(`<div class="timeline-entry relative pl-8 sm:pl-10"${_scopeId}><div class="absolute left-0 top-3 flex h-4 w-4 items-center justify-center sm:left-1"${_scopeId}>`);
                  if (yearIndex === 0 && entryIndex === 0) {
                    _push2(`<div class="absolute h-4 w-4 animate-ping rounded-full bg-primary/20"${_scopeId}></div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<div class="${ssrRenderClass([{ "bg-primary scale-110": yearIndex === 0 && entryIndex === 0 }, "relative h-2.5 w-2.5 rounded-full border-2 border-primary bg-background transition-all"])}"${_scopeId}></div></div>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<div class="${ssrRenderClass(entry.image ? "flex flex-col sm:flex-row" : "")}"${_scopeId2}>`);
                        if (entry.image) {
                          _push3(`<div class="relative w-full flex-shrink-0 sm:w-64 md:w-72"${_scopeId2}><div class="aspect-video w-full overflow-hidden rounded-t-lg sm:rounded-l-lg sm:rounded-tr-none"${_scopeId2}><img${ssrRenderAttr("src", `/storage/${entry.image}`)}${ssrRenderAttr("alt", entry.title)} class="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"${_scopeId2}></div>`);
                          if (entry.status === "draft") {
                            _push3(`<span class="absolute top-2 right-2 rounded-md bg-yellow-500/90 px-1.5 py-0.5 text-xs font-medium text-yellow-900"${_scopeId2}> Taslak </span>`);
                          } else {
                            _push3(`<!---->`);
                          }
                          _push3(`</div>`);
                        ...
                        _push3(`<div class="${ssrRenderClass(entry.image ? "flex min-w-0 flex-1 flex-col p-4" : "p-4")}"${_scopeId2}><div class="flex items-center gap-2 text-xs text-muted-foreground"${_scopeId2}><svg class="h-3 w-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"${_scopeId2}></path></svg><span${_scopeId2}>${ssrInterpolate(formatDate(entry.entry_date))}</span>`);
                        if (entry.status === "draft") {
                          _push3(`<span class="rounded-md bg-yellow-500/20 px-1.5 py-0.5 text-xs font-medium text-yellow-600 dark:text-yellow-400"${_scopeId2}> Taslak </span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div><h3 class="mt-2 line-clamp-2 text-sm font-semibold text-foreground transition-colors group-hover:text-primary sm:text-base"${_scopeId2}>${ssrInterpolate(entry.title)}</h3>`);
                        if (entry.description) {
                          _push3(`<p class="mt-2 line-clamp-2 text-xs text-muted-foreground sm:text-sm"${_scopeId2}>${ssrInterpolate(entry.description)}</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`<div class="mt-3 flex items-center gap-1 text-xs text-muted-foreground transition-colors group-hover:text-primary"${_scopeId2}><span${_scopeId2}>Devamını oku</span><svg class="h-3 w-3 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"${_scopeId2}></path></svg></div></div></div>`);
                      } else {
                        return [
                          createVNode("div", {
                            class: entry.image ? "flex flex-col sm:flex-row" : ""
                          }, [
                            entry.image ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "relative w-full flex-shrink-0 sm:w-64 md:w-72"
                            }, [
                              createVNode("div", { class: "aspect-video w-full overflow-hidden rounded-t-lg sm:rounded-l-lg sm:rounded-tr-none" }, [
                                createVNode("img", {
                              ...
                              entry.status === "draft" ? (openBlock(), createBlock("span", {
                                key: 0,
                                class: "absolute top-2 right-2 rounded-md bg-yellow-500/90 px-1.5 py-0.5 text-xs font-medium text-yellow-900"
                              }, " Taslak ")) : createCommentVNode("", true)
                            ])) : createCommentVNode("", true),
                            createVNode("div", {
                              class: entry.image ? "flex min-w-0 flex-1 flex-col p-4" : "p-4"
                            }, [
                              createVNode("div", { class: "flex items-center gap-2 text-xs text-muted-foreground" }, [
                                ...
                                entry.status === "draft" ? (openBlock(), createBlock("span", {
                                  key: 0,
                                  class: "rounded-md bg-yellow-500/20 px-1.5 py-0.5 text-xs font-medium text-yellow-600 dark:text-yellow-400"
                                }, " Taslak ")) : createCommentVNode("", true)
                              ]),
                              createVNode("h3", { class: "mt-2 line-clamp-2 text-sm font-semibold text-foreground transition-colors group-hover:text-primary sm:text-base" }, toDisplayString(entry.title), 1),
                              entry.description ? (openBlock(), createBlock("p", {
                                key: 0,
                                class: "mt-2 line-clamp-2 text-xs text-muted-foreground sm:text-sm"
              ...
              _push2(`<!--]--></div><div class="relative mt-8 flex items-center justify-center"${_scopeId}><div class="flex items-center gap-2 rounded-full border border-border/50 bg-muted/30 px-4 py-2 backdrop-blur-sm"${_scopeId}><div class="h-1.5 w-1.5 rounded-full bg-border"${_scopeId}></div><p class="text-xs text-muted-foreground"${_scopeId}>Yolculuğun başlangıcı</p></div></div></div>`);
            } else {
              _push2(`<div class="py-12 text-center"${_scopeId}><div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-muted/50"${_scopeId}><svg class="h-6 w-6 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"${_scopeId}></path></svg></div><p class="text-sm text-muted-foreground"${_scopeId}>${ssrInterpolate(selectedYear.value ? `${selectedYear.value} yılında kayıt bulunamadı` : "Henüz kayıt yok")}</p></div>`);
            }
            _push2(`</div>`);
            if (__props.entries.length > 0) {
              _push2(`<div class="border-t border-border bg-muted/20"${_scopeId}><div class="mx-auto max-w-4xl px-4 py-4 sm:px-6"${_scopeId}><div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-1.5 text-xs text-muted-foreground"${_scopeId}><div class="flex items-center gap-1.5"${_scopeId}><div class="h-1.5 w-1.5 rounded-full bg-primary"${_scopeId}></div><span${_scopeId}><span class="font-medium text-foreground"${_scopeId}>${ssrInterpolate(__props.entries.length)}</span> kayıt</span></div><div class="flex items-center gap-1.5"${_scopeId}><div class="h-1.5 w-1.5 rounded-full bg-primary/60"${_scopeId}></div><span${_scopeId}><span class="font-medium text-foreground"${_scopeId}>${ssrInterpolate(years.value.length)}</span> yıl</span></div><div class="flex items-center gap-1.5"${_scopeId}><div class="h-1.5 w-1.5 rounded-full bg-primary/30"${_scopeId}></div><span${_scopeId}>${ssrInterpolate(oldestYear.value)} - ${ssrInterpolate(newestYear.value)}</span></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "min-h-screen bg-background" }, [
                createVNode("div", { class: "mx-auto max-w-4xl px-4 py-6 sm:px-6" }, [
                  createVNode("h1", { class: "xl:-translate-x-[80px] mb-6 text-2xl font-semibold text-foreground" }, "Yolculuk"),
                  groupedByYear.value.length > 0 ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: ["relative transition-all duration-300", { "xl:-translate-x-[80px]": showYearFilter.value && isYearFilterOpen.value }]
                  }, [
                    createVNode("div", { class: "space-y-8" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(groupedByYear.value, (yearGroup, yearIndex) => {
                        return openBlock(), createBlock("div", {
                          key: yearGroup.year,
                          class: "relative"
                        }, [
                          createVNode("div", { class: "relative mb-6 flex items-center" }, [
                            createVNode("div", { class: "h-px flex-1 bg-gradient-to-r from-transparent to-border" }),
                            createVNode("div", { class: "mx-4 flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 backdrop-blur-sm" }, [
                              (openBlock(), createBlock("svg", {
                              ...
                              createVNode("span", { class: "text-sm font-semibold text-primary" }, toDisplayString(yearGroup.year), 1),
                              createVNode("span", { class: "text-xs text-muted-foreground" }, toDisplayString(yearGroup.entries.length) + " kayıt", 1)
                            ]),
                            createVNode("div", { class: "h-px flex-1 bg-gradient-to-l from-transparent to-border" })
                          ]),
                          createVNode("div", { class: "relative" }, [
                            createVNode("div", { class: "absolute bottom-0 left-2 top-0 w-px border-l-2 border-dashed border-border/60 sm:left-3" }),
                            createVNode("div", { class: "space-y-4" }, [
                              (openBlock(true), createBlock(Fragment, null, renderList(yearGroup.entries, (entry, entryIndex) => {
                                return openBlock(), createBlock("div", {
                                  key: entry.id,
                                  class: "timeline-entry relative pl-8 sm:pl-10"
                                }, [
                                  createVNode("div", { class: "absolute left-0 top-3 flex h-4 w-4 items-center justify-center sm:left-1" }, [
                                    yearIndex === 0 && entryIndex === 0 ? (openBlock(), createBlock("div", {
                                      key: 0,
                                      class: "absolute h-4 w-4 animate-ping rounded-full bg-primary/20"
                                    })) : createCommentVNode("", true),
                                    createVNode("div", {
                                      class: ["relative h-2.5 w-2.5 rounded-full border-2 border-primary bg-background transition-all", { "bg-primary scale-110": yearIndex === 0 && entryIndex === 0 }]
                                    }, null, 2)
                                  ]),
                    ...
                    createVNode("div", { class: "relative mt-8 flex items-center justify-center" }, [
                      createVNode("div", { class: "flex items-center gap-2 rounded-full border border-border/50 bg-muted/30 px-4 py-2 backdrop-blur-sm" }, [
                        createVNode("div", { class: "h-1.5 w-1.5 rounded-full bg-border" }),
                    ...
                    createVNode("div", { class: "mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-muted/50" }, [
                      (openBlock(), createBlock("svg", {
                    ...
                    createVNode("p", { class: "text-sm text-muted-foreground" }, toDisplayString(selectedYear.value ? `${selectedYear.value} yılında kayıt bulunamadı` : "Henüz kayıt yok"), 1)
                  ]))
                ]),
                __props.entries.length > 0 ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "mx-auto max-w-4xl px-4 py-4 sm:px-6" }, [
                    createVNode("div", { class: "flex flex-wrap items-center justify-center gap-x-6 gap-y-1.5 text-xs text-muted-foreground" }, [
                      createVNode("div", { class: "flex items-center gap-1.5" }, [
                        createVNode("div", { class: "h-1.5 w-1.5 rounded-full bg-primary" }),
                        createVNode("span", null, [
                          createVNode("span", { class: "font-medium text-foreground" }, toDisplayString(__props.entries.length), 1),
                          createTextVNode(" kayıt")
                        ])
                      ]),
                      createVNode("div", { class: "flex items-center gap-1.5" }, [
                        createVNode("div", { class: "h-1.5 w-1.5 rounded-full bg-primary/60" }),
                        createVNode("span", null, [
                          createVNode("span", { class: "font-medium text-foreground" }, toDisplayString(years.value.length), 1),
                          createTextVNode(" yıl")
                        ])
                      ]),
                      createVNode("div", { class: "flex items-center gap-1.5" }, [
                        createVNode("div", { class: "h-1.5 w-1.5 rounded-full bg-primary/30" }),
                        createVNode("span", null, toDisplayString(oldestYear.value) + " - " + toDisplayString(newestYear.value), 1)
                      ])
                    ])
                  ])
                ])) : createCommentVNode("", true)
