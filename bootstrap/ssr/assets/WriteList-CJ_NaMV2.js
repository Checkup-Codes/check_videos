  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: scrollContainer,
        class: "h-[calc(100vh-10rem)] overflow-y-auto overscroll-contain lg:h-[calc(100vh-5rem)]"
      }, _attrs))} data-v-8768c963><div class="min-h-full" data-v-8768c963><!--[-->`);
      ssrRenderList(__props.writes, (write) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="font-semibold" data-v-8768c963${_scopeId}>${ssrInterpolate(write.title)}</div><div class="flex items-center justify-between text-xs text-gray-500" data-v-8768c963${_scopeId}><span data-v-8768c963${_scopeId}>${ssrInterpolate(formatDate(write.created_at))}</span><span data-v-8768c963${_scopeId}>${ssrInterpolate(write.views_count)} görüntülenme</span></div>`);
            } else {
              return [
...
const WriteList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8768c963"]]);
export {
