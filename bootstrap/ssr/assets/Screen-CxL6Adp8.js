        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (queryParams.value.game === "multiple-choice") {
              ...
              _push2(`<div${_scopeId}><div class="p-6"${_scopeId}><div class="mb-6 flex items-center justify-between"${_scopeId}><div${_scopeId}><h2 class="text-xl font-bold text-gray-800"${_scopeId}>Kelime Listesi</h2><p class="text-sm text-gray-600"${_scopeId}>Toplam Kelime Sayısı: ${ssrInterpolate(__props.words.length)}</p></div><div class="flex gap-2"${_scopeId}>`);
              if (isLoggedIn.value) {
              ...
              ssrRenderList(filteredWords.value, (word) => {
                ...
                if (isLoggedIn.value) {
                  _push2(`<td class="border-b px-4 py-3"${_scopeId}><div class="flex space-x-2"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("rendition.words.edit", word.id))} class="rounded bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-700 hover:bg-yellow-200"${_scopeId}> ✎ </a><button class="rounded bg-red-100 px-2 py-1 text-xs font-medium text-red-700 hover:bg-red-200"${_scopeId}> 🗑️ </button></div></td>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</tr>`);
            ...
            return [
              ...
              }, null, 8, ["gameType", "packSlug"])) : queryParams.value.game === "fill-in-the-blank" ? (openBlock(), createBlock(_sfc_main$4, {
                key: 1,
                gameType: queryParams.value.game,
                packSlug: ((_d = props.pack) == null ? void 0 : _d.slug) || getPackSlugFromUrl()
              }, null, 8, ["gameType", "packSlug"])) : (openBlock(), createBlock("div", { key: 2 }, [
