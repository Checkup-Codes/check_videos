    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(form).questions, (question, questionIndex) => {
        ...
        if (question.question_type === "single_choice") {
          ...
          }, "flex cursor-pointer items-center gap-2 rounded-lg border-2 p-4 transition-all"])}"><input type="radio"${ssrRenderAttr("name", `question-${questionIndex}-tf`)}${ssrRenderAttr("value", true)}${ssrIncludeBooleanAttr(ssrLooseEqual(question.correct_answer, true)) ? " checked" : ""} class="h-4 w-4 cursor-pointer text-primary focus:ring-primary"><span class="font-medium">Doğru</span></label><label class="${ssrRenderClass([{
          ...
          }, "flex cursor-pointer items-center gap-2 rounded-lg border-2 p-4 transition-all"])}"><input type="radio"${ssrRenderAttr("name", `question-${questionIndex}-tf`)}${ssrRenderAttr("value", false)}${ssrIncludeBooleanAttr(ssrLooseEqual(question.correct_answer, false)) ? " checked" : ""} class="h-4 w-4 cursor-pointer text-primary focus:ring-primary"><span class="font-medium">Yanlış</span></label></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
