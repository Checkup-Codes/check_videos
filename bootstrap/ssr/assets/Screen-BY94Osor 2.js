...
import { _ as _sfc_main$1 } from "./CheckScreen-Db5h7eRm.js";
const _sfc_main = {
  __name: "Screen",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6 pt-12 sm:p-8 sm:pt-16"${_scopeId}><div class="mb-8"${_scopeId}><h1 class="text-2xl font-semibold text-base-content sm:text-3xl"${_scopeId}>Kelime Sözlüğü</h1><p class="text-base-content/70 mt-2 text-sm"${_scopeId}>Kelime arayın, anlamlarını öğrenin</p></div><div class="mb-8"${_scopeId}><div class="flex gap-3"${_scopeId}><div class="flex-1"${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Kelime arayın..." class="input-bordered input w-full"${_scopeId}></div><button${ssrIncludeBooleanAttr(isSearching.value || !searchQuery.value.trim()) ? " disabled" : ""} class="${ssrRenderClass([[
              isSearching.value || !searchQuery.value.trim() ? "btn-disabled" : "bg-base-content text-base-100 hover:bg-base-300 hover:text-base-content"
            ], "btn"])}"${ssrRenderAttr("title", isSearching.value ? "Arama yapılıyor..." : "Kelime ara")}${_scopeId}>`);
            ...
            if (searchResult.value) {
              _push2(`<div${_scopeId}><div class="rounded-lg bg-base-100 p-6"${_scopeId}><div class="mb-6 flex items-start justify-between"${_scopeId}><div class="flex-1"${_scopeId}><div class="mb-3 flex items-center gap-3"${_scopeId}><h2 class="text-2xl font-semibold text-base-content"${_scopeId}>${ssrInterpolate(searchResult.value.word)}</h2><div class="flex gap-2"${_scopeId}><span class="badge badge-sm bg-base-content text-base-100"${_scopeId}>${ssrInterpolate(getWordTypeLabel(searchResult.value.type))}</span><span class="badge badge-sm bg-base-300 text-base-content"${_scopeId}>${ssrInterpolate(getLanguageLabel(searchResult.value.language))}</span></div></div><p class="text-base-content/70 text-lg"${_scopeId}>${ssrInterpolate(searchResult.value.meaning)}</p></div>`);
              if (isLoggedIn.value) {
              ...
              if (searchResult.value.meanings && searchResult.value.meanings.length > 1) {
                ...
                ssrRenderList(searchResult.value.meanings, (meaning, index) => {
                  _push2(`<div class="${ssrRenderClass([meaning.is_primary ? "bg-base-content text-base-100" : "bg-base-200", "flex items-start gap-3 rounded-lg p-3"])}"${_scopeId}>`);
                  if (meaning.is_primary) {
                    _push2(`<span class="${ssrRenderClass([meaning.is_primary ? "bg-base-100 text-base-content" : "badge-outline", "badge badge-sm"])}"${_scopeId}> Ana </span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<span class="${ssrRenderClass([meaning.is_primary ? "text-base-100" : "text-base-content", "text-sm"])}"${_scopeId}>${ssrInterpolate(meaning.meaning)}</span></div>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3"${_scopeId}><div class="rounded-lg bg-base-200 p-4"${_scopeId}><div class="text-base-content/70 text-sm"${_scopeId}>Öğrenme Durumu</div><div class="text-lg font-semibold text-base-content"${_scopeId}>${ssrInterpolate(getLearningStatusLabel(searchResult.value.learning_status))}</div></div><div class="rounded-lg bg-base-200 p-4"${_scopeId}><div class="text-base-content/70 text-sm"${_scopeId}>Tekrar Sayısı</div><div class="text-lg font-semibold text-base-content"${_scopeId}>${ssrInterpolate(searchResult.value.review_count || 0)}</div></div><div class="rounded-lg bg-base-200 p-4"${_scopeId}><div class="text-base-content/70 text-sm"${_scopeId}>Yanlış Sayısı</div><div class="text-lg font-semibold text-base-content"${_scopeId}>${ssrInterpolate(searchResult.value.incorrect_count || 0)}</div></div></div>`);
              if (searchResult.value.language_packs && searchResult.value.language_packs.length > 0) {
                ...
                ssrRenderList(searchResult.value.language_packs, (pack) => {
                  _push2(`<span class="badge badge-sm bg-base-200 text-base-content"${_scopeId}>${ssrInterpolate(pack.name)}</span>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              if (searchResult.value.example_sentences && searchResult.value.example_sentences.length > 0) {
                ...
                ssrRenderList(searchResult.value.example_sentences, (sentence, index) => {
                  _push2(`<div class="rounded-lg bg-base-200 p-4"${_scopeId}><div class="mb-1 font-medium text-base-content"${_scopeId}>${ssrInterpolate(sentence.sentence)}</div>`);
                  if (sentence.translation) {
                    _push2(`<div class="text-base-content/70 text-sm"${_scopeId}>${ssrInterpolate(sentence.translation)}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
              ...
              if (searchResult.value.synonyms && searchResult.value.synonyms.length > 0) {
                ...
                ssrRenderList(searchResult.value.synonyms, (synonym) => {
                  _push2(`<span class="badge badge-sm bg-base-300 text-base-content"${_scopeId}>${ssrInterpolate(synonym.synonym)}</span>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
            ...
            return [
              createVNode("div", { class: "p-6 pt-12 sm:p-8 sm:pt-16" }, [
                createVNode("div", { class: "mb-8" }, [
                  ...
                  createVNode("p", { class: "text-base-content/70 mt-2 text-sm" }, "Kelime arayın, anlamlarını öğrenin")
                ]),
                createVNode("div", { class: "mb-8" }, [
                ...
                searchResult.value ? (openBlock(), createBlock("div", { key: 0 }, [
                  createVNode("div", { class: "rounded-lg bg-base-100 p-6" }, [
                      ...
                      createVNode("div", { class: "flex-1" }, [
                        createVNode("div", { class: "mb-3 flex items-center gap-3" }, [
                          ...
                          createVNode("div", { class: "flex gap-2" }, [
                            createVNode("span", { class: "badge badge-sm bg-base-content text-base-100" }, toDisplayString(getWordTypeLabel(searchResult.value.type)), 1),
                            createVNode("span", { class: "badge badge-sm bg-base-300 text-base-content" }, toDisplayString(getLanguageLabel(searchResult.value.language)), 1)
                          ])
                        ]),
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(searchResult.value.meanings, (meaning, index) => {
                          return openBlock(), createBlock("div", {
                            key: index,
                            class: ["flex items-start gap-3 rounded-lg p-3", meaning.is_primary ? "bg-base-content text-base-100" : "bg-base-200"]
                          }, [
                            meaning.is_primary ? (openBlock(), createBlock("span", {
                              key: 0,
                              class: ["badge badge-sm", meaning.is_primary ? "bg-base-100 text-base-content" : "badge-outline"]
                    ...
                    createVNode("div", { class: "mb-6 grid grid-cols-1 gap-4 md:grid-cols-3" }, [
                      createVNode("div", { class: "rounded-lg bg-base-200 p-4" }, [
                        createVNode("div", { class: "text-base-content/70 text-sm" }, "Öğrenme Durumu"),
                      ...
                      createVNode("div", { class: "rounded-lg bg-base-200 p-4" }, [
                        createVNode("div", { class: "text-base-content/70 text-sm" }, "Tekrar Sayısı"),
                        createVNode("div", { class: "text-lg font-semibold text-base-content" }, toDisplayString(searchResult.value.review_count || 0), 1)
                      ]),
                      createVNode("div", { class: "rounded-lg bg-base-200 p-4" }, [
                        createVNode("div", { class: "text-base-content/70 text-sm" }, "Yanlış Sayısı"),
                  ...
                  createVNode("p", { class: "text-base-content/70 text-sm" }, ' "' + toDisplayString(searchQuery.value) + '" kelimesi sözlüğümüzde bulunamadı. Farklı bir kelime deneyin. ', 1)
                ])) : createCommentVNode("", true),
                isLoggedIn.value ? (openBlock(), createBlock("div", {
                  key: 2,
