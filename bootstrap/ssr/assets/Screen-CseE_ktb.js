...
import TranslateWord from "./TranslateWord-ClnHAT5G.js";
import WordCompletion from "./WordCompletion-CZHGeOki.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="px-5 transition-all duration-200 dark:border-gray-700 dark:bg-base-100" data-v-e05c0828${_scopeId}><div class="mb-4 flex items-center justify-between" data-v-e05c0828${_scopeId}><div class="flex-1" data-v-e05c0828${_scopeId}><h1 class="p-5 text-2xl font-bold" data-v-e05c0828${_scopeId}>${ssrInterpolate(((_a = props.pack) == null ? void 0 : _a.name) || "Kelimeler")} <span class="badge badge-outline ml-2" data-v-e05c0828${_scopeId}>${ssrInterpolate(((_b = props.words) == null ? void 0 : _b.length) || 0)} kelime</span></h1></div><div class="flex gap-2" data-v-e05c0828${_scopeId}>`);
            ...
            if (!showGameInterface.value) {
              _push2(`<div class="mb-4 flex flex-wrap gap-3" data-v-e05c0828${_scopeId}><div class="form-control min-w-[200px] flex-1" data-v-e05c0828${_scopeId}><div class="input-group" data-v-e05c0828${_scopeId}><input type="text"${ssrRenderAttr("value", searchQuery.value)} placeholder="Kelime ara..." class="input-bordered input input-sm w-52" data-v-e05c0828${_scopeId}><button class="btn btn-sm btn-square mx-5" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-e05c0828${_scopeId}></path></svg></button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showGameInterface.value) {
              _push2(`<div class="my-20" data-v-e05c0828${_scopeId}>`);
              if (loadingGame.value) {
                _push2(`<div class="flex h-60 items-center justify-center" data-v-e05c0828${_scopeId}><span class="loading loading-spinner loading-lg" data-v-e05c0828${_scopeId}></span></div>`);
              ...
              _push2(`<div data-v-e05c0828${_scopeId}><div class="mb-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm" data-v-e05c0828${_scopeId}><div class="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-3" data-v-e05c0828${_scopeId}><button class="group relative flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-blue-500 hover:shadow-md"${ssrIncludeBooleanAttr(!hasEnoughWords) ? " disabled" : ""} data-v-e05c0828${_scopeId}><div class="flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 text-blue-500 transition-all group-hover:bg-blue-100" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-v-e05c0828${_scopeId}></path></svg></div><div class="text-left" data-v-e05c0828${_scopeId}><h3 class="font-medium text-gray-900" data-v-e05c0828${_scopeId}>Çoktan Seçmeli</h3><p class="text-sm text-gray-500" data-v-e05c0828${_scopeId}>Doğru cevabı seçin</p></div></button><button class="group relative flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-green-500 hover:shadow-md"${ssrIncludeBooleanAttr(!hasEnoughWords) ? " disabled" : ""} data-v-e05c0828${_scopeId}><div class="flex h-12 w-12 items-center justify-center rounded-full bg-green-50 text-green-500 transition-all group-hover:bg-green-100" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-e05c0828${_scopeId}></path></svg></div><div class="text-left" data-v-e05c0828${_scopeId}><h3 class="font-medium text-gray-900" data-v-e05c0828${_scopeId}>Boşluk Doldurma</h3><p class="text-sm text-gray-500" data-v-e05c0828${_scopeId}>Eksik kelimeyi yazın</p></div></button><button class="group relative flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-purple-500 hover:shadow-md"${ssrIncludeBooleanAttr(!hasEnoughWords) ? " disabled" : ""} data-v-e05c0828${_scopeId}><div class="flex h-12 w-12 items-center justify-center rounded-full bg-purple-50 text-purple-500 transition-all group-hover:bg-purple-100" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" data-v-e05c0828${_scopeId}></path></svg></div><div class="text-left" data-v-e05c0828${_scopeId}><h3 class="font-medium text-gray-900" data-v-e05c0828${_scopeId}>Kelime Tamamlama</h3><p class="text-sm text-gray-500" data-v-e05c0828${_scopeId}>Eksik harfleri tamamlayın</p></div></button></div>`);
              if (isLoggedIn.value) {
                _push2(`<div class="collapse" data-v-e05c0828${_scopeId}><input type="checkbox" class="peer" data-v-e05c0828${_scopeId}><div class="collapse-title text-sm font-medium text-gray-700" data-v-e05c0828${_scopeId}> Oyun Ayarları ve Filtreler <span class="ml-2 text-xs text-gray-500" data-v-e05c0828${_scopeId}>(Varsayılan: Rastgele)</span></div><div class="collapse-content" data-v-e05c0828${_scopeId}><div class="space-y-4" data-v-e05c0828${_scopeId}><div class="flex justify-end" data-v-e05c0828${_scopeId}><button class="btn btn-ghost btn-sm" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" data-v-e05c0828${_scopeId}></path></svg> Ayarları Sıfırla </button></div><div class="form-control" data-v-e05c0828${_scopeId}><label class="label" data-v-e05c0828${_scopeId}><span class="label-text font-medium" data-v-e05c0828${_scopeId}>Kelime Türü</span></label><div class="flex flex-wrap gap-2" data-v-e05c0828${_scopeId}><!--[-->`);
                ssrRenderList(wordCounts.value.types, (count, type) => {
                  ...
                  }, "btn btn-sm"])}" data-v-e05c0828${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(gameConfig.value.wordType, type)) ? " checked" : ""}${ssrRenderAttr("value", type)} class="hidden"${ssrIncludeBooleanAttr(!hasEnoughWords(count)) ? " disabled" : ""} data-v-e05c0828${_scopeId}> ${ssrInterpolate(getWordTypeLabel(type))} (${ssrInterpolate(count)}) </label>`);
                });
                _push2(`<!--]--></div></div><div class="form-control" data-v-e05c0828${_scopeId}><label class="label" data-v-e05c0828${_scopeId}><span class="label-text font-medium" data-v-e05c0828${_scopeId}>Öğrenme Durumu</span></label><div class="flex flex-wrap gap-2" data-v-e05c0828${_scopeId}><!--[-->`);
                ssrRenderList(wordCounts.value.status, (count, status) => {
                  _push2(`<label class="${ssrRenderClass([{
                    "btn-primary": gameConfig.value.learningStatus === status.toString(),
                    "cursor-not-allowed opacity-50": !hasEnoughWords(count)
                  }, "btn btn-sm"])}" data-v-e05c0828${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(gameConfig.value.learningStatus, status.toString())) ? " checked" : ""}${ssrRenderAttr("value", status.toString())} class="hidden"${ssrIncludeBooleanAttr(!hasEnoughWords(count)) ? " disabled" : ""} data-v-e05c0828${_scopeId}> ${ssrInterpolate(getLearningStatusLabel(status))} (${ssrInterpolate(count)}) </label>`);
                });
                _push2(`<!--]--></div></div><div class="form-control" data-v-e05c0828${_scopeId}><label class="label" data-v-e05c0828${_scopeId}><span class="label-text font-medium" data-v-e05c0828${_scopeId}>Zorluk Seviyesi</span></label><div class="flex flex-wrap gap-2" data-v-e05c0828${_scopeId}><!--[-->`);
                ssrRenderList(wordCounts.value.difficulty, (count, level) => {
                  _push2(`<label class="${ssrRenderClass([{
                    "btn-primary": gameConfig.value.difficultyLevel === level,
                    "cursor-not-allowed opacity-50": !hasEnoughWords(count)
                  }, "btn btn-sm"])}" data-v-e05c0828${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(gameConfig.value.difficultyLevel, level)) ? " checked" : ""}${ssrRenderAttr("value", level)} class="hidden"${ssrIncludeBooleanAttr(!hasEnoughWords(count)) ? " disabled" : ""} data-v-e05c0828${_scopeId}> ${ssrInterpolate(getDifficultyLabel(level))} (${ssrInterpolate(count)}) </label>`);
                });
                _push2(`<!--]--></div></div><div class="divider text-xs text-gray-500" data-v-e05c0828${_scopeId}>Öncelik Filtreleri</div><div class="grid grid-cols-2 gap-2" data-v-e05c0828${_scopeId}><label class="flex cursor-pointer items-center justify-between rounded-lg border p-3 hover:bg-gray-50" data-v-e05c0828${_scopeId}><span class="text-sm" data-v-e05c0828${_scopeId}>Son Öğrenilenler</span><input type="checkbox" class="toggle toggle-sm"${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.prioritizeRecentlyLearned) ? ssrLooseContain(gameConfig.value.prioritizeRecentlyLearned, null) : gameConfig.value.prioritizeRecentlyLearned) ? " checked" : ""} data-v-e05c0828${_scopeId}></label><label class="flex cursor-pointer items-center justify-between rounded-lg border p-3 hover:bg-gray-50" data-v-e05c0828${_scopeId}><span class="text-sm" data-v-e05c0828${_scopeId}>İşaretlenenler</span><input type="checkbox" class="toggle toggle-sm"${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.prioritizeFlagged) ? ssrLooseContain(gameConfig.value.prioritizeFlagged, null) : gameConfig.value.prioritizeFlagged) ? " checked" : ""} data-v-e05c0828${_scopeId}></label><label class="flex cursor-pointer items-center justify-between rounded-lg border p-3 hover:bg-gray-50" data-v-e05c0828${_scopeId}><span class="text-sm" data-v-e05c0828${_scopeId}>En Çok Yanlış Yapılanlar</span><input type="checkbox" class="toggle toggle-sm"${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.prioritizeMostIncorrect) ? ssrLooseContain(gameConfig.value.prioritizeMostIncorrect, null) : gameConfig.value.prioritizeMostIncorrect) ? " checked" : ""} data-v-e05c0828${_scopeId}></label><label class="flex cursor-pointer items-center justify-between rounded-lg border p-3 hover:bg-gray-50" data-v-e05c0828${_scopeId}><span class="text-sm" data-v-e05c0828${_scopeId}>En Eski Güncellenenler</span><input type="checkbox" class="toggle toggle-sm"${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.prioritizeOldestUpdated) ? ssrLooseContain(gameConfig.value.prioritizeOldestUpdated, null) : gameConfig.value.prioritizeOldestUpdated) ? " checked" : ""} data-v-e05c0828${_scopeId}></label><label class="flex cursor-pointer items-center justify-between rounded-lg border p-3 hover:bg-gray-50" data-v-e05c0828${_scopeId}><span class="text-sm" data-v-e05c0828${_scopeId}>Soru Sayısı</span><select class="select-bordered select select-sm w-24" data-v-e05c0828${_scopeId}><option value="5" data-v-e05c0828${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "5") : ssrLooseEqual(gameConfig.value.questionCount, "5")) ? " selected" : ""}${_scopeId}>5</option><option value="10" data-v-e05c0828${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "10") : ssrLooseEqual(gameConfig.value.questionCount, "10")) ? " selected" : ""}${_scopeId}>10</option><option value="15" data-v-e05c0828${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "15") : ssrLooseEqual(gameConfig.value.questionCount, "15")) ? " selected" : ""}${_scopeId}>15</option><option value="20" data-v-e05c0828${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "20") : ssrLooseEqual(gameConfig.value.questionCount, "20")) ? " selected" : ""}${_scopeId}>20</option><option value="25" data-v-e05c0828${ssrIncludeBooleanAttr(Array.isArray(gameConfig.value.questionCount) ? ssrLooseContain(gameConfig.value.questionCount, "25") : ssrLooseEqual(gameConfig.value.questionCount, "25")) ? " selected" : ""}${_scopeId}>25</option></select></label></div></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="overflow-x-auto" data-v-e05c0828${_scopeId}><table class="table table-zebra" data-v-e05c0828${_scopeId}><thead data-v-e05c0828${_scopeId}><tr data-v-e05c0828${_scopeId}><th data-v-e05c0828${_scopeId}>Kelime</th><th data-v-e05c0828${_scopeId}>Anlam</th><th data-v-e05c0828${_scopeId}><div class="flex items-center gap-2" data-v-e05c0828${_scopeId}> Tür <button class="${ssrRenderClass([{
                "text-primary": sortState.value.type !== "none",
                "opacity-50": sortState.value.type === "none"
              }, "btn btn-ghost btn-xs"])}" data-v-e05c0828${_scopeId}>`);
              if (sortState.value.type === "none") {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" data-v-e05c0828${_scopeId}></path></svg>`);
              } else if (sortState.value.type === "asc") {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-e05c0828${_scopeId}></path></svg>`);
              } else {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-e05c0828${_scopeId}></path></svg>`);
              }
              _push2(`</button></div></th><th data-v-e05c0828${_scopeId}>Durum</th><th data-v-e05c0828${_scopeId}><div class="flex items-center gap-2" data-v-e05c0828${_scopeId}> Başarı <button class="${ssrRenderClass([{
              ...
              if (isLoggedIn.value) {
                _push2(`<th data-v-e05c0828${_scopeId}></th>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</tr></thead><tbody data-v-e05c0828${_scopeId}>`);
              if (isLoading.value) {
                _push2(`<tr data-v-e05c0828${_scopeId}><td colspan="6" class="text-center" data-v-e05c0828${_scopeId}><span class="loading loading-spinner loading-md" data-v-e05c0828${_scopeId}></span></td></tr>`);
              } else if (displayedWords.value.length === 0) {
                _push2(`<tr data-v-e05c0828${_scopeId}><td colspan="6" class="text-center" data-v-e05c0828${_scopeId}>Sonuç bulunamadı</td></tr>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(displayedWords.value, (word) => {
                _push2(`<tr data-v-e05c0828${_scopeId}><td class="font-medium" data-v-e05c0828${_scopeId}>${ssrInterpolate(word.word)}</td><td data-v-e05c0828${_scopeId}>${ssrInterpolate(getPrimaryMeaning(word))}</td><td data-v-e05c0828${_scopeId}><div class="badge" data-v-e05c0828${_scopeId}>${ssrInterpolate(word.type)}</div></td><td data-v-e05c0828${_scopeId}><div class="${ssrRenderClass([getLearningStatusBadgeClass(word.learning_status), "badge badge-sm"])}" data-v-e05c0828${_scopeId}>${ssrInterpolate(getLearningStatusLabel(word.learning_status))}</div></td><td data-v-e05c0828${_scopeId}><div class="${ssrRenderClass([getSuccessRateBadgeClass(calculateSuccessRate(word).rate), "badge badge-sm"])}" data-v-e05c0828${_scopeId}>${ssrInterpolate(calculateSuccessRate(word).label)}</div></td>`);
                if (isLoggedIn.value) {
                  _push2(`<td data-v-e05c0828${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Link), {
              ...
              if (sortedWords.value.length > perPage.value) {
                _push2(`<div class="mt-4 flex justify-between" data-v-e05c0828${_scopeId}><div data-v-e05c0828${_scopeId}><span class="text-sm opacity-70" data-v-e05c0828${_scopeId}>${ssrInterpolate(paginationInfo.value)}</span></div><div class="join" data-v-e05c0828${_scopeId}><button class="btn btn-sm join-item"${ssrIncludeBooleanAttr(currentPage.value <= 1) ? " disabled" : ""} data-v-e05c0828${_scopeId}> « </button><button class="btn btn-sm join-item" data-v-e05c0828${_scopeId}>${ssrInterpolate(currentPage.value)}</button><button class="btn btn-sm join-item"${ssrIncludeBooleanAttr(currentPage.value >= totalPages.value) ? " disabled" : ""} data-v-e05c0828${_scopeId}> » </button></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (((_f = props.words) == null ? void 0 : _f.length) === 0) {
                _push2(`<div class="alert alert-info mt-6" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-6 w-6 shrink-0 stroke-current" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-e05c0828${_scopeId}></path></svg><span data-v-e05c0828${_scopeId}>Bu pakette kelime bulunmamaktadır.</span></div>`);
              } else if (!hasEnoughWords) {
                _push2(`<div class="alert alert-warning mt-6" data-v-e05c0828${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="h-6 w-6 shrink-0 stroke-current" data-v-e05c0828${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" data-v-e05c0828${_scopeId}></path></svg><span data-v-e05c0828${_scopeId}>Oyunları başlatabilmek için en az 5 kelime gerekiyor.</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
...
const Screen = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e05c0828"]]);
export {
  Screen as default
};
