      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex justify-between gap-3 pt-4"${_scopeId}><button type="button" class="rounded border border-red-300 bg-red-50 px-4 py-2 text-sm font-medium text-red-700 transition hover:bg-red-100 disabled:opacity-50"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
              _push2(`<span class="mr-2 inline-block h-3 w-3 animate-spin rounded-full border-2 border-red-700 border-t-transparent"${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` ${ssrInterpolate(processing.value ? "Siliniyor..." : "Sil")}</button><div class="flex gap-3"${_scopeId}><button type="button" class="rounded border border-base-300 bg-base-100 px-4 py-2 text-sm font-medium text-base-content transition hover:bg-base-200"${_scopeId}> İptal </button><button type="submit" class="rounded bg-base-content px-4 py-2 text-sm font-medium text-base-100 transition hover:bg-base-300 hover:text-base-content disabled:opacity-50"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""}${_scopeId}>`);
            if (processing.value) {
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Kaydediliyor..." : "Kaydet")}</button></div></div></form></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "mx-auto max-w-2xl" }, [
                createVNode("div", { class: "rounded-lg border border-base-300 bg-base-100 p-6" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "flex justify-between gap-3 pt-4" }, [
                      createVNode("button", {
                        type: "button",
