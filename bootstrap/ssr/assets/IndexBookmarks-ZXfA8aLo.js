...
import _sfc_main$1 from "./SidebarLayoutBookmarks-CazwsvM1.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lg:grid-cols-subsidebar grid h-full grid-cols-1" }, _attrs))}>`);
