...
import { _ as _sfc_main$1 } from "./AuthenticatedLayout-CwvN7yh4.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><dl${_scopeId}><dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400"${_scopeId}>Yayında Olan Yazılar</dt><dd class="mt-1 text-3xl font-semibold text-purple-600 dark:text-purple-400"${_scopeId}>${ssrInterpolate(_ctx.stats.public_writes_count)}</dd></dl></div><div class="bg-gray-50 px-4 py-3 dark:bg-gray-700"${_scopeId}><div class="text-sm font-medium text-gray-500 dark:text-gray-400"${_scopeId}> Toplam Yazıların ${ssrInterpolate(_ctx.stats.writes_count > 0 ? Math.round(_ctx.stats.public_writes_count / _ctx.stats.writes_count * 100) : 0)}%&#39;si </div></div></div><div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><dl${_scopeId}><dt class="truncate text-sm font-medium text-gray-500 dark:text-gray-400"${_scopeId}>Özel Yazılar</dt><dd class="mt-1 text-3xl font-semibold text-amber-600 dark:text-amber-400"${_scopeId}>${ssrInterpolate(_ctx.stats.private_writes_count)}</dd></dl></div><div class="bg-gray-50 px-4 py-3 dark:bg-gray-700"${_scopeId}><div class="text-sm font-medium text-gray-500 dark:text-gray-400"${_scopeId}> Toplam Yazıların ${ssrInterpolate(_ctx.stats.writes_count > 0 ? Math.round(_ctx.stats.private_writes_count / _ctx.stats.writes_count * 100) : 0)}%&#39;si </div></div></div></div><div class="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-3"${_scopeId}><div class="overflow-hidden rounded-lg bg-white shadow lg:col-span-2 dark:bg-gray-800"${_scopeId}><div class="border-b border-gray-200 px-4 py-5 sm:px-6 dark:border-gray-700"${_scopeId}><h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100"${_scopeId}>Son Yazılarınız</h3></div><div class="bg-white dark:bg-gray-800"${_scopeId}><ul class="divide-y divide-gray-200 dark:divide-gray-700"${_scopeId}><!--[-->`);
            ssrRenderList(_ctx.recentWrites, (write) => {
              _push2(`<li class="px-4 py-4 hover:bg-gray-50 sm:px-6 dark:hover:bg-gray-700"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`<!--]-->`);
            if (_ctx.recentWrites.length === 0) {
              _push2(`<li class="px-4 py-4 text-gray-500 sm:px-6 dark:text-gray-400"${_scopeId}> Henüz yazı eklenmemiş. </li>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            ssrRenderList(_ctx.popularCategories, (category) => {
              _push2(`<li class="px-4 py-4 hover:bg-gray-50 sm:px-6 dark:hover:bg-gray-700"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`<!--]-->`);
            if (_ctx.popularCategories.length === 0) {
              _push2(`<li class="px-4 py-4 text-gray-500 sm:px-6 dark:text-gray-400"${_scopeId}> Henüz kategori eklenmemiş. </li>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</ul><div class="bg-gray-50 px-4 py-3 text-right dark:bg-gray-700"${_scopeId}>`);
                    ...
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        createVNode("dl", null, [
                          ...
                          createVNode("dd", { class: "mt-1 text-3xl font-semibold text-blue-600 dark:text-blue-400" }, toDisplayString(_ctx.stats.categories_count), 1)
                        ])
                      ]),
                    ...
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        createVNode("dl", null, [
                          ...
                          createVNode("dd", { class: "mt-1 text-3xl font-semibold text-green-600 dark:text-green-400" }, toDisplayString(_ctx.stats.writes_count), 1)
                        ])
                      ]),
                      createVNode("div", { class: "bg-gray-50 px-4 py-3 dark:bg-gray-700" }, [
                        createVNode(unref(Link), {
                    ...
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        createVNode("dl", null, [
                          ...
                          createVNode("dd", { class: "mt-1 text-3xl font-semibold text-purple-600 dark:text-purple-400" }, toDisplayString(_ctx.stats.public_writes_count), 1)
                        ])
                      ]),
                      createVNode("div", { class: "bg-gray-50 px-4 py-3 dark:bg-gray-700" }, [
                        createVNode("div", { class: "text-sm font-medium text-gray-500 dark:text-gray-400" }, " Toplam Yazıların " + toDisplayString(_ctx.stats.writes_count > 0 ? Math.round(_ctx.stats.public_writes_count / _ctx.stats.writes_count * 100) : 0) + "%'si ", 1)
                      ])
                    ]),
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        createVNode("dl", null, [
                          ...
                          createVNode("dd", { class: "mt-1 text-3xl font-semibold text-amber-600 dark:text-amber-400" }, toDisplayString(_ctx.stats.private_writes_count), 1)
                        ])
                      ]),
                      createVNode("div", { class: "bg-gray-50 px-4 py-3 dark:bg-gray-700" }, [
                        createVNode("div", { class: "text-sm font-medium text-gray-500 dark:text-gray-400" }, " Toplam Yazıların " + toDisplayString(_ctx.stats.writes_count > 0 ? Math.round(_ctx.stats.private_writes_count / _ctx.stats.writes_count * 100) : 0) + "%'si ", 1)
                      ])
                    ])
                  ]),
                  createVNode("div", { class: "mb-8 grid grid-cols-1 gap-6 lg:grid-cols-3" }, [
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow lg:col-span-2 dark:bg-gray-800" }, [
                      createVNode("div", { class: "border-b border-gray-200 px-4 py-5 sm:px-6 dark:border-gray-700" }, [
                      ...
                      createVNode("div", { class: "bg-white dark:bg-gray-800" }, [
                        createVNode("ul", { class: "divide-y divide-gray-200 dark:divide-gray-700" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.recentWrites, (write) => {
                          ...
                          _ctx.recentWrites.length === 0 ? (openBlock(), createBlock("li", {
                            key: 0,
                            class: "px-4 py-4 text-gray-500 sm:px-6 dark:text-gray-400"
                    ...
                    createVNode("div", { class: "overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                      ...
                      createVNode("div", { class: "bg-white dark:bg-gray-800" }, [
                        createVNode("ul", { class: "divide-y divide-gray-200 dark:divide-gray-700" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.popularCategories, (category) => {
                            return openBlock(), createBlock("li", {
                              key: category.id,
                              class: "px-4 py-4 hover:bg-gray-50 sm:px-6 dark:hover:bg-gray-700"
                            }, [
                          ...
                          _ctx.popularCategories.length === 0 ? (openBlock(), createBlock("li", {
                            key: 0,
                            class: "px-4 py-4 text-gray-500 sm:px-6 dark:text-gray-400"
