      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></select></div>`);
            if (form.value.category === "writes") {
              _push2(`<div${_scopeId}><label for="related_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300"${_scopeId}> Yazı Seçin </label><select id="related_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(form.value.related_id) ? ssrLooseContain(form.value.related_id, "") : ssrLooseEqual(form.value.related_id, "")) ? " selected" : ""}${_scopeId}>Yazı Seçin (Opsiyonel)</option><!--[-->`);
                  ...
                  createVNode("div", { class: "mb-8 overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800" }, [
                    ...
                    createVNode("div", { class: "p-6" }, [
                      createVNode("form", {
                        ...
                        form.value.category === "writes" ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("label", {
                            for: "related_id",
                            class: "block text-sm font-medium text-gray-700 dark:text-gray-300"
                          }, " Yazı Seçin "),
                          withDirectives(createVNode("select", {
                            id: "related_id",
                            "onUpdate:modelValue": ($event) => form.value.related_id = $event,
                            class: "mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"
                          }, [
                            ...
                            [vModelSelect, form.value.related_id]
                          ])
