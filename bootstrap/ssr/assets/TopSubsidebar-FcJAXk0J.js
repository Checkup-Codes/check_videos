import { computed, useSSRContext, ref, mergeProps, unref, withCtx, createTextVNode, createVNode } from "vue";
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cursor-pointer overflow-hidden border-b-2 border-base-300 lg:relative" }, _attrs))}><div class="flex h-12 items-center justify-between px-5 text-sm font-semibold"><span class="">${ssrInterpolate(__props.title)}</span><div class="flex items-center gap-2">`);
