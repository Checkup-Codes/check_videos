...
import _sfc_main$1 from "./LayoutCertificates-D69cZOsd.js";
import { _ as _sfc_main$2 } from "./CheckScreen-DrAw6M-t.js";
import "./CheckLayout-BtNrppTD.js";
import "./SidebarLayoutCertificate-D6BK55Zg.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="space-y-4 py-6"${_scopeId2}><h1 class="text-2xl font-bold text-foreground"${_scopeId2}>Sertifika Düzenle</h1><form class="space-y-4"${_scopeId2}><div${_scopeId2}><label class="mb-1 block text-sm font-medium text-foreground"${_scopeId2}>Başlık <span class="text-destructive"${_scopeId2}>*</span></label><input${ssrRenderAttr("value", unref(form).title)} type="text" required class="${ssrRenderClass([{ "border-destructive focus-visible:ring-destructive": unref(form).errors.title }, "flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"])}" placeholder="Sertifika adı"${_scopeId2}>`);
                  if (unref(form).errors.title) {
                    _push3(`<p class="mt-1 text-xs text-destructive"${_scopeId2}>${ssrInterpolate(unref(form).errors.title)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div${_scopeId2}><label class="mb-1 block text-sm font-medium text-foreground"${_scopeId2}>Veren Kurum <span class="text-destructive"${_scopeId2}>*</span></label><input${ssrRenderAttr("value", unref(form).issuer)} type="text" required class="${ssrRenderClass([{ "border-destructive focus-visible:ring-destructive": unref(form).errors.issuer }, "flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"])}" placeholder="Örn: Coursera, Udemy, Microsoft"${_scopeId2}>`);
                  if (unref(form).errors.issuer) {
                    _push3(`<p class="mt-1 text-xs text-destructive"${_scopeId2}>${ssrInterpolate(unref(form).errors.issuer)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div${_scopeId2}><label class="mb-1 block text-sm font-medium text-foreground"${_scopeId2}>Açıklama</label><textarea rows="4" class="${ssrRenderClass([{ "border-destructive focus-visible:ring-destructive": unref(form).errors.description }, "flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"])}" placeholder="Sertifika hakkında detaylar..."${_scopeId2}>${ssrInterpolate(unref(form).description)}</textarea>`);
                  if (unref(form).errors.description) {
                    _push3(`<p class="mt-1 text-xs text-destructive"${_scopeId2}>${ssrInterpolate(unref(form).errors.description)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div${_scopeId2}><label class="mb-2 block text-sm font-medium text-foreground"${_scopeId2}>Sertifika Görseli</label><div class="flex items-center gap-4"${_scopeId2}><input type="file" accept="image/*" class="block w-full text-sm text-muted-foreground file:mr-4 file:rounded-md file:border-0 file:bg-primary file:px-4 file:py-2 file:text-sm file:font-medium file:text-primary-foreground hover:file:bg-primary/90"${_scopeId2}></div>`);
                  ...
                  return [
                    createVNode("div", { class: "space-y-4 py-6" }, [
                      createVNode("h1", { class: "text-2xl font-bold text-foreground" }, "Sertifika Düzenle"),
                      createVNode("form", {
