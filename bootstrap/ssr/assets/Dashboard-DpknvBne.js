    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto max-w-7xl space-y-8 p-6"${_scopeId}><div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-semibold tracking-tight"${_scopeId}>Dashboard</h1><p class="mt-1 text-sm text-muted-foreground"${_scopeId}>İçeriklerinize hızlı erişim</p></div><div class="inline-flex items-center rounded-lg border border-border bg-card p-1 shadow-sm"${_scopeId}><button class="${ssrRenderClass([
            ...
            return [
              createVNode("div", { class: "container mx-auto max-w-7xl space-y-8 p-6" }, [
                createVNode("div", { class: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between" }, [
                  ...
                  createVNode("div", { class: "inline-flex items-center rounded-lg border border-border bg-card p-1 shadow-sm" }, [
                    createVNode("button", {
