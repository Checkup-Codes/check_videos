...
import CategoryTree from "./CategoryTree-bv4j6w1X.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ isNarrow: isNarrow.value }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative z-10 shrink-0 border-b border-border bg-background p-2" data-v-62e53e01${_scopeId}><div class="flex items-center justify-between gap-2" data-v-62e53e01${_scopeId}><div class="flex items-center gap-1" data-v-62e53e01${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-62e53e01${_scopeId2}>Liste</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!isNarrow.value) {
                    _push3(`<span data-v-62e53e01${_scopeId2}>Kategori</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(`</div>`);
            if (isLoggedIn.value) {
              _push2(`<div class="flex items-center gap-1" data-v-62e53e01${_scopeId}><button class="${ssrRenderClass([{ "bg-accent text-accent-foreground": areAllCategoriesExpanded.value }, "inline-flex h-6 items-center gap-1 rounded px-2 text-xs text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"])}"${ssrRenderAttr("title", areAllCategoriesExpanded.value ? "Tümünü Daralt" : "Tümünü Genişlet")} data-v-62e53e01${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$4, {
                class: ["h-3 w-3 transition-transform duration-200", { "rotate-180": areAllCategoriesExpanded.value }]
              }, null, _parent2, _scopeId));
              _push2(`<span class="text-xs" data-v-62e53e01${_scopeId}>${ssrInterpolate(areAllCategoriesExpanded.value ? "Daralt" : "Genişlet")}</span></button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
...
const SidebarLayoutCategory = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-62e53e01"]]);
export {
