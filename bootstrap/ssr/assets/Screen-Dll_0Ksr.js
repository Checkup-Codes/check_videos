import { ref, onMounted, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate } from "vue/server-renderer";
import { usePage, Link } from "@inertiajs/vue3";
import { Inertia } from "@inertiajs/inertia";
import "./GoBackButton-CwBeSdRG.js";
import { _ as _sfc_main$3 } from "./ExcalidrawComponent-BQfLYtsj.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "rounded-lg bg-white px-2 py-3 pt-5 shadow-sm sm:px-10 lg:grid lg:grid-cols-12 lg:px-10" }, [
              ...
              showDraw.value ? (openBlock(), createBlock("div", {
                ...
                key: 1,
                class: "mt-3 rounded-lg bg-white p-4 pb-16 shadow-sm"
              }, [
                createVNode("div", {
