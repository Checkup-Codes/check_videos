...
const _sfc_main = /* @__PURE__ */ Object.assign({ name: "TestList" }, {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-1 p-2" }, _attrs))} data-v-a9c1f24c><!--[-->`);
      ssrRenderList(filteredTests.value, (test) => {
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="${ssrRenderClass([isActive(test) ? "text-primary-foreground" : "text-foreground", "line-clamp-2 text-sm font-medium leading-tight"])}" data-v-a9c1f24c${_scopeId}>${ssrInterpolate(test.title)}</h3><div class="${ssrRenderClass([isActive(test) ? "text-primary-foreground/70" : "text-muted-foreground", "flex flex-col gap-1 text-xs sm:flex-row sm:items-center sm:justify-between"])}" data-v-a9c1f24c${_scopeId}><div class="flex items-center gap-3" data-v-a9c1f24c${_scopeId}><span class="flex items-center gap-1" data-v-a9c1f24c${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-a9c1f24c${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-v-a9c1f24c${_scopeId}></path></svg><span data-v-a9c1f24c${_scopeId}>${ssrInterpolate(test.total_questions)} soru</span></span>`);
              if (test.total_points) {
                _push2(`<span class="flex items-center gap-1" data-v-a9c1f24c${_scopeId}><span data-v-a9c1f24c${_scopeId}>${ssrInterpolate(test.total_points)} puan</span></span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
      ...
      if (filteredTests.value.length === 0) {
        _push(`<div class="flex h-32 items-center justify-center text-center text-muted-foreground" data-v-a9c1f24c><div data-v-a9c1f24c>Henüz test bulunmuyor</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const TestList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a9c1f24c"]]);
export {
  TestList as default
};
