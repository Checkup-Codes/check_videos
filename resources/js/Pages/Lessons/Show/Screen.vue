  ...
  <div class="grid grid-cols-1 p-5 leading-loose">
    <div>
      ...
      <div class="mt-6 rounded-lg bg-white p-6 shadow-lg">
        <h2 class="mb-4 text-2xl font-semibold text-gray-800">Keywords</h2>
        <div>
          <textarea
            v-model="keywords"
            class="h-40 w-full rounded border bg-gray-50 p-4 outline-none focus:ring-2 focus:ring-gray-500"
          ...
          <div class="flex justify-end">
            <button
              ...
              class="mt-3 w-1/3 rounded bg-gray-800 py-2 text-white transition-all hover:bg-gray-700"
            >
              Kopyala
            </button>
          </div>
