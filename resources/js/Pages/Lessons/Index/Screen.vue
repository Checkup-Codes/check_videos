<template>
  <CheckScreen>
    <div class="mb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between">
      <h2 class="mb-3 text-xl font-bold text-primary sm:mb-0">DERSLER</h2>
        ...
        <div class="card-body">
          ...
          <div v-else>
                  ...
                  <tr v-for="lesson in lessons" :key="lesson.id" class="hover">
                    ...
                    <td class="text-center">
                      <div class="flex justify-center space-x-1">
                        <Link :href="`/lessons/${lesson.slug}`" class="btn btn-ghost btn-xs">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4"
                            fill="none"
                        ...
                        <Link :href="`/lessons/${lesson.slug}/edit`" class="btn btn-ghost btn-xs">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4"
                            fill="none"
            ...
            <div class="divide-y divide-base-200 md:hidden">
              <div v-for="lesson in lessons" :key="lesson.id" class="p-4 hover:bg-base-100">
                <div class="mb-2">
                  <h3 class="font-medium text-primary">{{ lesson.title }}</h3>
                ...
                <div class="mt-3 flex justify-end space-x-2">
                  <Link :href="`/lessons/${lesson.slug}`" class="btn btn-outline btn-sm">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="mr-1 h-4 w-4"
                      fill="none"
