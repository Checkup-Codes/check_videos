<template>
  ...
  <CheckLayout :isCollapsed="isSidebarCollapsed">
    <SidebarRendition v-if="isSidebarCollapsed" @update:isCollapsed="handleSidebarCollapse" :class="sidebarStyle" />
    <!-- <SidebarPackGame
      v-else-if="isSidebarCollapsed && screenName === 'packs'"
...
import SidebarPackGame from '@/Pages/Rendition/_layouts/SidebarPackGame.vue';
