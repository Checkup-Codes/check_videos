      ...
      <div class="card-body p-6">
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="form-control w-full">
            ...
            <input v-model="form.project_name" type="text" class="input-bordered input w-full" required />
          </div>
          ...
          <div class="form-control w-full">
            ...
            <select v-model="form.customer_id" class="select-bordered select w-full" required>
          ...
          <div class="flex justify-end gap-2">
            <Link :href="`/projects/${project.id}`" class="btn btn-ghost">İptal</Link>
