  ...
  <CheckScreen>
    ...
    <Card elevated>
      <div class="mb-6 flex items-center justify-between">
        ...
        <Link :href="`/projects/${project.id}/edit`" class="btn btn-sm btn-outline">
          <svg
      ...
      <div v-if="project.customer" class="bg-base-200 rounded-lg p-4">
      ...
      <div v-if="project.services && project.services.length" class="space-y-4">
        <div v-for="service in project.services" :key="service.id" class="border-base-300 rounded-lg border p-4">
