<template>
  <CheckScreen>
    <GoBackButton :url="`/customers/${customer.id}`" />
    <TopScreen title="Müşteri Bilgisini Güncelle" />
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div ref="firstNameRef">
              <label class="mb-1 block text-sm font-medium text-foreground">İlk İsmi</label>
              <input
            ...
            <div ref="lastNameRef">
              <label class="mb-1 block text-sm font-medium text-foreground">Soy İsmi</label>
              <input
