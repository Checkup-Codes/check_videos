<template>
  <div class="space-y-6 py-6">
    <div class="mb-6">
      <h1 class="text-3xl font-bold text-foreground">Test Düzenle</h1>
      <p class="mt-2 text-sm text-muted-foreground">Test bilgilerini ve sorularını düzenleyin</p>
    </div>

    <form @submit.prevent="updateTest" class="space-y-6">
      <!-- Test Basic Info -->
      ...
      <div class="flex gap-4">
        ...
        >
          ...
          <span v-else>Testi Güncelle</span>
        </button>
        <Link
...
// Form - Initialize with test data
const form = useForm({
