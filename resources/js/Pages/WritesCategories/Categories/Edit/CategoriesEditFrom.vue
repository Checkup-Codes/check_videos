<template>
  <div class="space-y-4 py-6">
    <form @submit.prevent="submitForm" class="space-y-4">
      ...
      <!-- Aksiyonlar: birincil buton solda, silme masaüstünde en sağa itiliyor
           (yan yana durup yanlışlıkla tıklanmasın), mobilde en alta düşüyor. -->
      <div class="flex flex-col gap-2 pt-2 sm:flex-row sm:items-center">
        ...
        <button
          ...
          class="inline-flex h-11 w-full items-center justify-center gap-1.5 rounded-md border border-destructive bg-background px-4 text-sm font-medium text-destructive ring-offset-background transition-colors hover:bg-destructive hover:text-destructive-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-destructive focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 sm:ml-auto sm:h-9 sm:w-auto"
          :disabled="form.processing"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
