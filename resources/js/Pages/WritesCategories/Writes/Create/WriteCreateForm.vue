<template>
  <CForm @submit="createWrite">
    ...
    <div class="mb-4">
      <label for="status" class="mb-1 block text-sm font-bold text-gray-800">Durumu:</label>
    ...
    <div class="mb-4">
      <label for="views_count" class="mb-1 block text-sm font-bold text-gray-800">Görüntülenme Sayısı:</label>
      <input
