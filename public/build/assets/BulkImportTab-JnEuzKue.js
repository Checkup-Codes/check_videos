import{g,b as k,c as a,a as t,i as x,t as d,C as h,l as p,j as w,m as _,n as b,F as z,k as C,N,o as l}from"./ssr-D9CkDMV7.js";const j={class:"space-y-6"},B={class:"rounded-xl border border-primary/20 bg-primary/5 p-4"},S={class:"flex items-start gap-3"},F={class:"flex-1"},T={key:0,class:"rounded-xl border border-border bg-card p-6"},A={class:"space-y-4"},O={class:"flex flex-wrap gap-2"},P={class:"space-y-2"},$={key:0,class:"text-xs text-destructive"},E={key:1,class:"text-xs text-green-600 dark:text-green-400"},D={key:1,class:"space-y-3"},J={class:"grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3"},V=["onClick"],K={class:"text-xs opacity-70"},M={class:"flex items-center justify-end gap-3"},I=["disabled"],U={__name:"BulkImportTab",props:{languagePacks:{type:Array,default:()=>[]}},emits:["cancel"],setup(v){const s=g(""),n=g(""),i=g(!1),c=g(!1),m=g([]),u=k(()=>{if(!s.value.trim())return n.value="",[];try{const r=JSON.parse(s.value);if(!Array.isArray(r))return n.value="JSON bir dizi (array) olmalıdır",[];for(let e=0;e<r.length;e++){const o=r[e];if(!o.word||!o.language)return n.value=`${e+1}. kelimede 'word' ve 'language' alanları zorunludur`,[]}return n.value="",r}catch(r){return n.value="Geçersiz JSON formatı: "+r.message,[]}}),q=r=>{const e=m.value.indexOf(r);e>-1?m.value.splice(e,1):m.value.push(r)},f=r=>{r==="simple"?s.value=`[
  {
    "word": "hello",
    "language": "en",
    "meanings": [
