import{o,g as i,b as a,t as m,n,r as d,f as c}from"./app-Bict2Khe.js";const b={class:"relative mb-6"},f=["for"],g=["value","type","id"],S={__name:"CTextInput",props:{label:String,id:String,modelValue:String,type:{type:String,default:"text"},labelClass:{type:String,default:"block font-semibold mb-2 text-sm text-gray-700"},inputClass:{type:String,default:`
